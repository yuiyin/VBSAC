; ModuleID = './476_null_pointer_1.c'
source_filename = "./476_null_pointer_1.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define void @null_pointer_001_bad() #0 !dbg !6 {
entry:
...
; Function Attrs: nounwind uwtable
define void @null_pointer_001_good() #0 !dbg !18 {
entry:
...
entry:
  ...
  call void @null_pointer_001_good(), !dbg !33
  call void @null_pointer_001_bad(), !dbg !34
  ret i32 0, !dbg !35
}
...
!1 = !DIFile(filename: "476_null_pointer_1.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/476")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "null_pointer_001_bad", scope: !7, file: !7, line: 17, type: !8, isLocal: false, isDefinition: true, scopeLine: 18, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./476_null_pointer_1.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/476")
...
!15 = !DILocation(line: 20, column: 3, scope: !6)
!16 = !DILocation(line: 20, column: 5, scope: !6)
!17 = !DILocation(line: 21, column: 1, scope: !6)
!18 = distinct !DISubprogram(name: "null_pointer_001_good", scope: !7, file: !7, line: 27, type: !8, isLocal: false, isDefinition: true, scopeLine: 28, isOptimized: false, unit: !0, variables: !2)
...
!27 = !DILocation(line: 31, column: 3, scope: !18)
!28 = !DILocation(line: 31, column: 5, scope: !18)
