...
; Function Attrs: nounwind uwtable
define void @bad32() #0 !dbg !74 {
entry:
  %data = alloca i64*, align 8
  call void @llvm.dbg.declare(metadata i64** %data, metadata !77, metadata !33), !dbg !79
  store i64* null, i64** %data, align 8, !dbg !80
  %0 = load i64*, i64** %data, align 8, !dbg !83
  %1 = load i64, i64* %0, align 8, !dbg !86
  call void @printLongLine(i64 %1), !dbg !87
  ret void, !dbg !88
}

; Function Attrs: nounwind uwtable
define void @good32() #0 !dbg !89 {
entry:
  %data = alloca i64*, align 8
  call void @llvm.dbg.declare(metadata i64** %data, metadata !90, metadata !33), !dbg !91
...
if.then:                                          ; preds = %entry
  ...
  call void @printLongLine(i64 %2), !dbg !104
...
entry:
  ...
  call void @good32(), !dbg !110
  call void @bad32(), !dbg !111
  ret i32 1, !dbg !112
}
...
!1 = !DIFile(filename: "476_32.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_32.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad32", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!83 = !DILocation(line: 70, column: 24, scope: !84)
!84 = distinct !DILexicalBlock(scope: !85, file: !8, line: 68, column: 5)
!85 = distinct !DILexicalBlock(scope: !74, file: !8, line: 67, column: 8)
!86 = !DILocation(line: 70, column: 23, scope: !84)
!87 = !DILocation(line: 70, column: 9, scope: !84)
!88 = !DILocation(line: 72, column: 1, scope: !74)
!89 = distinct !DISubprogram(name: "good32", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
...
!101 = !DILocation(line: 96, column: 28, scope: !102)
!102 = distinct !DILexicalBlock(scope: !96, file: !8, line: 95, column: 9)
!103 = !DILocation(line: 96, column: 27, scope: !102)
