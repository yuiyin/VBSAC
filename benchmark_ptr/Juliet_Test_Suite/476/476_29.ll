...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @globalReturnsTrue(), !dbg !86
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @globalReturnsFalse(), !dbg !104
...
entry:
  ...
  call void @good29(), !dbg !124
  call void @bad29(), !dbg !125
  ret i32 1, !dbg !126
}
...
!1 = !DIFile(filename: "476_29.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_29.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad29", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!91 = !DILocation(line: 70, column: 22, scope: !90)
!92 = !DILocation(line: 70, column: 9, scope: !90)
!93 = !DILocation(line: 71, column: 5, scope: !90)
!94 = !DILocation(line: 72, column: 1, scope: !74)
!95 = distinct !DISubprogram(name: "good29", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!96 = !DILocalVariable(name: "data", scope: !95, file: !8, line: 80, type: !78)
!97 = !DILocation(line: 80, column: 11, scope: !95)
...
!115 = !DILocation(line: 96, column: 27, scope: !116)
!116 = distinct !DILexicalBlock(scope: !111, file: !8, line: 95, column: 9)
!117 = !DILocation(line: 96, column: 26, scope: !116)
