...
if.end:                                           ; preds = %if.then, %entry
  ...
  br i1 %tobool2, label %if.then3, label %if.end4, !dbg !88
...
; Function Attrs: nounwind uwtable
define void @good26() #0 !dbg !95 {
entry:
  %data = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %data, metadata !96, metadata !33), !dbg !97
  %call = call i32 @staticReturnsTrue(), !dbg !98
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsFalse(), !dbg !104
  %tobool2 = icmp ne i32 %call1, 0, !dbg !104
  br i1 %tobool2, label %if.then3, label %if.else, !dbg !106
...
if.else:                                          ; preds = %if.end
  ...
  %cmp = icmp ne i32* %0, null, !dbg !113
  br i1 %cmp, label %if.then4, label %if.else5, !dbg !114

if.then4:                                         ; preds = %if.else
  %1 = load i32*, i32** %data, align 8, !dbg !115
  %2 = load i32, i32* %1, align 4, !dbg !117
  call void @printIntLine(i32 %2), !dbg !118
  br label %if.end6, !dbg !119
...
entry:
  ...
  call void @good26(), !dbg !124
  call void @bad26(), !dbg !125
  ret i32 1, !dbg !126
}

; Function Attrs: nounwind uwtable
define internal i32 @staticReturnsTrue() #0 !dbg !127 {
entry:
  ret i32 1, !dbg !128
}
...
!1 = !DIFile(filename: "476_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad26", scope: !8, file: !8, line: 69, type: !75, isLocal: false, isDefinition: true, scopeLine: 70, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "data", scope: !74, file: !8, line: 71, type: !78)
!78 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64, align: 64)
!79 = !DILocation(line: 71, column: 11, scope: !74)
!80 = !DILocation(line: 72, column: 8, scope: !81)
!81 = distinct !DILexicalBlock(scope: !74, file: !8, line: 72, column: 8)
!82 = !DILocation(line: 72, column: 8, scope: !74)
!83 = !DILocation(line: 75, column: 14, scope: !84)
!84 = distinct !DILexicalBlock(scope: !81, file: !8, line: 73, column: 5)
!85 = !DILocation(line: 76, column: 5, scope: !84)
!86 = !DILocation(line: 77, column: 8, scope: !87)
!87 = distinct !DILexicalBlock(scope: !74, file: !8, line: 77, column: 8)
!88 = !DILocation(line: 77, column: 8, scope: !74)
!89 = !DILocation(line: 80, column: 23, scope: !90)
!90 = distinct !DILexicalBlock(scope: !87, file: !8, line: 78, column: 5)
!91 = !DILocation(line: 80, column: 22, scope: !90)
!92 = !DILocation(line: 80, column: 9, scope: !90)
!93 = !DILocation(line: 81, column: 5, scope: !90)
!94 = !DILocation(line: 82, column: 1, scope: !74)
!95 = distinct !DISubprogram(name: "good26", scope: !8, file: !8, line: 88, type: !75, isLocal: false, isDefinition: true, scopeLine: 89, isOptimized: false, unit: !0, variables: !2)
!96 = !DILocalVariable(name: "data", scope: !95, file: !8, line: 90, type: !78)
!97 = !DILocation(line: 90, column: 11, scope: !95)
!98 = !DILocation(line: 91, column: 8, scope: !99)
!99 = distinct !DILexicalBlock(scope: !95, file: !8, line: 91, column: 8)
!100 = !DILocation(line: 91, column: 8, scope: !95)
!101 = !DILocation(line: 94, column: 14, scope: !102)
!102 = distinct !DILexicalBlock(scope: !99, file: !8, line: 92, column: 5)
!103 = !DILocation(line: 95, column: 5, scope: !102)
!104 = !DILocation(line: 96, column: 8, scope: !105)
!105 = distinct !DILexicalBlock(scope: !95, file: !8, line: 96, column: 8)
!106 = !DILocation(line: 96, column: 8, scope: !95)
!107 = !DILocation(line: 99, column: 9, scope: !108)
!108 = distinct !DILexicalBlock(scope: !105, file: !8, line: 97, column: 5)
!109 = !DILocation(line: 100, column: 5, scope: !108)
!110 = !DILocation(line: 104, column: 13, scope: !111)
!111 = distinct !DILexicalBlock(scope: !112, file: !8, line: 104, column: 13)
!112 = distinct !DILexicalBlock(scope: !105, file: !8, line: 102, column: 5)
!113 = !DILocation(line: 104, column: 18, scope: !111)
!114 = !DILocation(line: 104, column: 13, scope: !112)
!115 = !DILocation(line: 106, column: 27, scope: !116)
!116 = distinct !DILexicalBlock(scope: !111, file: !8, line: 105, column: 9)
!117 = !DILocation(line: 106, column: 26, scope: !116)
!118 = !DILocation(line: 106, column: 13, scope: !116)
!119 = !DILocation(line: 107, column: 9, scope: !116)
!120 = !DILocation(line: 110, column: 13, scope: !121)
!121 = distinct !DILexicalBlock(scope: !111, file: !8, line: 109, column: 9)
!122 = !DILocation(line: 113, column: 1, scope: !95)
!123 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 117, type: !19, isLocal: false, isDefinition: true, scopeLine: 117, isOptimized: false, unit: !0, variables: !2)
!124 = !DILocation(line: 118, column: 5, scope: !123)
!125 = !DILocation(line: 119, column: 2, scope: !123)
!126 = !DILocation(line: 120, column: 5, scope: !123)
!127 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !8, file: !8, line: 57, type: !19, isLocal: true, isDefinition: true, scopeLine: 58, isOptimized: false, unit: !0, variables: !2)
!128 = !DILocation(line: 59, column: 5, scope: !127)
!129 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !8, file: !8, line: 62, type: !19, isLocal: true, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
!130 = !DILocation(line: 64, column: 5, scope: !129)
