...
if.then3:                                         ; preds = %if.end
  ...
  %1 = load i64, i64* %0, align 8, !dbg !91
  call void @printLongLine(i64 %1), !dbg !92
...
if.else:                                          ; preds = %if.end
  ...
  %cmp = icmp ne i64* %0, null, !dbg !113
  br i1 %cmp, label %if.then4, label %if.else5, !dbg !114

if.then4:                                         ; preds = %if.else
  %1 = load i64*, i64** %data, align 8, !dbg !115
  %2 = load i64, i64* %1, align 8, !dbg !117
  call void @printLongLine(i64 %2), !dbg !118
...
entry:
  ...
  call void @good38(), !dbg !124
  call void @bad38(), !dbg !125
  ret i32 1, !dbg !126
}
...
!1 = !DIFile(filename: "476_38.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_38.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad38", scope: !8, file: !8, line: 69, type: !75, isLocal: false, isDefinition: true, scopeLine: 70, isOptimized: false, unit: !0, variables: !2)
...
!79 = !DILocation(line: 71, column: 12, scope: !74)
...
!89 = !DILocation(line: 80, column: 24, scope: !90)
!90 = distinct !DILexicalBlock(scope: !87, file: !8, line: 78, column: 5)
!91 = !DILocation(line: 80, column: 23, scope: !90)
!92 = !DILocation(line: 80, column: 9, scope: !90)
!93 = !DILocation(line: 81, column: 5, scope: !90)
!94 = !DILocation(line: 82, column: 1, scope: !74)
!95 = distinct !DISubprogram(name: "good38", scope: !8, file: !8, line: 88, type: !75, isLocal: false, isDefinition: true, scopeLine: 89, isOptimized: false, unit: !0, variables: !2)
...
!115 = !DILocation(line: 106, column: 28, scope: !116)
!116 = distinct !DILexicalBlock(scope: !111, file: !8, line: 105, column: 9)
!117 = !DILocation(line: 106, column: 27, scope: !116)
...
!123 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 116, type: !19, isLocal: false, isDefinition: true, scopeLine: 116, isOptimized: false, unit: !0, variables: !2)
!124 = !DILocation(line: 117, column: 5, scope: !123)
!125 = !DILocation(line: 118, column: 2, scope: !123)
!126 = !DILocation(line: 119, column: 5, scope: !123)
