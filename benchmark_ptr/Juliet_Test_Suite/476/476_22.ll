...
entry:
  ...
  %1 = load i32, i32* %0, align 4, !dbg !86
  call void @printIntLine(i32 %1), !dbg !87
  ret void, !dbg !88
}

; Function Attrs: nounwind uwtable
define void @good22() #0 !dbg !89 {
entry:
  %data = alloca i32*, align 8
  ...
  %cmp = icmp ne i32* %0, null, !dbg !99
  br i1 %cmp, label %if.then, label %if.else, !dbg !100

if.then:                                          ; preds = %entry
  %1 = load i32*, i32** %data, align 8, !dbg !101
  %2 = load i32, i32* %1, align 4, !dbg !103
  call void @printIntLine(i32 %2), !dbg !104
  br label %if.end, !dbg !105

if.else:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0)), !dbg !106
  br label %if.end
...
entry:
  ...
  call void @good22(), !dbg !110
  call void @bad22(), !dbg !111
  ret i32 1, !dbg !112
}
...
!1 = !DIFile(filename: "476_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad22", scope: !8, file: !8, line: 62, type: !75, isLocal: false, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "data", scope: !74, file: !8, line: 64, type: !78)
!78 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64, align: 64)
!79 = !DILocation(line: 64, column: 11, scope: !74)
!80 = !DILocation(line: 68, column: 14, scope: !81)
!81 = distinct !DILexicalBlock(scope: !82, file: !8, line: 66, column: 5)
!82 = distinct !DILexicalBlock(scope: !74, file: !8, line: 65, column: 8)
!83 = !DILocation(line: 73, column: 23, scope: !84)
!84 = distinct !DILexicalBlock(scope: !85, file: !8, line: 71, column: 5)
!85 = distinct !DILexicalBlock(scope: !74, file: !8, line: 70, column: 8)
!86 = !DILocation(line: 73, column: 22, scope: !84)
!87 = !DILocation(line: 73, column: 9, scope: !84)
!88 = !DILocation(line: 75, column: 1, scope: !74)
!89 = distinct !DISubprogram(name: "good22", scope: !8, file: !8, line: 81, type: !75, isLocal: false, isDefinition: true, scopeLine: 82, isOptimized: false, unit: !0, variables: !2)
!90 = !DILocalVariable(name: "data", scope: !89, file: !8, line: 83, type: !78)
!91 = !DILocation(line: 83, column: 11, scope: !89)
!92 = !DILocation(line: 87, column: 14, scope: !93)
!93 = distinct !DILexicalBlock(scope: !94, file: !8, line: 85, column: 5)
!94 = distinct !DILexicalBlock(scope: !89, file: !8, line: 84, column: 8)
!95 = !DILocation(line: 97, column: 13, scope: !96)
!96 = distinct !DILexicalBlock(scope: !97, file: !8, line: 97, column: 13)
!97 = distinct !DILexicalBlock(scope: !98, file: !8, line: 95, column: 5)
!98 = distinct !DILexicalBlock(scope: !89, file: !8, line: 89, column: 8)
!99 = !DILocation(line: 97, column: 18, scope: !96)
!100 = !DILocation(line: 97, column: 13, scope: !97)
!101 = !DILocation(line: 99, column: 27, scope: !102)
!102 = distinct !DILexicalBlock(scope: !96, file: !8, line: 98, column: 9)
!103 = !DILocation(line: 99, column: 26, scope: !102)
!104 = !DILocation(line: 99, column: 13, scope: !102)
!105 = !DILocation(line: 100, column: 9, scope: !102)
!106 = !DILocation(line: 103, column: 13, scope: !107)
!107 = distinct !DILexicalBlock(scope: !96, file: !8, line: 102, column: 9)
!108 = !DILocation(line: 106, column: 1, scope: !89)
!109 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 110, type: !19, isLocal: false, isDefinition: true, scopeLine: 110, isOptimized: false, unit: !0, variables: !2)
!110 = !DILocation(line: 111, column: 5, scope: !109)
!111 = !DILocation(line: 112, column: 2, scope: !109)
!112 = !DILocation(line: 113, column: 5, scope: !109)
