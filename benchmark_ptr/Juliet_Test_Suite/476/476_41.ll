...
; Function Attrs: nounwind uwtable
define void @bad41() #0 !dbg !74 {
entry:
  %intPointer = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !77, metadata !33), !dbg !80
  store i32* null, i32** %intPointer, align 8, !dbg !80
  %0 = load i32*, i32** %intPointer, align 8, !dbg !81
  %cmp = icmp eq i32* %0, null, !dbg !83
  br i1 %cmp, label %if.then, label %if.end, !dbg !84

if.then:                                          ; preds = %entry
  %1 = load i32*, i32** %intPointer, align 8, !dbg !85
  %2 = load i32, i32* %1, align 4, !dbg !87
  call void @printIntLine(i32 %2), !dbg !88
...
; Function Attrs: nounwind uwtable
define void @good41() #0 !dbg !91 {
entry:
  %intPointer = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !92, metadata !33), !dbg !94
  store i32* null, i32** %intPointer, align 8, !dbg !94
  %0 = load i32*, i32** %intPointer, align 8, !dbg !95
  %cmp = icmp eq i32* %0, null, !dbg !97
  br i1 %cmp, label %if.then, label %if.end, !dbg !98

if.then:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0)), !dbg !99
...
entry:
  ...
  call void @good41(), !dbg !104
  call void @bad41(), !dbg !105
  ret i32 1, !dbg !106
}
...
!1 = !DIFile(filename: "476_41.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_41.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad41", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "intPointer", scope: !78, file: !8, line: 63, type: !79)
...
!81 = !DILocation(line: 64, column: 13, scope: !82)
!82 = distinct !DILexicalBlock(scope: !78, file: !8, line: 64, column: 13)
!83 = !DILocation(line: 64, column: 24, scope: !82)
!84 = !DILocation(line: 64, column: 13, scope: !78)
!85 = !DILocation(line: 66, column: 27, scope: !86)
!86 = distinct !DILexicalBlock(scope: !82, file: !8, line: 65, column: 9)
!87 = !DILocation(line: 66, column: 26, scope: !86)
!88 = !DILocation(line: 66, column: 13, scope: !86)
!89 = !DILocation(line: 67, column: 9, scope: !86)
!90 = !DILocation(line: 69, column: 1, scope: !74)
!91 = distinct !DISubprogram(name: "good41", scope: !8, file: !8, line: 75, type: !75, isLocal: false, isDefinition: true, scopeLine: 76, isOptimized: false, unit: !0, variables: !2)
!92 = !DILocalVariable(name: "intPointer", scope: !93, file: !8, line: 79, type: !79)
!93 = distinct !DILexicalBlock(scope: !91, file: !8, line: 77, column: 5)
!94 = !DILocation(line: 79, column: 14, scope: !93)
!95 = !DILocation(line: 80, column: 13, scope: !96)
!96 = distinct !DILexicalBlock(scope: !93, file: !8, line: 80, column: 13)
!97 = !DILocation(line: 80, column: 24, scope: !96)
!98 = !DILocation(line: 80, column: 13, scope: !93)
!99 = !DILocation(line: 82, column: 13, scope: !100)
!100 = distinct !DILexicalBlock(scope: !96, file: !8, line: 81, column: 9)
!101 = !DILocation(line: 83, column: 9, scope: !100)
!102 = !DILocation(line: 85, column: 1, scope: !91)
!103 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 90, type: !19, isLocal: false, isDefinition: true, scopeLine: 90, isOptimized: false, unit: !0, variables: !2)
!104 = !DILocation(line: 91, column: 5, scope: !103)
!105 = !DILocation(line: 92, column: 2, scope: !103)
!106 = !DILocation(line: 93, column: 5, scope: !103)
