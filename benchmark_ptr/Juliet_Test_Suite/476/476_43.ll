...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !77, metadata !33), !dbg !82
  store i32* null, i32** %intPointer, align 8, !dbg !82
  %0 = load i32*, i32** %intPointer, align 8, !dbg !83
  %cmp = icmp eq i32* %0, null, !dbg !85
  br i1 %cmp, label %if.then, label %if.end, !dbg !86

if.then:                                          ; preds = %entry
  %1 = load i32*, i32** %intPointer, align 8, !dbg !87
  %2 = load i32, i32* %1, align 4, !dbg !89
...
; Function Attrs: nounwind uwtable
define void @good43() #0 !dbg !93 {
entry:
  %intPointer = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !94, metadata !33), !dbg !98
  store i32* null, i32** %intPointer, align 8, !dbg !98
  %0 = load i32*, i32** %intPointer, align 8, !dbg !99
  %cmp = icmp eq i32* %0, null, !dbg !101
  br i1 %cmp, label %if.then, label %if.end, !dbg !102

if.then:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0)), !dbg !103
...
entry:
  ...
  call void @good43(), !dbg !108
  call void @bad43(), !dbg !109
  ret i32 1, !dbg !110
}
...
!1 = !DIFile(filename: "476_43.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_43.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad43", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "intPointer", scope: !78, file: !8, line: 65, type: !81)
...
!82 = !DILocation(line: 65, column: 18, scope: !78)
!83 = !DILocation(line: 66, column: 17, scope: !84)
!84 = distinct !DILexicalBlock(scope: !78, file: !8, line: 66, column: 17)
!85 = !DILocation(line: 66, column: 28, scope: !84)
!86 = !DILocation(line: 66, column: 17, scope: !78)
!87 = !DILocation(line: 68, column: 31, scope: !88)
!88 = distinct !DILexicalBlock(scope: !84, file: !8, line: 67, column: 13)
...
!93 = distinct !DISubprogram(name: "good43", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!94 = !DILocalVariable(name: "intPointer", scope: !95, file: !8, line: 89, type: !81)
!95 = distinct !DILexicalBlock(scope: !96, file: !8, line: 87, column: 9)
!96 = distinct !DILexicalBlock(scope: !97, file: !8, line: 86, column: 5)
!97 = distinct !DILexicalBlock(scope: !93, file: !8, line: 80, column: 8)
!98 = !DILocation(line: 89, column: 18, scope: !95)
!99 = !DILocation(line: 90, column: 17, scope: !100)
!100 = distinct !DILexicalBlock(scope: !95, file: !8, line: 90, column: 17)
!101 = !DILocation(line: 90, column: 28, scope: !100)
!102 = !DILocation(line: 90, column: 17, scope: !95)
!103 = !DILocation(line: 92, column: 17, scope: !104)
!104 = distinct !DILexicalBlock(scope: !100, file: !8, line: 91, column: 13)
!105 = !DILocation(line: 93, column: 13, scope: !104)
!106 = !DILocation(line: 96, column: 1, scope: !93)
!107 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 99, type: !19, isLocal: false, isDefinition: true, scopeLine: 99, isOptimized: false, unit: !0, variables: !2)
!108 = !DILocation(line: 100, column: 5, scope: !107)
!109 = !DILocation(line: 101, column: 2, scope: !107)
!110 = !DILocation(line: 102, column: 5, scope: !107)
