...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @malloc(i64 100) #4, !dbg !65
...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @malloc(i64 100) #4, !dbg !94
...
entry:
  ...
  call void @good30(), !dbg !120
  call void @bad30(), !dbg !121
  ret i32 1, !dbg !122
}
...
!1 = !DIFile(filename: "401_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad30", scope: !9, file: !9, line: 49, type: !56, isLocal: false, isDefinition: true, scopeLine: 50, isOptimized: false, unit: !0, variables: !2)
...
!86 = distinct !DISubprogram(name: "good30", scope: !9, file: !9, line: 73, type: !56, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
...
!119 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 100, type: !21, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!120 = !DILocation(line: 101, column: 5, scope: !119)
!121 = !DILocation(line: 102, column: 2, scope: !119)
!122 = !DILocation(line: 103, column: 5, scope: !119)
