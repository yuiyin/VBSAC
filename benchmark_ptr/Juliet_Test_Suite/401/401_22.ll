...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @malloc(i64 100) #4, !dbg !95
...
entry:
  ...
  call void @good22(), !dbg !121
  call void @bad22(), !dbg !122
  ret i32 1, !dbg !123
}
...
!1 = !DIFile(filename: "401_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!56 = distinct !DISubprogram(name: "bad22", scope: !9, file: !9, line: 51, type: !57, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: false, unit: !0, variables: !2)
...
!87 = distinct !DISubprogram(name: "good22", scope: !9, file: !9, line: 75, type: !57, isLocal: false, isDefinition: true, scopeLine: 76, isOptimized: false, unit: !0, variables: !2)
...
!120 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 102, type: !22, isLocal: false, isDefinition: true, scopeLine: 102, isOptimized: false, unit: !0, variables: !2)
!121 = !DILocation(line: 103, column: 5, scope: !120)
!122 = !DILocation(line: 104, column: 2, scope: !120)
!123 = !DILocation(line: 105, column: 5, scope: !120)
