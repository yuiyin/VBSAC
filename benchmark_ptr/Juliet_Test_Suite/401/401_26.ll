...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @malloc(i64 100) #4, !dbg !64
...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @malloc(i64 100) #4, !dbg !91
...
entry:
  ...
  call void @good26(), !dbg !116
  call void @bad26(), !dbg !117
  ret i32 1, !dbg !118
}
...
!1 = !DIFile(filename: "401_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad26", scope: !9, file: !9, line: 49, type: !56, isLocal: false, isDefinition: true, scopeLine: 50, isOptimized: false, unit: !0, variables: !2)
...
!84 = distinct !DISubprogram(name: "good26", scope: !9, file: !9, line: 73, type: !56, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
...
!115 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 100, type: !21, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!116 = !DILocation(line: 101, column: 5, scope: !115)
!117 = !DILocation(line: 102, column: 2, scope: !115)
!118 = !DILocation(line: 103, column: 5, scope: !115)
