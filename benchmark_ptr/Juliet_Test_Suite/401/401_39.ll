...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i8* @realloc(i8* %0, i64 100) #4, !dbg !66
  store i8* %call1, i8** %data, align 8, !dbg !67
  %1 = load i8*, i8** %data, align 8, !dbg !68
  %cmp = icmp eq i8* %1, null, !dbg !70
...
if.then:                                          ; preds = %entry
  ...
  %call1 = call i8* @realloc(i8* %0, i64 100) #4, !dbg !94
...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call i8* @strcpy(i8* %2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !103
...
entry:
  ...
  call void @good39(), !dbg !118
  call void @bad39(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "401_39.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_39.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad39", scope: !9, file: !9, line: 59, type: !56, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!64 = !DILocation(line: 66, column: 32, scope: !65)
!65 = distinct !DILexicalBlock(scope: !62, file: !9, line: 64, column: 5)
!66 = !DILocation(line: 66, column: 24, scope: !65)
...
!74 = !DILocation(line: 69, column: 16, scope: !65)
!75 = !DILocation(line: 69, column: 9, scope: !65)
!76 = !DILocation(line: 70, column: 19, scope: !65)
...
!85 = distinct !DISubprogram(name: "good39", scope: !9, file: !9, line: 83, type: !56, isLocal: false, isDefinition: true, scopeLine: 84, isOptimized: false, unit: !0, variables: !2)
...
!92 = !DILocation(line: 90, column: 32, scope: !93)
!93 = distinct !DILexicalBlock(scope: !90, file: !9, line: 88, column: 5)
!94 = !DILocation(line: 90, column: 24, scope: !93)
...
!102 = !DILocation(line: 93, column: 16, scope: !93)
!103 = !DILocation(line: 93, column: 9, scope: !93)
!104 = !DILocation(line: 94, column: 19, scope: !93)
...
!117 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 110, type: !21, isLocal: false, isDefinition: true, scopeLine: 110, isOptimized: false, unit: !0, variables: !2)
...
!121 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !9, file: !9, line: 47, type: !21, isLocal: true, isDefinition: true, scopeLine: 48, isOptimized: false, unit: !0, variables: !2)
!122 = !DILocation(line: 49, column: 5, scope: !121)
!123 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !9, file: !9, line: 52, type: !21, isLocal: true, isDefinition: true, scopeLine: 53, isOptimized: false, unit: !0, variables: !2)
