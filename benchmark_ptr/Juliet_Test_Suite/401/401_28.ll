...
if.then:                                          ; preds = %entry
  %call1 = call noalias i8* @malloc(i64 100) #4, !dbg !107
...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call i8* @strcpy(i8* %1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !117
  %2 = load i8*, i8** %data, align 8, !dbg !118
  call void @printLine(i8* %2), !dbg !119
  br label %if.end9, !dbg !120

if.else:                                          ; preds = %entry
  %call4 = call noalias i8* @malloc(i64 100) #4, !dbg !121
  store i8* %call4, i8** %data, align 8, !dbg !123
  %3 = load i8*, i8** %data, align 8, !dbg !124
  %cmp5 = icmp eq i8* %3, null, !dbg !126
...
if.end7:                                          ; preds = %if.else
  ...
  %call8 = call i8* @strcpy(i8* %4, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !131
  %5 = load i8*, i8** %data, align 8, !dbg !132
  call void @printLine(i8* %5), !dbg !133
  br label %if.end9

if.end9:                                          ; preds = %if.end7, %if.end
  %call10 = call i32 @globalReturnsTrueOrFalse(), !dbg !134
  %tobool11 = icmp ne i32 %call10, 0, !dbg !134
  br i1 %tobool11, label %if.then12, label %if.else13, !dbg !136

if.then12:                                        ; preds = %if.end9
  %6 = load i8*, i8** %data, align 8, !dbg !137
  call void @free(i8* %6) #4, !dbg !139
  br label %if.end14, !dbg !140

if.else13:                                        ; preds = %if.end9
  %7 = load i8*, i8** %data, align 8, !dbg !141
  call void @free(i8* %7) #4, !dbg !143
  br label %if.end14

if.end14:                                         ; preds = %if.then2, %if.then6, %if.else13, %if.then12
  ret void, !dbg !144
}
...
entry:
  ...
  call void @good28(), !dbg !146
  call void @bad28(), !dbg !147
  ret i32 1, !dbg !148
}
...
!1 = !DIFile(filename: "401_28.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_28.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad28", scope: !9, file: !9, line: 49, type: !56, isLocal: false, isDefinition: true, scopeLine: 50, isOptimized: false, unit: !0, variables: !2)
...
!100 = distinct !DISubprogram(name: "good28", scope: !9, file: !9, line: 87, type: !56, isLocal: false, isDefinition: true, scopeLine: 88, isOptimized: false, unit: !0, variables: !2)
...
!111 = distinct !DILexicalBlock(scope: !108, file: !9, line: 95, column: 13)
!112 = !DILocation(line: 95, column: 18, scope: !111)
!113 = !DILocation(line: 95, column: 13, scope: !108)
!114 = !DILocation(line: 95, column: 27, scope: !115)
!115 = !DILexicalBlockFile(scope: !111, file: !9, discriminator: 1)
!116 = !DILocation(line: 97, column: 16, scope: !108)
!117 = !DILocation(line: 97, column: 9, scope: !108)
!118 = !DILocation(line: 98, column: 19, scope: !108)
!119 = !DILocation(line: 98, column: 9, scope: !108)
!120 = !DILocation(line: 99, column: 5, scope: !108)
!121 = !DILocation(line: 103, column: 24, scope: !122)
!122 = distinct !DILexicalBlock(scope: !105, file: !9, line: 101, column: 5)
!123 = !DILocation(line: 103, column: 14, scope: !122)
!124 = !DILocation(line: 104, column: 13, scope: !125)
!125 = distinct !DILexicalBlock(scope: !122, file: !9, line: 104, column: 13)
!126 = !DILocation(line: 104, column: 18, scope: !125)
!127 = !DILocation(line: 104, column: 13, scope: !122)
!128 = !DILocation(line: 104, column: 27, scope: !129)
!129 = !DILexicalBlockFile(scope: !125, file: !9, discriminator: 1)
!130 = !DILocation(line: 106, column: 16, scope: !122)
!131 = !DILocation(line: 106, column: 9, scope: !122)
!132 = !DILocation(line: 107, column: 19, scope: !122)
!133 = !DILocation(line: 107, column: 9, scope: !122)
!134 = !DILocation(line: 109, column: 8, scope: !135)
!135 = distinct !DILexicalBlock(scope: !100, file: !9, line: 109, column: 8)
!136 = !DILocation(line: 109, column: 8, scope: !100)
!137 = !DILocation(line: 112, column: 14, scope: !138)
!138 = distinct !DILexicalBlock(scope: !135, file: !9, line: 110, column: 5)
!139 = !DILocation(line: 112, column: 9, scope: !138)
!140 = !DILocation(line: 113, column: 5, scope: !138)
!141 = !DILocation(line: 117, column: 14, scope: !142)
!142 = distinct !DILexicalBlock(scope: !135, file: !9, line: 115, column: 5)
!143 = !DILocation(line: 117, column: 9, scope: !142)
!144 = !DILocation(line: 119, column: 1, scope: !100)
!145 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 121, type: !21, isLocal: false, isDefinition: true, scopeLine: 121, isOptimized: false, unit: !0, variables: !2)
!146 = !DILocation(line: 122, column: 5, scope: !145)
!147 = !DILocation(line: 123, column: 2, scope: !145)
!148 = !DILocation(line: 124, column: 5, scope: !145)
