; ModuleID = './190_data_overflow_6.c'
source_filename = "./190_data_overflow_6.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define void @data_overflow_013_bad() #0 !dbg !6 {
entry:
  %max = alloca i32, align 4
  %ret = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %max, metadata !10, metadata !12), !dbg !13
  store i32 1073741824, i32* %max, align 4, !dbg !13
...
; Function Attrs: nounwind uwtable
define void @data_overflow_013_good() #0 !dbg !20 {
entry:
  %max = alloca i32, align 4
  %ret = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %max, metadata !21, metadata !12), !dbg !22
  store i32 1073741823, i32* %max, align 4, !dbg !22
...
entry:
  ...
  call void @data_overflow_013_good(), !dbg !32
  call void @data_overflow_013_bad(), !dbg !33
  ret i32 0, !dbg !34
}
...
!1 = !DIFile(filename: "190_data_overflow_6.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "data_overflow_013_bad", scope: !7, file: !7, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./190_data_overflow_6.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
...
!20 = distinct !DISubprogram(name: "data_overflow_013_good", scope: !7, file: !7, line: 19, type: !8, isLocal: false, isDefinition: true, scopeLine: 20, isOptimized: false, unit: !0, variables: !2)
