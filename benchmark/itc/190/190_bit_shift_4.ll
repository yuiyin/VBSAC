; ModuleID = './190_bit_shift_4.c'
source_filename = "./190_bit_shift_4.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define void @bit_shift_007_bad() #0 !dbg !6 {
entry:
  ...
  %shr = ashr i32 %0, -1, !dbg !17
  store i32 %shr, i32* %ret, align 4, !dbg !18
  ret void, !dbg !19
}
...
; Function Attrs: nounwind uwtable
define void @bit_shift_007_good() #0 !dbg !20 {
entry:
  %a = alloca i32, align 4
  %ret = alloca i32, align 4
  ...
  %shr = ashr i32 %0, 10, !dbg !26
  store i32 %shr, i32* %ret, align 4, !dbg !27
  ret void, !dbg !28
}
...
entry:
  ...
  call void @bit_shift_007_good(), !dbg !32
  call void @bit_shift_007_bad(), !dbg !33
  ret i32 0, !dbg !34
}
...
!1 = !DIFile(filename: "190_bit_shift_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "bit_shift_007_bad", scope: !7, file: !7, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./190_bit_shift_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
...
!20 = distinct !DISubprogram(name: "bit_shift_007_good", scope: !7, file: !7, line: 19, type: !8, isLocal: false, isDefinition: true, scopeLine: 20, isOptimized: false, unit: !0, variables: !2)
