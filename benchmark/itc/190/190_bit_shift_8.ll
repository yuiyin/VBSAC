; ModuleID = './190_bit_shift_8.c'
source_filename = "./190_bit_shift_8.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define void @bit_shift_011_bad() #0 !dbg !6 {
entry:
  ...
  store i32 5, i32* %shift, align 4, !dbg !15
  ...
  %2 = load i32, i32* %shift, align 4, !dbg !20
  %mul = mul nsw i32 %1, %2, !dbg !21
  %add = add nsw i32 %mul, 7, !dbg !22
  %shl = shl i32 %0, %add, !dbg !23
...
; Function Attrs: nounwind uwtable
define void @bit_shift_011_good() #0 !dbg !26 {
entry:
  %a = alloca i32, align 4
  %shift = alloca i32, align 4
  %ret = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %shift, metadata !29, metadata !12), !dbg !30
  store i32 2, i32* %shift, align 4, !dbg !30
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !31, metadata !12), !dbg !32
  %0 = load i32, i32* %a, align 4, !dbg !33
  %1 = load i32, i32* %shift, align 4, !dbg !34
  %2 = load i32, i32* %shift, align 4, !dbg !35
  %mul = mul nsw i32 %1, %2, !dbg !36
  %add = add nsw i32 %mul, 6, !dbg !37
  %shl = shl i32 %0, %add, !dbg !38
  store i32 %shl, i32* %ret, align 4, !dbg !39
  ret void, !dbg !40
}
...
entry:
  ...
  call void @bit_shift_011_good(), !dbg !44
  call void @bit_shift_011_bad(), !dbg !45
  ret i32 0, !dbg !46
}
...
!1 = !DIFile(filename: "190_bit_shift_8.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "bit_shift_011_bad", scope: !7, file: !7, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./190_bit_shift_8.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/190")
...
!19 = !DILocation(line: 12, column: 15, scope: !6)
!20 = !DILocation(line: 12, column: 23, scope: !6)
!21 = !DILocation(line: 12, column: 21, scope: !6)
!22 = !DILocation(line: 12, column: 30, scope: !6)
!23 = !DILocation(line: 12, column: 10, scope: !6)
!24 = !DILocation(line: 12, column: 6, scope: !6)
!25 = !DILocation(line: 14, column: 1, scope: !6)
!26 = distinct !DISubprogram(name: "bit_shift_011_good", scope: !7, file: !7, line: 20, type: !8, isLocal: false, isDefinition: true, scopeLine: 21, isOptimized: false, unit: !0, variables: !2)
!27 = !DILocalVariable(name: "a", scope: !26, file: !7, line: 22, type: !11)
!28 = !DILocation(line: 22, column: 6, scope: !26)
!29 = !DILocalVariable(name: "shift", scope: !26, file: !7, line: 23, type: !11)
...
!34 = !DILocation(line: 25, column: 15, scope: !26)
!35 = !DILocation(line: 25, column: 23, scope: !26)
!36 = !DILocation(line: 25, column: 21, scope: !26)
!37 = !DILocation(line: 25, column: 30, scope: !26)
