; ModuleID = './191_data_underflow_9.c'
source_filename = "./191_data_underflow_9.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@data_underflow_012_bad.dlist = private unnamed_addr constant [4 x i32] [i32 0, i32 1, i32 -2, i32 -1], align 16
@data_underflow_012_good.dlist = private unnamed_addr constant [4 x i32] [i32 0, i32 1, i32 -2, i32 -1], align 16

; Function Attrs: nounwind uwtable
define void @data_underflow_012_bad() #0 !dbg !6 {
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([4 x i32]* @data_underflow_012_bad.dlist to i8*), i64 16, i32 16, i1 false), !dbg !18
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !19, metadata !12), !dbg !20
  %1 = load i32, i32* %min, align 4, !dbg !21
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* %dlist, i64 0, i64 2, !dbg !22
...
; Function Attrs: nounwind uwtable
define void @data_underflow_012_good() #0 !dbg !26 {
entry:
  %min = alloca i32, align 4
  %dlist = alloca [4 x i32], align 16
  %ret = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %min, metadata !27, metadata !12), !dbg !28
  store i32 -2147483646, i32* %min, align 4, !dbg !28
  call void @llvm.dbg.declare(metadata [4 x i32]* %dlist, metadata !29, metadata !12), !dbg !30
  %0 = bitcast [4 x i32]* %dlist to i8*, !dbg !30
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %0, i8* bitcast ([4 x i32]* @data_underflow_012_good.dlist to i8*), i64 16, i32 16, i1 false), !dbg !30
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !31, metadata !12), !dbg !32
  %1 = load i32, i32* %min, align 4, !dbg !33
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* %dlist, i64 0, i64 2, !dbg !34
...
entry:
  ...
  call void @data_underflow_012_good(), !dbg !41
  call void @data_underflow_012_bad(), !dbg !42
  ret i32 0, !dbg !43
}
...
!1 = !DIFile(filename: "191_data_underflow_9.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/191")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "data_underflow_012_bad", scope: !7, file: !7, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./191_data_underflow_9.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/191")
...
!26 = distinct !DISubprogram(name: "data_underflow_012_good", scope: !7, file: !7, line: 20, type: !8, isLocal: false, isDefinition: true, scopeLine: 21, isOptimized: false, unit: !0, variables: !2)
!27 = !DILocalVariable(name: "min", scope: !26, file: !7, line: 22, type: !11)
