; ModuleID = './191_data_underflow_3.c'
source_filename = "./191_data_underflow_3.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define void @data_underflow_004_bad() #0 !dbg !6 {
entry:
  %min = alloca i32, align 4
  %ret = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %min, metadata !10, metadata !12), !dbg !13
  store i32 -2147483521, i32* %min, align 4, !dbg !13
  call void @llvm.dbg.declare(metadata i32* %ret, metadata !14, metadata !12), !dbg !15
  %0 = load i32, i32* %min, align 4, !dbg !16
  %sub = sub nsw i32 %0, 128, !dbg !17
  store i32 %sub, i32* %ret, align 4, !dbg !18
  ret void, !dbg !19
}
...
entry:
  ...
  call void @data_underflow_004_good(), !dbg !32
  call void @data_underflow_004_bad(), !dbg !33
  ret i32 0, !dbg !34
}
...
!1 = !DIFile(filename: "191_data_underflow_3.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/191")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{!"clang version 3.9.0 (tags/RELEASE_390/final)"}
!6 = distinct !DISubprogram(name: "data_underflow_004_bad", scope: !7, file: !7, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!7 = !DIFile(filename: "./191_data_underflow_3.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/itc/191")
...
!20 = distinct !DISubprogram(name: "data_underflow_004_good", scope: !7, file: !7, line: 19, type: !8, isLocal: false, isDefinition: true, scopeLine: 20, isOptimized: false, unit: !0, variables: !2)
