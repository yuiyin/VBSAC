...
while.body:                                       ; preds = %entry
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !78, metadata !33), !dbg !88
...
; Function Attrs: nounwind uwtable
define void @good16() #0 !dbg !102 {
entry:
  %twoIntsStructPointer = alloca %struct._twoIntsStruct*, align 8
  br label %while.body, !dbg !103

while.body:                                       ; preds = %entry
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !104, metadata !33), !dbg !107
  store %struct._twoIntsStruct* null, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !107
  %0 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !108
  %cmp = icmp ne %struct._twoIntsStruct* %0, null, !dbg !110
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !111

land.lhs.true:                                    ; preds = %while.body
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !112
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %1, i32 0, i32 0, !dbg !114
  %2 = load i32, i32* %intOne, align 4, !dbg !114
  %cmp1 = icmp eq i32 %2, 5, !dbg !115
  br i1 %cmp1, label %if.then, label %if.end, !dbg !116

if.then:                                          ; preds = %land.lhs.true
  call void @printLine(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)), !dbg !117
...
entry:
  ...
  call void @good16(), !dbg !123
  call void @bad16(), !dbg !124
  ret i32 1, !dbg !125
}
...
!1 = !DIFile(filename: "476_16.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_16.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!78 = !DILocalVariable(name: "twoIntsStructPointer", scope: !79, file: !8, line: 64, type: !81)
!79 = distinct !DILexicalBlock(scope: !80, file: !8, line: 63, column: 9)
...
!88 = !DILocation(line: 64, column: 28, scope: !79)
!89 = !DILocation(line: 67, column: 18, scope: !90)
!90 = distinct !DILexicalBlock(scope: !79, file: !8, line: 67, column: 17)
...
!96 = !DILocation(line: 67, column: 17, scope: !79)
...
!100 = !DILocation(line: 72, column: 9, scope: !80)
!101 = !DILocation(line: 74, column: 1, scope: !74)
!102 = distinct !DISubprogram(name: "good16", scope: !8, file: !8, line: 80, type: !75, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
!103 = !DILocation(line: 82, column: 5, scope: !102)
!104 = !DILocalVariable(name: "twoIntsStructPointer", scope: !105, file: !8, line: 85, type: !81)
!105 = distinct !DILexicalBlock(scope: !106, file: !8, line: 84, column: 9)
!106 = distinct !DILexicalBlock(scope: !102, file: !8, line: 83, column: 5)
!107 = !DILocation(line: 85, column: 28, scope: !105)
!108 = !DILocation(line: 88, column: 18, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !8, line: 88, column: 17)
!110 = !DILocation(line: 88, column: 39, scope: !109)
!111 = !DILocation(line: 88, column: 48, scope: !109)
!112 = !DILocation(line: 88, column: 52, scope: !113)
!113 = !DILexicalBlockFile(scope: !109, file: !8, discriminator: 1)
!114 = !DILocation(line: 88, column: 74, scope: !113)
!115 = !DILocation(line: 88, column: 81, scope: !113)
!116 = !DILocation(line: 88, column: 17, scope: !113)
!117 = !DILocation(line: 90, column: 17, scope: !118)
!118 = distinct !DILexicalBlock(scope: !109, file: !8, line: 89, column: 13)
!119 = !DILocation(line: 91, column: 13, scope: !118)
!120 = !DILocation(line: 93, column: 9, scope: !106)
!121 = !DILocation(line: 95, column: 1, scope: !102)
!122 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 100, type: !19, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!123 = !DILocation(line: 101, column: 2, scope: !122)
!124 = !DILocation(line: 102, column: 5, scope: !122)
!125 = !DILocation(line: 103, column: 5, scope: !122)
