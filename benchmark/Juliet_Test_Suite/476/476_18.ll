...
; Function Attrs: nounwind uwtable
define void @bad18() #0 !dbg !74 {
entry:
  %twoIntsStructPointer = alloca %struct._twoIntsStruct*, align 8
  br label %sink, !dbg !77

sink:                                             ; preds = %entry
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !78, metadata !33), !dbg !87
  store %struct._twoIntsStruct* null, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !87
  %0 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !88
  %cmp = icmp ne %struct._twoIntsStruct* %0, null, !dbg !90
  %conv = zext i1 %cmp to i32, !dbg !90
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !91
  ...
  %cmp1 = icmp eq i32 %2, 5, !dbg !93
  %conv2 = zext i1 %cmp1 to i32, !dbg !93
  %and = and i32 %conv, %conv2, !dbg !94
  %tobool = icmp ne i32 %and, 0, !dbg !94
  br i1 %tobool, label %if.then, label %if.end, !dbg !95

if.then:                                          ; preds = %sink
  call void @printLine(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)), !dbg !96
...
; Function Attrs: nounwind uwtable
define void @good18() #0 !dbg !100 {
entry:
  %twoIntsStructPointer = alloca %struct._twoIntsStruct*, align 8
  br label %sink, !dbg !101

sink:                                             ; preds = %entry
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !102, metadata !33), !dbg !104
  store %struct._twoIntsStruct* null, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !104
  %0 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !105
  %cmp = icmp ne %struct._twoIntsStruct* %0, null, !dbg !107
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !108

land.lhs.true:                                    ; preds = %sink
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !109
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %1, i32 0, i32 0, !dbg !111
  %2 = load i32, i32* %intOne, align 4, !dbg !111
  %cmp1 = icmp eq i32 %2, 5, !dbg !112
  br i1 %cmp1, label %if.then, label %if.end, !dbg !113

if.then:                                          ; preds = %land.lhs.true
  call void @printLine(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)), !dbg !114
...
entry:
  ...
  call void @good18(), !dbg !119
  call void @bad18(), !dbg !120
  ret i32 1, !dbg !121
}
...
!1 = !DIFile(filename: "476_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad18", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocation(line: 61, column: 5, scope: !74)
!78 = !DILocalVariable(name: "twoIntsStructPointer", scope: !79, file: !8, line: 64, type: !80)
!79 = distinct !DILexicalBlock(scope: !74, file: !8, line: 63, column: 5)
!80 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !81, size: 64, align: 64)
!81 = !DIDerivedType(tag: DW_TAG_typedef, name: "twoIntsStruct", file: !82, line: 14, baseType: !83)
!82 = !DIFile(filename: "./476.h", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!83 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_twoIntsStruct", file: !82, line: 10, size: 64, align: 32, elements: !84)
!84 = !{!85, !86}
!85 = !DIDerivedType(tag: DW_TAG_member, name: "intOne", scope: !83, file: !82, line: 12, baseType: !4, size: 32, align: 32)
!86 = !DIDerivedType(tag: DW_TAG_member, name: "intTwo", scope: !83, file: !82, line: 13, baseType: !4, size: 32, align: 32, offset: 32)
!87 = !DILocation(line: 64, column: 24, scope: !79)
!88 = !DILocation(line: 67, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !79, file: !8, line: 67, column: 13)
!90 = !DILocation(line: 67, column: 35, scope: !89)
!91 = !DILocation(line: 67, column: 47, scope: !89)
!92 = !DILocation(line: 67, column: 69, scope: !89)
!93 = !DILocation(line: 67, column: 76, scope: !89)
!94 = !DILocation(line: 67, column: 44, scope: !89)
!95 = !DILocation(line: 67, column: 13, scope: !79)
!96 = !DILocation(line: 69, column: 13, scope: !97)
!97 = distinct !DILexicalBlock(scope: !89, file: !8, line: 68, column: 9)
!98 = !DILocation(line: 70, column: 9, scope: !97)
!99 = !DILocation(line: 72, column: 1, scope: !74)
!100 = distinct !DISubprogram(name: "good18", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!101 = !DILocation(line: 80, column: 5, scope: !100)
!102 = !DILocalVariable(name: "twoIntsStructPointer", scope: !103, file: !8, line: 83, type: !80)
!103 = distinct !DILexicalBlock(scope: !100, file: !8, line: 82, column: 5)
!104 = !DILocation(line: 83, column: 24, scope: !103)
!105 = !DILocation(line: 86, column: 14, scope: !106)
!106 = distinct !DILexicalBlock(scope: !103, file: !8, line: 86, column: 13)
!107 = !DILocation(line: 86, column: 35, scope: !106)
!108 = !DILocation(line: 86, column: 44, scope: !106)
!109 = !DILocation(line: 86, column: 48, scope: !110)
!110 = !DILexicalBlockFile(scope: !106, file: !8, discriminator: 1)
!111 = !DILocation(line: 86, column: 70, scope: !110)
!112 = !DILocation(line: 86, column: 77, scope: !110)
!113 = !DILocation(line: 86, column: 13, scope: !110)
!114 = !DILocation(line: 88, column: 13, scope: !115)
!115 = distinct !DILexicalBlock(scope: !106, file: !8, line: 87, column: 9)
!116 = !DILocation(line: 89, column: 9, scope: !115)
!117 = !DILocation(line: 91, column: 1, scope: !100)
!118 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 97, type: !19, isLocal: false, isDefinition: true, scopeLine: 97, isOptimized: false, unit: !0, variables: !2)
!119 = !DILocation(line: 98, column: 5, scope: !118)
!120 = !DILocation(line: 99, column: 2, scope: !118)
!121 = !DILocation(line: 100, column: 5, scope: !118)
