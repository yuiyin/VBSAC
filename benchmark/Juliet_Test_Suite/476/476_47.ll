...
if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !83, metadata !35), !dbg !86
  store i32* null, i32** %intPointer, align 8, !dbg !86
  %call = call noalias i8* @malloc(i64 4) #4, !dbg !87
  %1 = bitcast i8* %call to i32*, !dbg !88
  store i32* %1, i32** %intPointer, align 8, !dbg !89
  %2 = load i32*, i32** %intPointer, align 8, !dbg !90
  store i32 5, i32* %2, align 4, !dbg !91
  %3 = load i32*, i32** %intPointer, align 8, !dbg !92
  %4 = load i32, i32* %3, align 4, !dbg !93
  call void @printIntLine(i32 %4), !dbg !94
  %5 = load i32*, i32** %intPointer, align 8, !dbg !95
  %cmp1 = icmp ne i32* %5, null, !dbg !97
  br i1 %cmp1, label %if.then2, label %if.end, !dbg !98

if.then2:                                         ; preds = %if.then
  %6 = load i32*, i32** %intPointer, align 8, !dbg !99
  store i32 10, i32* %6, align 4, !dbg !101
  br label %if.end, !dbg !102

if.end:                                           ; preds = %if.then2, %if.then
  %7 = load i32*, i32** %intPointer, align 8, !dbg !103
  %8 = load i32, i32* %7, align 4, !dbg !104
  call void @printIntLine(i32 %8), !dbg !105
...
if.else:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !116, metadata !35), !dbg !119
  store i32* null, i32** %intPointer, align 8, !dbg !119
  %1 = load i32*, i32** %intPointer, align 8, !dbg !120
  %cmp1 = icmp eq i32* %1, null, !dbg !122
  br i1 %cmp1, label %if.then2, label %if.end, !dbg !123

if.then2:                                         ; preds = %if.else
  call void @printLine(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0)), !dbg !124
...
entry:
  ...
  call void @good47(), !dbg !129
  call void @bad47(), !dbg !130
  ret i32 1, !dbg !131
}
...
!1 = !DIFile(filename: "476_47.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5, !6}
...
!9 = !DIFile(filename: "./476_47.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!76 = distinct !DISubprogram(name: "bad47", scope: !9, file: !9, line: 61, type: !77, isLocal: false, isDefinition: true, scopeLine: 62, isOptimized: false, unit: !0, variables: !2)
!77 = !DISubroutineType(types: !78)
!78 = !{null}
!79 = !DILocation(line: 63, column: 8, scope: !80)
!80 = distinct !DILexicalBlock(scope: !76, file: !9, line: 63, column: 8)
!81 = !DILocation(line: 63, column: 18, scope: !80)
!82 = !DILocation(line: 63, column: 8, scope: !76)
!83 = !DILocalVariable(name: "intPointer", scope: !84, file: !9, line: 66, type: !6)
!84 = distinct !DILexicalBlock(scope: !85, file: !9, line: 65, column: 9)
!85 = distinct !DILexicalBlock(scope: !80, file: !9, line: 64, column: 5)
!86 = !DILocation(line: 66, column: 18, scope: !84)
!87 = !DILocation(line: 67, column: 33, scope: !84)
!88 = !DILocation(line: 67, column: 26, scope: !84)
!89 = !DILocation(line: 67, column: 24, scope: !84)
!90 = !DILocation(line: 68, column: 14, scope: !84)
!91 = !DILocation(line: 68, column: 25, scope: !84)
!92 = !DILocation(line: 69, column: 27, scope: !84)
!93 = !DILocation(line: 69, column: 26, scope: !84)
!94 = !DILocation(line: 69, column: 13, scope: !84)
!95 = !DILocation(line: 71, column: 17, scope: !96)
!96 = distinct !DILexicalBlock(scope: !84, file: !9, line: 71, column: 17)
!97 = !DILocation(line: 71, column: 28, scope: !96)
!98 = !DILocation(line: 71, column: 17, scope: !84)
!99 = !DILocation(line: 73, column: 18, scope: !100)
!100 = distinct !DILexicalBlock(scope: !96, file: !9, line: 72, column: 13)
!101 = !DILocation(line: 73, column: 29, scope: !100)
!102 = !DILocation(line: 74, column: 13, scope: !100)
!103 = !DILocation(line: 75, column: 27, scope: !84)
!104 = !DILocation(line: 75, column: 26, scope: !84)
!105 = !DILocation(line: 75, column: 13, scope: !84)
!106 = !DILocation(line: 77, column: 5, scope: !85)
!107 = !DILocation(line: 78, column: 1, scope: !76)
!108 = distinct !DISubprogram(name: "good47", scope: !9, file: !9, line: 84, type: !77, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: false, unit: !0, variables: !2)
!109 = !DILocation(line: 86, column: 8, scope: !110)
!110 = distinct !DILexicalBlock(scope: !108, file: !9, line: 86, column: 8)
!111 = !DILocation(line: 86, column: 18, scope: !110)
!112 = !DILocation(line: 86, column: 8, scope: !108)
!113 = !DILocation(line: 89, column: 9, scope: !114)
!114 = distinct !DILexicalBlock(scope: !110, file: !9, line: 87, column: 5)
!115 = !DILocation(line: 90, column: 5, scope: !114)
!116 = !DILocalVariable(name: "intPointer", scope: !117, file: !9, line: 95, type: !6)
!117 = distinct !DILexicalBlock(scope: !118, file: !9, line: 93, column: 9)
!118 = distinct !DILexicalBlock(scope: !110, file: !9, line: 92, column: 5)
!119 = !DILocation(line: 95, column: 18, scope: !117)
!120 = !DILocation(line: 96, column: 17, scope: !121)
!121 = distinct !DILexicalBlock(scope: !117, file: !9, line: 96, column: 17)
!122 = !DILocation(line: 96, column: 28, scope: !121)
!123 = !DILocation(line: 96, column: 17, scope: !117)
!124 = !DILocation(line: 98, column: 17, scope: !125)
!125 = distinct !DILexicalBlock(scope: !121, file: !9, line: 97, column: 13)
!126 = !DILocation(line: 99, column: 13, scope: !125)
!127 = !DILocation(line: 102, column: 1, scope: !108)
!128 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 106, type: !21, isLocal: false, isDefinition: true, scopeLine: 106, isOptimized: false, unit: !0, variables: !2)
!129 = !DILocation(line: 107, column: 5, scope: !128)
!130 = !DILocation(line: 108, column: 2, scope: !128)
!131 = !DILocation(line: 109, column: 5, scope: !128)
