...
; Function Attrs: nounwind uwtable
define void @bad23() #0 !dbg !76 {
entry:
  %data = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %data, metadata !79, metadata !35), !dbg !81
...
if.then2:                                         ; preds = %if.end
  ...
  %3 = load i32, i32* %2, align 4, !dbg !93
  call void @printIntLine(i32 %3), !dbg !94
...
; Function Attrs: nounwind uwtable
define void @good23() #0 !dbg !97 {
entry:
  %data = alloca i32*, align 8
  call void @llvm.dbg.declare(metadata i32** %data, metadata !98, metadata !35), !dbg !99
...
if.else:                                          ; preds = %if.end
  ...
  %cmp = icmp ne i32* %2, null, !dbg !115
...
entry:
  ...
  call void @good23(), !dbg !126
  call void @bad23(), !dbg !127
  ret i32 1, !dbg !128
}
...
!1 = !DIFile(filename: "476_23.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_23.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!76 = distinct !DISubprogram(name: "bad23", scope: !8, file: !8, line: 62, type: !77, isLocal: false, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
...
!81 = !DILocation(line: 64, column: 11, scope: !76)
...
!91 = !DILocation(line: 73, column: 23, scope: !92)
...
!97 = distinct !DISubprogram(name: "good23", scope: !8, file: !8, line: 81, type: !77, isLocal: false, isDefinition: true, scopeLine: 82, isOptimized: false, unit: !0, variables: !2)
!98 = !DILocalVariable(name: "data", scope: !97, file: !8, line: 83, type: !80)
!99 = !DILocation(line: 83, column: 11, scope: !97)
...
!117 = !DILocation(line: 99, column: 27, scope: !118)
!118 = distinct !DILexicalBlock(scope: !113, file: !8, line: 98, column: 9)
!119 = !DILocation(line: 99, column: 26, scope: !118)
...
!125 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 110, type: !21, isLocal: false, isDefinition: true, scopeLine: 110, isOptimized: false, unit: !0, variables: !2)
!126 = !DILocation(line: 111, column: 5, scope: !125)
!127 = !DILocation(line: 112, column: 2, scope: !125)
!128 = !DILocation(line: 113, column: 5, scope: !125)
