...
entry:
  ...
  %1 = load i64, i64* %0, align 8, !dbg !82
  call void @printLongLine(i64 %1), !dbg !83
  ret void, !dbg !84
}

; Function Attrs: nounwind uwtable
define void @good31() #0 !dbg !85 {
entry:
  %data = alloca i64*, align 8
  %tmpData = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64** %data, metadata !86, metadata !33), !dbg !87
  call void @llvm.dbg.declare(metadata i64* %tmpData, metadata !88, metadata !33), !dbg !90
  store i64 5, i64* %tmpData, align 8, !dbg !90
  store i64* %tmpData, i64** %data, align 8, !dbg !91
  %0 = load i64*, i64** %data, align 8, !dbg !92
  %1 = load i64, i64* %0, align 8, !dbg !93
  call void @printLongLine(i64 %1), !dbg !94
  ret void, !dbg !95
}
...
entry:
  ...
  call void @good31(), !dbg !97
  call void @bad31(), !dbg !98
  ret i32 1, !dbg !99
}
...
!1 = !DIFile(filename: "476_31.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_31.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad31", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!81 = !DILocation(line: 65, column: 20, scope: !74)
!82 = !DILocation(line: 65, column: 19, scope: !74)
!83 = !DILocation(line: 65, column: 5, scope: !74)
!84 = !DILocation(line: 66, column: 1, scope: !74)
!85 = distinct !DISubprogram(name: "good31", scope: !8, file: !8, line: 72, type: !75, isLocal: false, isDefinition: true, scopeLine: 73, isOptimized: false, unit: !0, variables: !2)
!86 = !DILocalVariable(name: "data", scope: !85, file: !8, line: 74, type: !78)
!87 = !DILocation(line: 74, column: 12, scope: !85)
!88 = !DILocalVariable(name: "tmpData", scope: !89, file: !8, line: 77, type: !68)
!89 = distinct !DILexicalBlock(scope: !85, file: !8, line: 76, column: 5)
!90 = !DILocation(line: 77, column: 14, scope: !89)
!91 = !DILocation(line: 78, column: 14, scope: !89)
!92 = !DILocation(line: 81, column: 20, scope: !85)
!93 = !DILocation(line: 81, column: 19, scope: !85)
!94 = !DILocation(line: 81, column: 5, scope: !85)
!95 = !DILocation(line: 82, column: 1, scope: !85)
!96 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 85, type: !19, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: false, unit: !0, variables: !2)
!97 = !DILocation(line: 86, column: 5, scope: !96)
!98 = !DILocation(line: 87, column: 2, scope: !96)
!99 = !DILocation(line: 88, column: 5, scope: !96)
