...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %j, metadata !77, metadata !33), !dbg !78
  store i32 0, i32* %j, align 4, !dbg !79
  br label %for.cond, !dbg !81

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %j, align 4, !dbg !82
  %cmp = icmp slt i32 %0, 1, !dbg !85
  br i1 %cmp, label %for.body, label %for.end, !dbg !86

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !87, metadata !33), !dbg !97
  store %struct._twoIntsStruct* null, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !97
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !98
  %cmp1 = icmp ne %struct._twoIntsStruct* %1, null, !dbg !100
  %conv = zext i1 %cmp1 to i32, !dbg !100
  %2 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !101
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %2, i32 0, i32 0, !dbg !102
  %3 = load i32, i32* %intOne, align 4, !dbg !102
  %cmp2 = icmp eq i32 %3, 5, !dbg !103
  %conv3 = zext i1 %cmp2 to i32, !dbg !103
  %and = and i32 %conv, %conv3, !dbg !104
  %tobool = icmp ne i32 %and, 0, !dbg !104
  br i1 %tobool, label %if.then, label %if.end, !dbg !105

if.then:                                          ; preds = %for.body
  call void @printLine(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)), !dbg !106
...
for.inc:                                          ; preds = %if.end
  %4 = load i32, i32* %j, align 4, !dbg !110
  %inc = add nsw i32 %4, 1, !dbg !110
  store i32 %inc, i32* %j, align 4, !dbg !110
...
; Function Attrs: nounwind uwtable
define void @good17() #0 !dbg !116 {
entry:
  %k = alloca i32, align 4
  %twoIntsStructPointer = alloca %struct._twoIntsStruct*, align 8
  call void @llvm.dbg.declare(metadata i32* %k, metadata !117, metadata !33), !dbg !118
  store i32 0, i32* %k, align 4, !dbg !119
  br label %for.cond, !dbg !121

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %k, align 4, !dbg !122
  %cmp = icmp slt i32 %0, 1, !dbg !125
  br i1 %cmp, label %for.body, label %for.end, !dbg !126

for.body:                                         ; preds = %for.cond
  call void @llvm.dbg.declare(metadata %struct._twoIntsStruct** %twoIntsStructPointer, metadata !127, metadata !33), !dbg !130
  store %struct._twoIntsStruct* null, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !130
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !131
  %cmp1 = icmp ne %struct._twoIntsStruct* %1, null, !dbg !133
  br i1 %cmp1, label %land.lhs.true, label %if.end, !dbg !134

land.lhs.true:                                    ; preds = %for.body
  %2 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !135
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %2, i32 0, i32 0, !dbg !137
  %3 = load i32, i32* %intOne, align 4, !dbg !137
  %cmp2 = icmp eq i32 %3, 5, !dbg !138
  br i1 %cmp2, label %if.then, label %if.end, !dbg !139

if.then:                                          ; preds = %land.lhs.true
  call void @printLine(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0)), !dbg !140
...
for.inc:                                          ; preds = %if.end
  %4 = load i32, i32* %k, align 4, !dbg !144
...
entry:
  ...
  call void @good17(), !dbg !151
  call void @bad17(), !dbg !152
  ret i32 1, !dbg !153
}
...
!1 = !DIFile(filename: "476_17.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_17.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!76 = !{null}
!77 = !DILocalVariable(name: "j", scope: !74, file: !8, line: 61, type: !4)
!78 = !DILocation(line: 61, column: 9, scope: !74)
!79 = !DILocation(line: 62, column: 11, scope: !80)
!80 = distinct !DILexicalBlock(scope: !74, file: !8, line: 62, column: 5)
!81 = !DILocation(line: 62, column: 9, scope: !80)
!82 = !DILocation(line: 62, column: 16, scope: !83)
!83 = !DILexicalBlockFile(scope: !84, file: !8, discriminator: 1)
!84 = distinct !DILexicalBlock(scope: !80, file: !8, line: 62, column: 5)
!85 = !DILocation(line: 62, column: 18, scope: !83)
!86 = !DILocation(line: 62, column: 5, scope: !83)
!87 = !DILocalVariable(name: "twoIntsStructPointer", scope: !88, file: !8, line: 65, type: !90)
!88 = distinct !DILexicalBlock(scope: !89, file: !8, line: 64, column: 9)
!89 = distinct !DILexicalBlock(scope: !84, file: !8, line: 63, column: 5)
!90 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !91, size: 64, align: 64)
!91 = !DIDerivedType(tag: DW_TAG_typedef, name: "twoIntsStruct", file: !92, line: 14, baseType: !93)
!92 = !DIFile(filename: "./476.h", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!93 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_twoIntsStruct", file: !92, line: 10, size: 64, align: 32, elements: !94)
!94 = !{!95, !96}
!95 = !DIDerivedType(tag: DW_TAG_member, name: "intOne", scope: !93, file: !92, line: 12, baseType: !4, size: 32, align: 32)
!96 = !DIDerivedType(tag: DW_TAG_member, name: "intTwo", scope: !93, file: !92, line: 13, baseType: !4, size: 32, align: 32, offset: 32)
!97 = !DILocation(line: 65, column: 28, scope: !88)
!98 = !DILocation(line: 68, column: 18, scope: !99)
!99 = distinct !DILexicalBlock(scope: !88, file: !8, line: 68, column: 17)
!100 = !DILocation(line: 68, column: 39, scope: !99)
!101 = !DILocation(line: 68, column: 51, scope: !99)
!102 = !DILocation(line: 68, column: 73, scope: !99)
!103 = !DILocation(line: 68, column: 80, scope: !99)
!104 = !DILocation(line: 68, column: 48, scope: !99)
!105 = !DILocation(line: 68, column: 17, scope: !88)
!106 = !DILocation(line: 70, column: 17, scope: !107)
!107 = distinct !DILexicalBlock(scope: !99, file: !8, line: 69, column: 13)
!108 = !DILocation(line: 71, column: 13, scope: !107)
!109 = !DILocation(line: 73, column: 5, scope: !89)
!110 = !DILocation(line: 62, column: 24, scope: !111)
!111 = !DILexicalBlockFile(scope: !84, file: !8, discriminator: 2)
!112 = !DILocation(line: 62, column: 5, scope: !111)
!113 = distinct !{!113, !114}
!114 = !DILocation(line: 62, column: 5, scope: !74)
!115 = !DILocation(line: 74, column: 1, scope: !74)
!116 = distinct !DISubprogram(name: "good17", scope: !8, file: !8, line: 80, type: !75, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
!117 = !DILocalVariable(name: "k", scope: !116, file: !8, line: 82, type: !4)
!118 = !DILocation(line: 82, column: 9, scope: !116)
!119 = !DILocation(line: 83, column: 11, scope: !120)
!120 = distinct !DILexicalBlock(scope: !116, file: !8, line: 83, column: 5)
!121 = !DILocation(line: 83, column: 9, scope: !120)
!122 = !DILocation(line: 83, column: 16, scope: !123)
!123 = !DILexicalBlockFile(scope: !124, file: !8, discriminator: 1)
!124 = distinct !DILexicalBlock(scope: !120, file: !8, line: 83, column: 5)
!125 = !DILocation(line: 83, column: 18, scope: !123)
!126 = !DILocation(line: 83, column: 5, scope: !123)
!127 = !DILocalVariable(name: "twoIntsStructPointer", scope: !128, file: !8, line: 86, type: !90)
!128 = distinct !DILexicalBlock(scope: !129, file: !8, line: 85, column: 9)
!129 = distinct !DILexicalBlock(scope: !124, file: !8, line: 84, column: 5)
!130 = !DILocation(line: 86, column: 28, scope: !128)
!131 = !DILocation(line: 89, column: 18, scope: !132)
!132 = distinct !DILexicalBlock(scope: !128, file: !8, line: 89, column: 17)
!133 = !DILocation(line: 89, column: 39, scope: !132)
!134 = !DILocation(line: 89, column: 48, scope: !132)
!135 = !DILocation(line: 89, column: 52, scope: !136)
!136 = !DILexicalBlockFile(scope: !132, file: !8, discriminator: 1)
!137 = !DILocation(line: 89, column: 74, scope: !136)
!138 = !DILocation(line: 89, column: 81, scope: !136)
!139 = !DILocation(line: 89, column: 17, scope: !136)
!140 = !DILocation(line: 91, column: 17, scope: !141)
!141 = distinct !DILexicalBlock(scope: !132, file: !8, line: 90, column: 13)
!142 = !DILocation(line: 92, column: 13, scope: !141)
!143 = !DILocation(line: 94, column: 5, scope: !129)
!144 = !DILocation(line: 83, column: 24, scope: !145)
!145 = !DILexicalBlockFile(scope: !124, file: !8, discriminator: 2)
!146 = !DILocation(line: 83, column: 5, scope: !145)
!147 = distinct !{!147, !148}
!148 = !DILocation(line: 83, column: 5, scope: !116)
!149 = !DILocation(line: 95, column: 1, scope: !116)
!150 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 100, type: !19, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!151 = !DILocation(line: 101, column: 5, scope: !150)
!152 = !DILocation(line: 102, column: 2, scope: !150)
!153 = !DILocation(line: 103, column: 5, scope: !150)
