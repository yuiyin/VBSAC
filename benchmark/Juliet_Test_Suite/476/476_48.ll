...
if.then:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0)), !dbg !81
  br label %if.end2, !dbg !83

if.else:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !84, metadata !34), !dbg !87
  store i32* null, i32** %intPointer, align 8, !dbg !87
  %0 = load i32*, i32** %intPointer, align 8, !dbg !88
  %cmp = icmp eq i32* %0, null, !dbg !90
  br i1 %cmp, label %if.then1, label %if.end, !dbg !91

if.then1:                                         ; preds = %if.else
  call void @printLine(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0)), !dbg !92
...
; Function Attrs: nounwind uwtable
define void @good48() #0 !dbg !96 {
entry:
  %intPointer = alloca i32*, align 8
  %call = call i32 @staticReturnsFalse(), !dbg !97
  %tobool = icmp ne i32 %call, 0, !dbg !97
  br i1 %tobool, label %if.then, label %if.else, !dbg !99

if.then:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0)), !dbg !100
  br label %if.end, !dbg !102

if.else:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32** %intPointer, metadata !103, metadata !34), !dbg !106
  store i32* null, i32** %intPointer, align 8, !dbg !106
  %call1 = call noalias i8* @malloc(i64 4) #4, !dbg !107
  %0 = bitcast i8* %call1 to i32*, !dbg !108
  store i32* %0, i32** %intPointer, align 8, !dbg !109
  %1 = load i32*, i32** %intPointer, align 8, !dbg !110
  store i32 5, i32* %1, align 4, !dbg !111
  %2 = load i32*, i32** %intPointer, align 8, !dbg !112
  %3 = load i32, i32* %2, align 4, !dbg !113
  call void @printIntLine(i32 %3), !dbg !114
  %4 = load i32*, i32** %intPointer, align 8, !dbg !115
  store i32 10, i32* %4, align 4, !dbg !116
  %5 = load i32*, i32** %intPointer, align 8, !dbg !117
  %6 = load i32, i32* %5, align 4, !dbg !118
...
entry:
  ...
  call void @good48(), !dbg !122
  call void @bad48(), !dbg !123
  ret i32 1, !dbg !124
}

; Function Attrs: nounwind uwtable
define internal i32 @staticReturnsFalse() #0 !dbg !125 {
entry:
  ret i32 0, !dbg !126
}
...
!1 = !DIFile(filename: "476_48.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5, !6}
...
!9 = !DIFile(filename: "./476_48.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!75 = distinct !DISubprogram(name: "bad48", scope: !9, file: !9, line: 69, type: !76, isLocal: false, isDefinition: true, scopeLine: 70, isOptimized: false, unit: !0, variables: !2)
!76 = !DISubroutineType(types: !77)
!77 = !{null}
!78 = !DILocation(line: 71, column: 8, scope: !79)
!79 = distinct !DILexicalBlock(scope: !75, file: !9, line: 71, column: 8)
!80 = !DILocation(line: 71, column: 8, scope: !75)
!81 = !DILocation(line: 74, column: 9, scope: !82)
!82 = distinct !DILexicalBlock(scope: !79, file: !9, line: 72, column: 5)
!83 = !DILocation(line: 75, column: 5, scope: !82)
!84 = !DILocalVariable(name: "intPointer", scope: !85, file: !9, line: 80, type: !6)
!85 = distinct !DILexicalBlock(scope: !86, file: !9, line: 78, column: 9)
!86 = distinct !DILexicalBlock(scope: !79, file: !9, line: 77, column: 5)
!87 = !DILocation(line: 80, column: 18, scope: !85)
!88 = !DILocation(line: 81, column: 17, scope: !89)
!89 = distinct !DILexicalBlock(scope: !85, file: !9, line: 81, column: 17)
!90 = !DILocation(line: 81, column: 28, scope: !89)
!91 = !DILocation(line: 81, column: 17, scope: !85)
!92 = !DILocation(line: 83, column: 17, scope: !93)
!93 = distinct !DILexicalBlock(scope: !89, file: !9, line: 82, column: 13)
!94 = !DILocation(line: 84, column: 13, scope: !93)
!95 = !DILocation(line: 87, column: 1, scope: !75)
!96 = distinct !DISubprogram(name: "good48", scope: !9, file: !9, line: 93, type: !76, isLocal: false, isDefinition: true, scopeLine: 94, isOptimized: false, unit: !0, variables: !2)
!97 = !DILocation(line: 95, column: 8, scope: !98)
!98 = distinct !DILexicalBlock(scope: !96, file: !9, line: 95, column: 8)
!99 = !DILocation(line: 95, column: 8, scope: !96)
!100 = !DILocation(line: 98, column: 9, scope: !101)
!101 = distinct !DILexicalBlock(scope: !98, file: !9, line: 96, column: 5)
!102 = !DILocation(line: 99, column: 5, scope: !101)
!103 = !DILocalVariable(name: "intPointer", scope: !104, file: !9, line: 103, type: !6)
!104 = distinct !DILexicalBlock(scope: !105, file: !9, line: 102, column: 9)
!105 = distinct !DILexicalBlock(scope: !98, file: !9, line: 101, column: 5)
!106 = !DILocation(line: 103, column: 18, scope: !104)
!107 = !DILocation(line: 104, column: 33, scope: !104)
!108 = !DILocation(line: 104, column: 26, scope: !104)
!109 = !DILocation(line: 104, column: 24, scope: !104)
!110 = !DILocation(line: 105, column: 14, scope: !104)
!111 = !DILocation(line: 105, column: 25, scope: !104)
!112 = !DILocation(line: 106, column: 27, scope: !104)
!113 = !DILocation(line: 106, column: 26, scope: !104)
!114 = !DILocation(line: 106, column: 13, scope: !104)
!115 = !DILocation(line: 108, column: 14, scope: !104)
!116 = !DILocation(line: 108, column: 25, scope: !104)
!117 = !DILocation(line: 109, column: 27, scope: !104)
!118 = !DILocation(line: 109, column: 26, scope: !104)
!119 = !DILocation(line: 109, column: 13, scope: !104)
!120 = !DILocation(line: 112, column: 1, scope: !96)
!121 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 115, type: !20, isLocal: false, isDefinition: true, scopeLine: 115, isOptimized: false, unit: !0, variables: !2)
!122 = !DILocation(line: 116, column: 5, scope: !121)
!123 = !DILocation(line: 117, column: 2, scope: !121)
!124 = !DILocation(line: 118, column: 5, scope: !121)
!125 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !9, file: !9, line: 62, type: !20, isLocal: true, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
!126 = !DILocation(line: 64, column: 5, scope: !125)
