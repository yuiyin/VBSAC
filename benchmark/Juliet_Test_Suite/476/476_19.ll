...
entry:
  ...
  %1 = load i32, i32* %0, align 4, !dbg !82
  call void @printIntLine(i32 %1), !dbg !83
  ret void, !dbg !84
}

; Function Attrs: nounwind uwtable
define void @good19() #0 !dbg !85 {
entry:
  %data = alloca i32*, align 8
  %tmpData = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32** %data, metadata !86, metadata !33), !dbg !87
  call void @llvm.dbg.declare(metadata i32* %tmpData, metadata !88, metadata !33), !dbg !90
  store i32 5, i32* %tmpData, align 4, !dbg !90
  store i32* %tmpData, i32** %data, align 8, !dbg !91
...
entry:
  ...
  call void @good19(), !dbg !97
  call void @bad19(), !dbg !98
  ret i32 1, !dbg !99
}
...
!1 = !DIFile(filename: "476_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad19", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!81 = !DILocation(line: 65, column: 19, scope: !74)
!82 = !DILocation(line: 65, column: 18, scope: !74)
!83 = !DILocation(line: 65, column: 5, scope: !74)
!84 = !DILocation(line: 66, column: 1, scope: !74)
!85 = distinct !DISubprogram(name: "good19", scope: !8, file: !8, line: 72, type: !75, isLocal: false, isDefinition: true, scopeLine: 73, isOptimized: false, unit: !0, variables: !2)
!86 = !DILocalVariable(name: "data", scope: !85, file: !8, line: 74, type: !78)
!87 = !DILocation(line: 74, column: 11, scope: !85)
!88 = !DILocalVariable(name: "tmpData", scope: !89, file: !8, line: 77, type: !4)
...
!92 = !DILocation(line: 81, column: 19, scope: !85)
!93 = !DILocation(line: 81, column: 18, scope: !85)
!94 = !DILocation(line: 81, column: 5, scope: !85)
!95 = !DILocation(line: 82, column: 1, scope: !85)
!96 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 87, type: !19, isLocal: false, isDefinition: true, scopeLine: 87, isOptimized: false, unit: !0, variables: !2)
!97 = !DILocation(line: 88, column: 5, scope: !96)
!98 = !DILocation(line: 89, column: 2, scope: !96)
!99 = !DILocation(line: 90, column: 5, scope: !96)
