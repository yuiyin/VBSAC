...
; Function Attrs: nounwind uwtable
define void @bad37() #0 !dbg !75 {
entry:
  %data = alloca i64*, align 8
  call void @llvm.dbg.declare(metadata i64** %data, metadata !78, metadata !34), !dbg !80
...
if.then2:                                         ; preds = %if.end
  ...
  call void @printLongLine(i64 %3), !dbg !95
...
; Function Attrs: nounwind uwtable
define void @good37() #0 !dbg !98 {
entry:
  %data = alloca i64*, align 8
  call void @llvm.dbg.declare(metadata i64** %data, metadata !99, metadata !34), !dbg !100
...
entry:
  ...
  call void @good37(), !dbg !129
  call void @bad37(), !dbg !130
  ret i32 1, !dbg !131
}
...
!1 = !DIFile(filename: "476_37.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_37.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!75 = distinct !DISubprogram(name: "bad37", scope: !8, file: !8, line: 61, type: !76, isLocal: false, isDefinition: true, scopeLine: 62, isOptimized: false, unit: !0, variables: !2)
...
!92 = !DILocation(line: 72, column: 24, scope: !93)
!93 = distinct !DILexicalBlock(scope: !89, file: !8, line: 70, column: 5)
!94 = !DILocation(line: 72, column: 23, scope: !93)
!95 = !DILocation(line: 72, column: 9, scope: !93)
!96 = !DILocation(line: 73, column: 5, scope: !93)
!97 = !DILocation(line: 74, column: 1, scope: !75)
!98 = distinct !DISubprogram(name: "good37", scope: !8, file: !8, line: 80, type: !76, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
...
!120 = !DILocation(line: 98, column: 28, scope: !121)
!121 = distinct !DILexicalBlock(scope: !116, file: !8, line: 97, column: 9)
!122 = !DILocation(line: 98, column: 27, scope: !121)
