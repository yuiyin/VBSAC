...
if.then:                                          ; preds = %entry
  ...
  %2 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !94
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %2, i32 0, i32 0, !dbg !95
  %3 = load i32, i32* %intOne, align 4, !dbg !95
  %cmp1 = icmp eq i32 %3, 5, !dbg !96
...
if.else:                                          ; preds = %entry
  ...
  %1 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !115
  %cmp = icmp ne %struct._twoIntsStruct* %1, null, !dbg !117
  br i1 %cmp, label %land.lhs.true, label %if.end, !dbg !118

land.lhs.true:                                    ; preds = %if.else
  %2 = load %struct._twoIntsStruct*, %struct._twoIntsStruct** %twoIntsStructPointer, align 8, !dbg !119
  %intOne = getelementptr inbounds %struct._twoIntsStruct, %struct._twoIntsStruct* %2, i32 0, i32 0, !dbg !121
  %3 = load i32, i32* %intOne, align 4, !dbg !121
  %cmp1 = icmp eq i32 %3, 5, !dbg !122
...
entry:
  ...
  call void @good10(), !dbg !129
  call void @bad10(), !dbg !130
  ret i32 1, !dbg !131
}
...
!1 = !DIFile(filename: "476_10.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./476_10.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/476")
...
!74 = distinct !DISubprogram(name: "bad10", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!104 = distinct !DISubprogram(name: "good10", scope: !8, file: !8, line: 79, type: !75, isLocal: false, isDefinition: true, scopeLine: 80, isOptimized: false, unit: !0, variables: !2)
!105 = !DILocation(line: 81, column: 8, scope: !106)
!106 = distinct !DILexicalBlock(scope: !104, file: !8, line: 81, column: 8)
!107 = !DILocation(line: 81, column: 8, scope: !104)
!108 = !DILocation(line: 84, column: 9, scope: !109)
!109 = distinct !DILexicalBlock(scope: !106, file: !8, line: 82, column: 5)
!110 = !DILocation(line: 85, column: 5, scope: !109)
!111 = !DILocalVariable(name: "twoIntsStructPointer", scope: !112, file: !8, line: 89, type: !83)
!112 = distinct !DILexicalBlock(scope: !113, file: !8, line: 88, column: 9)
!113 = distinct !DILexicalBlock(scope: !106, file: !8, line: 87, column: 5)
!114 = !DILocation(line: 89, column: 28, scope: !112)
!115 = !DILocation(line: 92, column: 18, scope: !116)
!116 = distinct !DILexicalBlock(scope: !112, file: !8, line: 92, column: 17)
!117 = !DILocation(line: 92, column: 39, scope: !116)
!118 = !DILocation(line: 92, column: 48, scope: !116)
!119 = !DILocation(line: 92, column: 52, scope: !120)
!120 = !DILexicalBlockFile(scope: !116, file: !8, discriminator: 1)
!121 = !DILocation(line: 92, column: 74, scope: !120)
!122 = !DILocation(line: 92, column: 81, scope: !120)
!123 = !DILocation(line: 92, column: 17, scope: !120)
!124 = !DILocation(line: 94, column: 17, scope: !125)
!125 = distinct !DILexicalBlock(scope: !116, file: !8, line: 93, column: 13)
!126 = !DILocation(line: 95, column: 13, scope: !125)
!127 = !DILocation(line: 98, column: 1, scope: !104)
!128 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 101, type: !19, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!129 = !DILocation(line: 102, column: 5, scope: !128)
!130 = !DILocation(line: 103, column: 2, scope: !128)
!131 = !DILocation(line: 104, column: 5, scope: !128)
