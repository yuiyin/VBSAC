...
if.then:                                          ; preds = %entry
  store i8 -128, i8* %data, align 1, !dbg !107
...
if.else:                                          ; preds = %if.end
  ...
  %cmp3 = icmp slt i32 %conv, 0, !dbg !120
  br i1 %cmp3, label %if.then5, label %if.end14, !dbg !121

if.then5:                                         ; preds = %if.else
  %3 = load i8, i8* %data, align 1, !dbg !122
  %conv6 = sext i8 %3 to i32, !dbg !122
  %cmp7 = icmp sgt i32 %conv6, -64, !dbg !125
  br i1 %cmp7, label %if.then9, label %if.else12, !dbg !126

if.then9:                                         ; preds = %if.then5
  call void @llvm.dbg.declare(metadata i8* %result, metadata !127, metadata !17), !dbg !129
  %4 = load i8, i8* %data, align 1, !dbg !130
  %conv10 = sext i8 %4 to i32, !dbg !130
  %mul = mul nsw i32 %conv10, 2, !dbg !131
  %conv11 = trunc i32 %mul to i8, !dbg !130
  store i8 %conv11, i8* %result, align 1, !dbg !129
  %5 = load i8, i8* %result, align 1, !dbg !132
  call void @printHexCharLine(i8 signext %5), !dbg !133
  br label %if.end13, !dbg !134

if.else12:                                        ; preds = %if.then5
  call void @printLine(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.5, i32 0, i32 0)), !dbg !135
  br label %if.end13
...
entry:
  ...
  call void @good32(), !dbg !142
  call void @bad32(), !dbg !143
  ret i32 1, !dbg !144
}
...
!1 = !DIFile(filename: "191_32.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./191_32.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!67 = distinct !DISubprogram(name: "bad32", scope: !8, file: !8, line: 43, type: !68, isLocal: false, isDefinition: true, scopeLine: 44, isOptimized: false, unit: !0, variables: !2)
...
!99 = distinct !DISubprogram(name: "good32", scope: !8, file: !8, line: 67, type: !68, isLocal: false, isDefinition: true, scopeLine: 68, isOptimized: false, unit: !0, variables: !2)
...
!111 = distinct !DILexicalBlock(scope: !99, file: !8, line: 76, column: 8)
...
!115 = distinct !DILexicalBlock(scope: !111, file: !8, line: 77, column: 5)
!116 = !DILocation(line: 80, column: 5, scope: !115)
!117 = !DILocation(line: 83, column: 12, scope: !118)
!118 = distinct !DILexicalBlock(scope: !119, file: !8, line: 83, column: 12)
!119 = distinct !DILexicalBlock(scope: !111, file: !8, line: 82, column: 5)
!120 = !DILocation(line: 83, column: 17, scope: !118)
!121 = !DILocation(line: 83, column: 12, scope: !119)
!122 = !DILocation(line: 86, column: 17, scope: !123)
!123 = distinct !DILexicalBlock(scope: !124, file: !8, line: 86, column: 17)
!124 = distinct !DILexicalBlock(scope: !118, file: !8, line: 84, column: 9)
!125 = !DILocation(line: 86, column: 22, scope: !123)
!126 = !DILocation(line: 86, column: 17, scope: !124)
!127 = !DILocalVariable(name: "result", scope: !128, file: !8, line: 88, type: !15)
!128 = distinct !DILexicalBlock(scope: !123, file: !8, line: 87, column: 13)
!129 = !DILocation(line: 88, column: 22, scope: !128)
!130 = !DILocation(line: 88, column: 31, scope: !128)
!131 = !DILocation(line: 88, column: 36, scope: !128)
!132 = !DILocation(line: 89, column: 34, scope: !128)
!133 = !DILocation(line: 89, column: 17, scope: !128)
!134 = !DILocation(line: 90, column: 13, scope: !128)
!135 = !DILocation(line: 93, column: 17, scope: !136)
!136 = distinct !DILexicalBlock(scope: !123, file: !8, line: 92, column: 13)
!137 = !DILocation(line: 95, column: 9, scope: !124)
!138 = !DILocation(line: 97, column: 1, scope: !99)
!139 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 102, type: !140, isLocal: false, isDefinition: true, scopeLine: 102, isOptimized: false, unit: !0, variables: !2)
!140 = !DISubroutineType(types: !141)
!141 = !{!4}
!142 = !DILocation(line: 103, column: 5, scope: !139)
!143 = !DILocation(line: 104, column: 2, scope: !139)
!144 = !DILocation(line: 105, column: 5, scope: !139)
