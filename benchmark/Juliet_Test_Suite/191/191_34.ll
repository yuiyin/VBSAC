...
entry:
  ...
  %0 = load i8, i8* %data, align 1, !dbg !75
  %conv = sext i8 %0 to i32, !dbg !75
  %sub = sub nsw i32 %conv, 1, !dbg !76
  %conv1 = trunc i32 %sub to i8, !dbg !75
  store i8 %conv1, i8* %result, align 1, !dbg !74
  %1 = load i8, i8* %result, align 1, !dbg !77
  call void @printHexCharLine(i8 signext %1), !dbg !78
  ret void, !dbg !79
}

; Function Attrs: nounwind uwtable
define void @good34() #0 !dbg !80 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %data, metadata !81, metadata !15), !dbg !82
  store i8 32, i8* %data, align 1, !dbg !83
  store i8 -2, i8* %data, align 1, !dbg !84
  ...
  %conv1 = trunc i32 %sub to i8, !dbg !88
  store i8 %conv1, i8* %result, align 1, !dbg !87
  %1 = load i8, i8* %result, align 1, !dbg !90
  call void @printHexCharLine(i8 signext %1), !dbg !91
  ret void, !dbg !92
}
...
entry:
  ...
  call void @good34(), !dbg !96
  call void @bad34(), !dbg !97
  ret i32 1, !dbg !98
}
...
!1 = !DIFile(filename: "191_34.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_34.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad34", scope: !10, file: !10, line: 41, type: !66, isLocal: false, isDefinition: true, scopeLine: 42, isOptimized: false, unit: !0, variables: !2)
...
!72 = !DILocalVariable(name: "result", scope: !73, file: !10, line: 49, type: !13)
!73 = distinct !DILexicalBlock(scope: !65, file: !10, line: 47, column: 5)
!74 = !DILocation(line: 49, column: 14, scope: !73)
!75 = !DILocation(line: 49, column: 23, scope: !73)
!76 = !DILocation(line: 49, column: 28, scope: !73)
!77 = !DILocation(line: 50, column: 26, scope: !73)
!78 = !DILocation(line: 50, column: 9, scope: !73)
!79 = !DILocation(line: 52, column: 1, scope: !65)
!80 = distinct !DISubprogram(name: "good34", scope: !10, file: !10, line: 58, type: !66, isLocal: false, isDefinition: true, scopeLine: 59, isOptimized: false, unit: !0, variables: !2)
!81 = !DILocalVariable(name: "data", scope: !80, file: !10, line: 60, type: !13)
!82 = !DILocation(line: 60, column: 10, scope: !80)
!83 = !DILocation(line: 61, column: 10, scope: !80)
!84 = !DILocation(line: 63, column: 10, scope: !80)
!85 = !DILocalVariable(name: "result", scope: !86, file: !10, line: 66, type: !13)
!86 = distinct !DILexicalBlock(scope: !80, file: !10, line: 64, column: 5)
!87 = !DILocation(line: 66, column: 14, scope: !86)
!88 = !DILocation(line: 66, column: 23, scope: !86)
!89 = !DILocation(line: 66, column: 28, scope: !86)
!90 = !DILocation(line: 67, column: 26, scope: !86)
!91 = !DILocation(line: 67, column: 9, scope: !86)
!92 = !DILocation(line: 69, column: 1, scope: !80)
!93 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 73, type: !94, isLocal: false, isDefinition: true, scopeLine: 73, isOptimized: false, unit: !0, variables: !2)
!94 = !DISubroutineType(types: !95)
!95 = !{!4}
!96 = !DILocation(line: 74, column: 2, scope: !93)
!97 = !DILocation(line: 75, column: 5, scope: !93)
!98 = !DILocation(line: 76, column: 5, scope: !93)
