...
entry:
  ...
  %sub = sub nsw i32 %conv, 65, !dbg !80
...
; Function Attrs: nounwind uwtable
define void @good18() #0 !dbg !84 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %data, metadata !85, metadata !15), !dbg !86
  store i8 32, i8* %data, align 1, !dbg !87
  store i8 -2, i8* %data, align 1, !dbg !88
  call void @llvm.dbg.declare(metadata i8* %result, metadata !91, metadata !15), !dbg !95
  %0 = load i8, i8* %data, align 1, !dbg !96
  %conv = sext i8 %0 to i32, !dbg !96
  %sub = sub nsw i32 %conv, 1, !dbg !97
  %conv1 = trunc i32 %sub to i8, !dbg !96
  store i8 %conv1, i8* %result, align 1, !dbg !95
  %1 = load i8, i8* %result, align 1, !dbg !98
  call void @printHexCharLine(i8 signext %1), !dbg !99
  ret void, !dbg !100
}
...
entry:
  ...
  call void @good18(), !dbg !104
  call void @bad18(), !dbg !105
  ret i32 1, !dbg !106
}
...
!1 = !DIFile(filename: "191_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad18", scope: !10, file: !10, line: 41, type: !66, isLocal: false, isDefinition: true, scopeLine: 42, isOptimized: false, unit: !0, variables: !2)
...
!74 = !DILocalVariable(name: "result", scope: !75, file: !10, line: 53, type: !13)
...
!78 = !DILocation(line: 53, column: 18, scope: !75)
!79 = !DILocation(line: 53, column: 27, scope: !75)
!80 = !DILocation(line: 53, column: 32, scope: !75)
!81 = !DILocation(line: 54, column: 30, scope: !75)
!82 = !DILocation(line: 54, column: 13, scope: !75)
!83 = !DILocation(line: 57, column: 1, scope: !65)
!84 = distinct !DISubprogram(name: "good18", scope: !10, file: !10, line: 63, type: !66, isLocal: false, isDefinition: true, scopeLine: 64, isOptimized: false, unit: !0, variables: !2)
!85 = !DILocalVariable(name: "data", scope: !84, file: !10, line: 65, type: !13)
!86 = !DILocation(line: 65, column: 10, scope: !84)
!87 = !DILocation(line: 66, column: 10, scope: !84)
!88 = !DILocation(line: 75, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !10, line: 73, column: 5)
!90 = distinct !DILexicalBlock(scope: !84, file: !10, line: 67, column: 8)
!91 = !DILocalVariable(name: "result", scope: !92, file: !10, line: 81, type: !13)
!92 = distinct !DILexicalBlock(scope: !93, file: !10, line: 79, column: 9)
!93 = distinct !DILexicalBlock(scope: !94, file: !10, line: 78, column: 5)
!94 = distinct !DILexicalBlock(scope: !84, file: !10, line: 77, column: 8)
!95 = !DILocation(line: 81, column: 18, scope: !92)
!96 = !DILocation(line: 81, column: 27, scope: !92)
!97 = !DILocation(line: 81, column: 32, scope: !92)
!98 = !DILocation(line: 82, column: 30, scope: !92)
!99 = !DILocation(line: 82, column: 13, scope: !92)
!100 = !DILocation(line: 85, column: 1, scope: !84)
!101 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 90, type: !102, isLocal: false, isDefinition: true, scopeLine: 90, isOptimized: false, unit: !0, variables: !2)
!102 = !DISubroutineType(types: !103)
!103 = !{!4}
!104 = !DILocation(line: 91, column: 5, scope: !101)
!105 = !DILocation(line: 92, column: 2, scope: !101)
!106 = !DILocation(line: 93, column: 5, scope: !101)
