...
if.then:                                          ; preds = %entry
  store i8 -90, i8* %data, align 1, !dbg !74
...
if.then3:                                         ; preds = %if.end
  ...
  %sub = sub nsw i32 %conv, 65, !dbg !85
...
if.then:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0)), !dbg !97
  br label %if.end, !dbg !99

if.else:                                          ; preds = %entry
  store i8 -2, i8* %data, align 1, !dbg !100
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call1 = call i32 @staticReturnsTrue(), !dbg !102
  %tobool2 = icmp ne i32 %call1, 0, !dbg !102
  br i1 %tobool2, label %if.then3, label %if.end5, !dbg !104

if.then3:                                         ; preds = %if.end
  call void @llvm.dbg.declare(metadata i8* %result, metadata !105, metadata !15), !dbg !108
  %0 = load i8, i8* %data, align 1, !dbg !109
  %conv = sext i8 %0 to i32, !dbg !109
  %sub = sub nsw i32 %conv, 1, !dbg !110
  %conv4 = trunc i32 %sub to i8, !dbg !109
  store i8 %conv4, i8* %result, align 1, !dbg !108
  %1 = load i8, i8* %result, align 1, !dbg !111
...
entry:
  ...
  call void @good23(), !dbg !118
  call void @bad23(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "191_23.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_23.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad23", scope: !10, file: !10, line: 51, type: !66, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: false, unit: !0, variables: !2)
...
!74 = !DILocation(line: 57, column: 14, scope: !75)
...
!78 = distinct !DILexicalBlock(scope: !65, file: !10, line: 59, column: 8)
!79 = !DILocation(line: 59, column: 8, scope: !65)
!80 = !DILocalVariable(name: "result", scope: !81, file: !10, line: 63, type: !13)
!81 = distinct !DILexicalBlock(scope: !82, file: !10, line: 61, column: 9)
!82 = distinct !DILexicalBlock(scope: !78, file: !10, line: 60, column: 5)
!83 = !DILocation(line: 63, column: 18, scope: !81)
!84 = !DILocation(line: 63, column: 27, scope: !81)
!85 = !DILocation(line: 63, column: 32, scope: !81)
!86 = !DILocation(line: 64, column: 30, scope: !81)
!87 = !DILocation(line: 64, column: 13, scope: !81)
!88 = !DILocation(line: 66, column: 5, scope: !82)
!89 = !DILocation(line: 67, column: 1, scope: !65)
!90 = distinct !DISubprogram(name: "good23", scope: !10, file: !10, line: 74, type: !66, isLocal: false, isDefinition: true, scopeLine: 75, isOptimized: false, unit: !0, variables: !2)
...
!97 = !DILocation(line: 81, column: 9, scope: !98)
!98 = distinct !DILexicalBlock(scope: !95, file: !10, line: 79, column: 5)
!99 = !DILocation(line: 82, column: 5, scope: !98)
!100 = !DILocation(line: 86, column: 14, scope: !101)
!101 = distinct !DILexicalBlock(scope: !95, file: !10, line: 84, column: 5)
!102 = !DILocation(line: 88, column: 8, scope: !103)
!103 = distinct !DILexicalBlock(scope: !90, file: !10, line: 88, column: 8)
!104 = !DILocation(line: 88, column: 8, scope: !90)
!105 = !DILocalVariable(name: "result", scope: !106, file: !10, line: 92, type: !13)
!106 = distinct !DILexicalBlock(scope: !107, file: !10, line: 90, column: 9)
!107 = distinct !DILexicalBlock(scope: !103, file: !10, line: 89, column: 5)
!108 = !DILocation(line: 92, column: 18, scope: !106)
!109 = !DILocation(line: 92, column: 27, scope: !106)
!110 = !DILocation(line: 92, column: 32, scope: !106)
!111 = !DILocation(line: 93, column: 30, scope: !106)
!112 = !DILocation(line: 93, column: 13, scope: !106)
!113 = !DILocation(line: 95, column: 5, scope: !107)
!114 = !DILocation(line: 96, column: 1, scope: !90)
!115 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 101, type: !116, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!116 = !DISubroutineType(types: !117)
!117 = !{!4}
!118 = !DILocation(line: 102, column: 5, scope: !115)
!119 = !DILocation(line: 103, column: 2, scope: !115)
!120 = !DILocation(line: 104, column: 5, scope: !115)
!121 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !10, file: !10, line: 39, type: !116, isLocal: true, isDefinition: true, scopeLine: 40, isOptimized: false, unit: !0, variables: !2)
!122 = !DILocation(line: 41, column: 5, scope: !121)
!123 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !10, file: !10, line: 44, type: !116, isLocal: true, isDefinition: true, scopeLine: 45, isOptimized: false, unit: !0, variables: !2)
!124 = !DILocation(line: 46, column: 5, scope: !123)
