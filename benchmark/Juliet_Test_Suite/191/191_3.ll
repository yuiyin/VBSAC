...
; Function Attrs: nounwind uwtable
define void @bad3() #0 !dbg !65 {
entry:
  %data = alloca i32, align 4
  %result = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !68, metadata !15), !dbg !69
  store i32 0, i32* %data, align 4, !dbg !70
  store i32 -2147483648, i32* %data, align 4, !dbg !71
  call void @llvm.dbg.declare(metadata i32* %result, metadata !74, metadata !15), !dbg !78
  %0 = load i32, i32* %data, align 4, !dbg !79
  %sub = sub nsw i32 %0, 1, !dbg !80
  store i32 %sub, i32* %result, align 4, !dbg !78
  %1 = load i32, i32* %result, align 4, !dbg !81
  call void @printIntLine(i32 %1), !dbg !82
  ret void, !dbg !83
}

; Function Attrs: nounwind uwtable
define void @good3() #0 !dbg !84 {
entry:
  %data = alloca i32, align 4
  %result = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !85, metadata !15), !dbg !86
  store i32 0, i32* %data, align 4, !dbg !87
  store i32 -2147483648, i32* %data, align 4, !dbg !88
  %0 = load i32, i32* %data, align 4, !dbg !91
  %cmp = icmp sgt i32 %0, -2147483648, !dbg !95
  br i1 %cmp, label %if.then, label %if.else, !dbg !96

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %result, metadata !97, metadata !15), !dbg !99
  %1 = load i32, i32* %data, align 4, !dbg !100
  %sub = sub nsw i32 %1, 1, !dbg !101
  store i32 %sub, i32* %result, align 4, !dbg !99
  %2 = load i32, i32* %result, align 4, !dbg !102
  call void @printIntLine(i32 %2), !dbg !103
...
entry:
  ...
  call void @good3(), !dbg !111
  call void @bad3(), !dbg !112
  ret i32 1, !dbg !113
}
...
!1 = !DIFile(filename: "191_3.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_3.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad3", scope: !10, file: !10, line: 39, type: !66, isLocal: false, isDefinition: true, scopeLine: 40, isOptimized: false, unit: !0, variables: !2)
!66 = !DISubroutineType(types: !67)
!67 = !{null}
!68 = !DILocalVariable(name: "data", scope: !65, file: !10, line: 41, type: !4)
!69 = !DILocation(line: 41, column: 9, scope: !65)
!70 = !DILocation(line: 43, column: 10, scope: !65)
!71 = !DILocation(line: 47, column: 14, scope: !72)
!72 = distinct !DILexicalBlock(scope: !73, file: !10, line: 45, column: 5)
!73 = distinct !DILexicalBlock(scope: !65, file: !10, line: 44, column: 8)
!74 = !DILocalVariable(name: "result", scope: !75, file: !10, line: 53, type: !4)
!75 = distinct !DILexicalBlock(scope: !76, file: !10, line: 51, column: 9)
!76 = distinct !DILexicalBlock(scope: !77, file: !10, line: 50, column: 5)
!77 = distinct !DILexicalBlock(scope: !65, file: !10, line: 49, column: 8)
!78 = !DILocation(line: 53, column: 17, scope: !75)
!79 = !DILocation(line: 53, column: 26, scope: !75)
!80 = !DILocation(line: 53, column: 31, scope: !75)
!81 = !DILocation(line: 54, column: 26, scope: !75)
!82 = !DILocation(line: 54, column: 13, scope: !75)
!83 = !DILocation(line: 57, column: 1, scope: !65)
!84 = distinct !DISubprogram(name: "good3", scope: !10, file: !10, line: 59, type: !66, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!85 = !DILocalVariable(name: "data", scope: !84, file: !10, line: 61, type: !4)
!86 = !DILocation(line: 61, column: 9, scope: !84)
!87 = !DILocation(line: 63, column: 10, scope: !84)
!88 = !DILocation(line: 67, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !10, line: 65, column: 5)
!90 = distinct !DILexicalBlock(scope: !84, file: !10, line: 64, column: 8)
!91 = !DILocation(line: 72, column: 13, scope: !92)
!92 = distinct !DILexicalBlock(scope: !93, file: !10, line: 72, column: 13)
!93 = distinct !DILexicalBlock(scope: !94, file: !10, line: 70, column: 5)
!94 = distinct !DILexicalBlock(scope: !84, file: !10, line: 69, column: 8)
!95 = !DILocation(line: 72, column: 18, scope: !92)
!96 = !DILocation(line: 72, column: 13, scope: !93)
!97 = !DILocalVariable(name: "result", scope: !98, file: !10, line: 74, type: !4)
!98 = distinct !DILexicalBlock(scope: !92, file: !10, line: 73, column: 9)
!99 = !DILocation(line: 74, column: 17, scope: !98)
!100 = !DILocation(line: 74, column: 26, scope: !98)
!101 = !DILocation(line: 74, column: 31, scope: !98)
!102 = !DILocation(line: 75, column: 26, scope: !98)
!103 = !DILocation(line: 75, column: 13, scope: !98)
!104 = !DILocation(line: 76, column: 9, scope: !98)
!105 = !DILocation(line: 79, column: 13, scope: !106)
!106 = distinct !DILexicalBlock(scope: !92, file: !10, line: 78, column: 9)
!107 = !DILocation(line: 82, column: 1, scope: !84)
!108 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 84, type: !109, isLocal: false, isDefinition: true, scopeLine: 84, isOptimized: false, unit: !0, variables: !2)
!109 = !DISubroutineType(types: !110)
!110 = !{!4}
!111 = !DILocation(line: 85, column: 5, scope: !108)
!112 = !DILocation(line: 86, column: 2, scope: !108)
