...
@.str.4 = private unnamed_addr constant [48 x i8] c"data value is too small to perform subtraction.\00", align 1
...
; Function Attrs: nounwind uwtable
define void @bad4() #0 !dbg !65 {
entry:
  %data = alloca i64, align 8
  %result = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !68, metadata !15), !dbg !69
  store i64 0, i64* %data, align 8, !dbg !70
  store i64 -9223372036854775808, i64* %data, align 8, !dbg !71
  call void @llvm.dbg.declare(metadata i64* %result, metadata !74, metadata !15), !dbg !78
  %0 = load i64, i64* %data, align 8, !dbg !79
  %sub = sub nsw i64 %0, 1, !dbg !80
  store i64 %sub, i64* %result, align 8, !dbg !78
  %1 = load i64, i64* %result, align 8, !dbg !81
  call void @printLongLine(i64 %1), !dbg !82
  ret void, !dbg !83
}

; Function Attrs: nounwind uwtable
define void @good4() #0 !dbg !84 {
entry:
  %data = alloca i64, align 8
  %result = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !85, metadata !15), !dbg !86
  store i64 0, i64* %data, align 8, !dbg !87
  store i64 -9223372036854775808, i64* %data, align 8, !dbg !88
  %0 = load i64, i64* %data, align 8, !dbg !91
  %cmp = icmp sgt i64 %0, -9223372036854775808, !dbg !95
  br i1 %cmp, label %if.then, label %if.else, !dbg !96

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i64* %result, metadata !97, metadata !15), !dbg !99
  %1 = load i64, i64* %data, align 8, !dbg !100
  %sub = sub nsw i64 %1, 1, !dbg !101
  store i64 %sub, i64* %result, align 8, !dbg !99
  %2 = load i64, i64* %result, align 8, !dbg !102
  call void @printLongLine(i64 %2), !dbg !103
...
entry:
  ...
  call void @good4(), !dbg !111
  call void @bad4(), !dbg !112
  ret i32 1, !dbg !113
}
...
!1 = !DIFile(filename: "191_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad4", scope: !10, file: !10, line: 45, type: !66, isLocal: false, isDefinition: true, scopeLine: 46, isOptimized: false, unit: !0, variables: !2)
!66 = !DISubroutineType(types: !67)
!67 = !{null}
!68 = !DILocalVariable(name: "data", scope: !65, file: !10, line: 47, type: !48)
!69 = !DILocation(line: 47, column: 13, scope: !65)
!70 = !DILocation(line: 48, column: 10, scope: !65)
!71 = !DILocation(line: 52, column: 14, scope: !72)
!72 = distinct !DILexicalBlock(scope: !73, file: !10, line: 50, column: 5)
!73 = distinct !DILexicalBlock(scope: !65, file: !10, line: 49, column: 8)
!74 = !DILocalVariable(name: "result", scope: !75, file: !10, line: 58, type: !48)
!75 = distinct !DILexicalBlock(scope: !76, file: !10, line: 56, column: 9)
!76 = distinct !DILexicalBlock(scope: !77, file: !10, line: 55, column: 5)
!77 = distinct !DILexicalBlock(scope: !65, file: !10, line: 54, column: 8)
!78 = !DILocation(line: 58, column: 21, scope: !75)
!79 = !DILocation(line: 58, column: 30, scope: !75)
!80 = !DILocation(line: 58, column: 35, scope: !75)
!81 = !DILocation(line: 59, column: 27, scope: !75)
!82 = !DILocation(line: 59, column: 13, scope: !75)
!83 = !DILocation(line: 62, column: 1, scope: !65)
!84 = distinct !DISubprogram(name: "good4", scope: !10, file: !10, line: 64, type: !66, isLocal: false, isDefinition: true, scopeLine: 65, isOptimized: false, unit: !0, variables: !2)
!85 = !DILocalVariable(name: "data", scope: !84, file: !10, line: 66, type: !48)
!86 = !DILocation(line: 66, column: 13, scope: !84)
!87 = !DILocation(line: 67, column: 10, scope: !84)
!88 = !DILocation(line: 71, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !10, line: 69, column: 5)
!90 = distinct !DILexicalBlock(scope: !84, file: !10, line: 68, column: 8)
!91 = !DILocation(line: 81, column: 13, scope: !92)
!92 = distinct !DILexicalBlock(scope: !93, file: !10, line: 81, column: 13)
!93 = distinct !DILexicalBlock(scope: !94, file: !10, line: 79, column: 5)
!94 = distinct !DILexicalBlock(scope: !84, file: !10, line: 73, column: 8)
!95 = !DILocation(line: 81, column: 18, scope: !92)
!96 = !DILocation(line: 81, column: 13, scope: !93)
!97 = !DILocalVariable(name: "result", scope: !98, file: !10, line: 83, type: !48)
!98 = distinct !DILexicalBlock(scope: !92, file: !10, line: 82, column: 9)
!99 = !DILocation(line: 83, column: 21, scope: !98)
!100 = !DILocation(line: 83, column: 30, scope: !98)
!101 = !DILocation(line: 83, column: 35, scope: !98)
!102 = !DILocation(line: 84, column: 27, scope: !98)
!103 = !DILocation(line: 84, column: 13, scope: !98)
!104 = !DILocation(line: 85, column: 9, scope: !98)
!105 = !DILocation(line: 88, column: 13, scope: !106)
!106 = distinct !DILexicalBlock(scope: !92, file: !10, line: 87, column: 9)
!107 = !DILocation(line: 91, column: 1, scope: !84)
!108 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 93, type: !109, isLocal: false, isDefinition: true, scopeLine: 93, isOptimized: false, unit: !0, variables: !2)
!109 = !DISubroutineType(types: !110)
!110 = !{!4}
!111 = !DILocation(line: 94, column: 5, scope: !108)
!112 = !DILocation(line: 95, column: 2, scope: !108)
!113 = !DILocation(line: 96, column: 5, scope: !108)
