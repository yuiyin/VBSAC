...
entry:
  ...
  %1 = load i16, i16* %data, align 2, !dbg !74
  %conv = sext i16 %1 to i32, !dbg !74
  %cmp = icmp slt i32 %conv, 0, !dbg !76
  br i1 %cmp, label %if.then, label %if.end, !dbg !77

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i16* %result, metadata !78, metadata !15), !dbg !80
  %2 = load i16, i16* %data, align 2, !dbg !81
  %conv2 = sext i16 %2 to i32, !dbg !81
  %mul = mul nsw i32 %conv2, 2, !dbg !82
  %conv3 = trunc i32 %mul to i16, !dbg !81
  store i16 %conv3, i16* %result, align 2, !dbg !80
  %3 = load i16, i16* %result, align 2, !dbg !83
  %conv4 = sext i16 %3 to i32, !dbg !83
  call void @printIntLine(i32 %conv4), !dbg !84
...
; Function Attrs: nounwind uwtable
define void @good42() #0 !dbg !87 {
entry:
  %data = alloca i16, align 2
  %result = alloca i16, align 2
  call void @llvm.dbg.declare(metadata i16* %data, metadata !88, metadata !15), !dbg !89
  store i16 0, i16* %data, align 2, !dbg !90
  store i16 -2, i16* %data, align 2, !dbg !91
  %0 = load i16, i16* %data, align 2, !dbg !92
  %conv = sext i16 %0 to i32, !dbg !92
  %cmp = icmp slt i32 %conv, 0, !dbg !94
  br i1 %cmp, label %if.then, label %if.end, !dbg !95

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i16* %result, metadata !96, metadata !15), !dbg !98
  %1 = load i16, i16* %data, align 2, !dbg !99
  %conv2 = sext i16 %1 to i32, !dbg !99
  %mul = mul nsw i32 %conv2, 2, !dbg !100
  %conv3 = trunc i32 %mul to i16, !dbg !99
  store i16 %conv3, i16* %result, align 2, !dbg !98
  %2 = load i16, i16* %result, align 2, !dbg !101
  %conv4 = sext i16 %2 to i32, !dbg !101
  call void @printIntLine(i32 %conv4), !dbg !102
...
entry:
  ...
  call void @good42(), !dbg !108
  call void @bad42(), !dbg !109
  ret i32 1, !dbg !110
}
...
!1 = !DIFile(filename: "191_42.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./191_42.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/191")
...
!65 = distinct !DISubprogram(name: "bad42", scope: !10, file: !10, line: 41, type: !66, isLocal: false, isDefinition: true, scopeLine: 42, isOptimized: false, unit: !0, variables: !2)
...
!75 = distinct !DILexicalBlock(scope: !65, file: !10, line: 47, column: 8)
!76 = !DILocation(line: 47, column: 13, scope: !75)
!77 = !DILocation(line: 47, column: 8, scope: !65)
!78 = !DILocalVariable(name: "result", scope: !79, file: !10, line: 50, type: !69)
!79 = distinct !DILexicalBlock(scope: !75, file: !10, line: 48, column: 5)
!80 = !DILocation(line: 50, column: 15, scope: !79)
!81 = !DILocation(line: 50, column: 24, scope: !79)
!82 = !DILocation(line: 50, column: 29, scope: !79)
!83 = !DILocation(line: 51, column: 22, scope: !79)
!84 = !DILocation(line: 51, column: 9, scope: !79)
!85 = !DILocation(line: 52, column: 5, scope: !79)
!86 = !DILocation(line: 53, column: 1, scope: !65)
!87 = distinct !DISubprogram(name: "good42", scope: !10, file: !10, line: 59, type: !66, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!88 = !DILocalVariable(name: "data", scope: !87, file: !10, line: 61, type: !69)
!89 = !DILocation(line: 61, column: 11, scope: !87)
!90 = !DILocation(line: 62, column: 10, scope: !87)
!91 = !DILocation(line: 64, column: 10, scope: !87)
!92 = !DILocation(line: 65, column: 8, scope: !93)
!93 = distinct !DILexicalBlock(scope: !87, file: !10, line: 65, column: 8)
!94 = !DILocation(line: 65, column: 13, scope: !93)
!95 = !DILocation(line: 65, column: 8, scope: !87)
!96 = !DILocalVariable(name: "result", scope: !97, file: !10, line: 68, type: !69)
!97 = distinct !DILexicalBlock(scope: !93, file: !10, line: 66, column: 5)
!98 = !DILocation(line: 68, column: 15, scope: !97)
!99 = !DILocation(line: 68, column: 24, scope: !97)
!100 = !DILocation(line: 68, column: 29, scope: !97)
!101 = !DILocation(line: 69, column: 22, scope: !97)
!102 = !DILocation(line: 69, column: 9, scope: !97)
!103 = !DILocation(line: 70, column: 5, scope: !97)
!104 = !DILocation(line: 71, column: 1, scope: !87)
!105 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 77, type: !106, isLocal: false, isDefinition: true, scopeLine: 77, isOptimized: false, unit: !0, variables: !2)
!106 = !DISubroutineType(types: !107)
!107 = !{!4}
!108 = !DILocation(line: 78, column: 2, scope: !105)
!109 = !DILocation(line: 79, column: 5, scope: !105)
!110 = !DILocation(line: 80, column: 5, scope: !105)
