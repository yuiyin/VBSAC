...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @calloc(i64 100, i64 1) #4, !dbg !64
...
if.end:                                           ; preds = %if.then
  ...
  %call2 = call i8* @strcpy(i8* %2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !74
  %3 = load i8*, i8** %data, align 8, !dbg !75
  call void @printLine(i8* %3), !dbg !76
  br label %if.end3, !dbg !77

if.end3:                                          ; preds = %if.end, %entry
  %4 = load i32, i32* @globalTrue, align 4, !dbg !78
  %tobool4 = icmp ne i32 %4, 0, !dbg !78
  br i1 %tobool4, label %if.then5, label %if.end6, !dbg !80
...
entry:
  ...
  br i1 %tobool, label %if.then, label %if.end3, !dbg !90

if.then:                                          ; preds = %entry
  %call = call noalias i8* @calloc(i64 100, i64 1) #4, !dbg !91
...
if.end:                                           ; preds = %if.then
  ...
  %call2 = call i8* @strcpy(i8* %2, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !101
  %3 = load i8*, i8** %data, align 8, !dbg !102
  call void @printLine(i8* %3), !dbg !103
  br label %if.end3, !dbg !104

if.end3:                                          ; preds = %if.end, %entry
  %4 = load i32, i32* @globalFalse, align 4, !dbg !105
  %tobool4 = icmp ne i32 %4, 0, !dbg !105
  br i1 %tobool4, label %if.then5, label %if.else, !dbg !107
...
entry:
  ...
  call void @good10(), !dbg !116
  call void @bad10(), !dbg !117
  ret i32 1, !dbg !118
}
...
!1 = !DIFile(filename: "401_10.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_10.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad10", scope: !9, file: !9, line: 49, type: !56, isLocal: false, isDefinition: true, scopeLine: 50, isOptimized: false, unit: !0, variables: !2)
...
!84 = distinct !DISubprogram(name: "good10", scope: !9, file: !9, line: 73, type: !56, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
...
!115 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 101, type: !21, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!116 = !DILocation(line: 102, column: 2, scope: !115)
!117 = !DILocation(line: 103, column: 5, scope: !115)
