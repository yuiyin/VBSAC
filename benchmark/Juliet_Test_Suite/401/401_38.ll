...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call i8* @strcpy(i8* %3, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !77
  %4 = load i8*, i8** %data, align 8, !dbg !78
  call void @printLine(i8* %4), !dbg !79
  br label %if.end4, !dbg !80

if.end4:                                          ; preds = %if.end, %entry
  %5 = load i32, i32* @staticFive, align 4, !dbg !81
  %cmp5 = icmp eq i32 %5, 5, !dbg !83
...
; Function Attrs: nounwind uwtable
define void @good38() #0 !dbg !88 {
entry:
  %data = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %data, metadata !89, metadata !37), !dbg !90
...
if.then:                                          ; preds = %entry
  ...
  %call = call i8* @realloc(i8* %1, i64 100) #4, !dbg !98
  store i8* %call, i8** %data, align 8, !dbg !99
  %2 = load i8*, i8** %data, align 8, !dbg !100
  %cmp1 = icmp eq i8* %2, null, !dbg !102
...
if.end:                                           ; preds = %if.then
  ...
  %call3 = call i8* @strcpy(i8* %3, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #4, !dbg !107
  %4 = load i8*, i8** %data, align 8, !dbg !108
  call void @printLine(i8* %4), !dbg !109
  br label %if.end4, !dbg !110

if.end4:                                          ; preds = %if.end, %entry
  %5 = load i32, i32* @staticFive, align 4, !dbg !111
  %cmp5 = icmp ne i32 %5, 5, !dbg !113
  br i1 %cmp5, label %if.then6, label %if.else, !dbg !114

if.then6:                                         ; preds = %if.end4
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0)), !dbg !115
  br label %if.end7, !dbg !117

if.else:                                          ; preds = %if.end4
  %6 = load i8*, i8** %data, align 8, !dbg !118
  call void @free(i8* %6) #4, !dbg !120
  br label %if.end7
...
entry:
  ...
  call void @good38(), !dbg !123
  call void @bad38(), !dbg !124
  ret i32 1, !dbg !125
}
...
!1 = !DIFile(filename: "401_38.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_38.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!56 = distinct !DISubprogram(name: "bad38", scope: !9, file: !9, line: 51, type: !57, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: false, unit: !0, variables: !2)
...
!66 = !DILocation(line: 58, column: 32, scope: !67)
!67 = distinct !DILexicalBlock(scope: !63, file: !9, line: 56, column: 5)
!68 = !DILocation(line: 58, column: 24, scope: !67)
...
!76 = !DILocation(line: 61, column: 16, scope: !67)
!77 = !DILocation(line: 61, column: 9, scope: !67)
!78 = !DILocation(line: 62, column: 19, scope: !67)
...
!88 = distinct !DISubprogram(name: "good38", scope: !9, file: !9, line: 75, type: !57, isLocal: false, isDefinition: true, scopeLine: 76, isOptimized: false, unit: !0, variables: !2)
!89 = !DILocalVariable(name: "data", scope: !88, file: !9, line: 77, type: !5)
!90 = !DILocation(line: 77, column: 12, scope: !88)
...
!96 = !DILocation(line: 82, column: 32, scope: !97)
!97 = distinct !DILexicalBlock(scope: !93, file: !9, line: 80, column: 5)
!98 = !DILocation(line: 82, column: 24, scope: !97)
...
!106 = !DILocation(line: 85, column: 16, scope: !97)
...
!122 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 103, type: !22, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: false, unit: !0, variables: !2)
!123 = !DILocation(line: 104, column: 5, scope: !122)
!124 = !DILocation(line: 105, column: 2, scope: !122)
