...
if.then:                                          ; preds = %entry
  %call = call noalias i8* @calloc(i64 100, i64 1) #4, !dbg !93
...
entry:
  ...
  call void @good5(), !dbg !118
  call void @bad5(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "401_5.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_5.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!57 = distinct !DISubprogram(name: "bad5", scope: !9, file: !9, line: 52, type: !58, isLocal: false, isDefinition: true, scopeLine: 53, isOptimized: false, unit: !0, variables: !2)
...
!86 = distinct !DISubprogram(name: "good5", scope: !9, file: !9, line: 76, type: !58, isLocal: false, isDefinition: true, scopeLine: 77, isOptimized: false, unit: !0, variables: !2)
...
!117 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 103, type: !23, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: false, unit: !0, variables: !2)
