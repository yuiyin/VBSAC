...
if.end4:                                          ; preds = %if.end, %entry
  %call5 = call i32 @globalReturnsTrue(), !dbg !79
...
if.end4:                                          ; preds = %if.end, %entry
  %call5 = call i32 @globalReturnsFalse(), !dbg !107
...
entry:
  ...
  call void @good42(), !dbg !118
  call void @bad42(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "401_42.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
!2 = !{}
!3 = !{!4, !5}
...
!9 = !DIFile(filename: "./401_42.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/401")
...
!55 = distinct !DISubprogram(name: "bad42", scope: !9, file: !9, line: 49, type: !56, isLocal: false, isDefinition: true, scopeLine: 50, isOptimized: false, unit: !0, variables: !2)
...
!85 = distinct !DISubprogram(name: "good42", scope: !9, file: !9, line: 73, type: !56, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
...
!117 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 100, type: !21, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!118 = !DILocation(line: 101, column: 5, scope: !117)
!119 = !DILocation(line: 102, column: 2, scope: !117)
