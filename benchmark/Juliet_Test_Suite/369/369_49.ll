...
entry:
  ...
  %rem = srem i32 100, %1, !dbg !46
  call void @printIntLine(i32 %rem), !dbg !47
  ret void, !dbg !48
}
...
entry:
  ...
  %rem = srem i32 100, %1, !dbg !66
  call void @printIntLine(i32 %rem), !dbg !67
  ret void, !dbg !68
}
...
entry:
  ...
  call void @good49(), !dbg !78
  call void @bad49(), !dbg !79
  ret i32 1, !dbg !80
}
...
!1 = !DIFile(filename: "369_49.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!9 = !DIFile(filename: "./369_49.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!36 = distinct !DISubprogram(name: "bad49", scope: !9, file: !9, line: 33, type: !37, isLocal: false, isDefinition: true, scopeLine: 34, isOptimized: false, unit: !0, variables: !2)
...
!58 = distinct !DISubprogram(name: "good49", scope: !9, file: !9, line: 53, type: !37, isLocal: false, isDefinition: true, scopeLine: 54, isOptimized: false, unit: !0, variables: !2)
...
!77 = !{!30}
!78 = !DILocation(line: 66, column: 5, scope: !75)
