...
entry:
  ...
  %rem = srem i32 100, %1, !dbg !45
  call void @printIntLine(i32 %rem), !dbg !46
  ret void, !dbg !47
}
...
; Function Attrs: nounwind uwtable
define void @good26() #0 !dbg !48 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !49, metadata !16), !dbg !50
  store i32 -1, i32* %data, align 4, !dbg !51
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !dbg !52
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0), i32* %data), !dbg !53
  %1 = load i32, i32* %data, align 4, !dbg !54
  %cmp = icmp ne i32 %1, 0, !dbg !56
  br i1 %cmp, label %if.then, label %if.else, !dbg !57

if.then:                                          ; preds = %entry
  %2 = load i32, i32* %data, align 4, !dbg !58
  %rem = srem i32 100, %2, !dbg !60
  call void @printIntLine(i32 %rem), !dbg !61
  br label %if.end, !dbg !62

if.else:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i32 0, i32 0)), !dbg !63
  br label %if.end
...
entry:
  ...
  call void @good26(), !dbg !69
  call void @bad26(), !dbg !70
  ret i32 1, !dbg !71
}
...
!1 = !DIFile(filename: "369_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!9 = !DIFile(filename: "./369_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!36 = distinct !DISubprogram(name: "bad26", scope: !9, file: !9, line: 27, type: !37, isLocal: false, isDefinition: true, scopeLine: 28, isOptimized: false, unit: !0, variables: !2)
...
!42 = !DILocation(line: 33, column: 12, scope: !36)
!43 = !DILocation(line: 33, column: 5, scope: !36)
!44 = !DILocation(line: 35, column: 24, scope: !36)
!45 = !DILocation(line: 35, column: 22, scope: !36)
!46 = !DILocation(line: 35, column: 5, scope: !36)
!47 = !DILocation(line: 36, column: 1, scope: !36)
!48 = distinct !DISubprogram(name: "good26", scope: !9, file: !9, line: 42, type: !37, isLocal: false, isDefinition: true, scopeLine: 43, isOptimized: false, unit: !0, variables: !2)
!49 = !DILocalVariable(name: "data", scope: !48, file: !9, line: 44, type: !30)
!50 = !DILocation(line: 44, column: 9, scope: !48)
!51 = !DILocation(line: 46, column: 10, scope: !48)
!52 = !DILocation(line: 48, column: 12, scope: !48)
!53 = !DILocation(line: 48, column: 5, scope: !48)
!54 = !DILocation(line: 50, column: 9, scope: !55)
!55 = distinct !DILexicalBlock(scope: !48, file: !9, line: 50, column: 9)
!56 = !DILocation(line: 50, column: 14, scope: !55)
!57 = !DILocation(line: 50, column: 9, scope: !48)
!58 = !DILocation(line: 52, column: 28, scope: !59)
!59 = distinct !DILexicalBlock(scope: !55, file: !9, line: 51, column: 5)
!60 = !DILocation(line: 52, column: 26, scope: !59)
!61 = !DILocation(line: 52, column: 9, scope: !59)
!62 = !DILocation(line: 53, column: 5, scope: !59)
!63 = !DILocation(line: 56, column: 9, scope: !64)
!64 = distinct !DILexicalBlock(scope: !55, file: !9, line: 55, column: 5)
!65 = !DILocation(line: 58, column: 1, scope: !48)
!66 = distinct !DISubprogram(name: "main", scope: !9, file: !9, line: 62, type: !67, isLocal: false, isDefinition: true, scopeLine: 62, isOptimized: false, unit: !0, variables: !2)
!67 = !DISubroutineType(types: !68)
!68 = !{!30}
!69 = !DILocation(line: 63, column: 2, scope: !66)
!70 = !DILocation(line: 64, column: 5, scope: !66)
!71 = !DILocation(line: 65, column: 5, scope: !66)
