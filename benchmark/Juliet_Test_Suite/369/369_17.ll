...
for.body3:                                        ; preds = %for.cond1
  ...
  %div = sdiv i32 100, %4, !dbg !91
  call void @printIntLine(i32 %div), !dbg !92
...
if.then:                                          ; preds = %for.body3
  ...
  %div = sdiv i32 100, %5, !dbg !140
  call void @printIntLine(i32 %div), !dbg !141
...
entry:
  ...
  call void @good17(), !dbg !153
  call void @bad17(), !dbg !154
  ret i32 1, !dbg !155
}
...
!1 = !DIFile(filename: "369_17.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!7 = !DIFile(filename: "./369_17.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!54 = distinct !DISubprogram(name: "bad17", scope: !7, file: !7, line: 51, type: !55, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: false, unit: !0, variables: !2)
...
!100 = distinct !DISubprogram(name: "good17", scope: !7, file: !7, line: 71, type: !55, isLocal: false, isDefinition: true, scopeLine: 72, isOptimized: false, unit: !0, variables: !2)
...
!152 = distinct !DISubprogram(name: "main", scope: !7, file: !7, line: 97, type: !19, isLocal: false, isDefinition: true, scopeLine: 97, isOptimized: false, unit: !0, variables: !2)
!153 = !DILocation(line: 98, column: 2, scope: !152)
!154 = !DILocation(line: 99, column: 5, scope: !152)
!155 = !DILocation(line: 100, column: 5, scope: !152)
