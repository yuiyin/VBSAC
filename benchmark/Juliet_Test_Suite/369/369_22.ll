...
entry:
  ...
  %div = sdiv i32 100, %2, !dbg !77
  call void @printIntLine(i32 %div), !dbg !78
  ret void, !dbg !79
}
...
entry:
  ...
  call void @good22(), !dbg !83
  call void @bad22(), !dbg !84
  ret i32 1, !dbg !85
}
...
!1 = !DIFile(filename: "369_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!9 = !DIFile(filename: "./369_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!36 = distinct !DISubprogram(name: "bad22", scope: !9, file: !9, line: 32, type: !37, isLocal: false, isDefinition: true, scopeLine: 33, isOptimized: false, unit: !0, variables: !2)
...
!62 = distinct !DISubprogram(name: "good22", scope: !9, file: !9, line: 52, type: !37, isLocal: false, isDefinition: true, scopeLine: 53, isOptimized: false, unit: !0, variables: !2)
...
!82 = !{!30}
!83 = !DILocation(line: 71, column: 2, scope: !80)
