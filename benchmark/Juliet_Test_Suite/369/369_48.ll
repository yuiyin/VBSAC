...
entry:
  ...
  %rem = srem i32 100, %0, !dbg !51
  call void @printIntLine(i32 %rem), !dbg !52
  ret void, !dbg !53
}

; Function Attrs: nounwind uwtable
define void @good48() #0 !dbg !54 {
entry:
  %data = alloca i32, align 4
...
entry:
  ...
  call void @good48(), !dbg !72
  call void @bad48(), !dbg !73
  ret i32 1, !dbg !74
}
...
!1 = !DIFile(filename: "369_48.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!9 = !DIFile(filename: "./369_48.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!36 = distinct !DISubprogram(name: "bad48", scope: !9, file: !9, line: 29, type: !37, isLocal: false, isDefinition: true, scopeLine: 30, isOptimized: false, unit: !0, variables: !2)
...
!54 = distinct !DISubprogram(name: "good48", scope: !9, file: !9, line: 47, type: !37, isLocal: false, isDefinition: true, scopeLine: 48, isOptimized: false, unit: !0, variables: !2)
