...
sink:                                             ; preds = %source
  ...
  %div = sdiv i32 100, %1, !dbg !65
  call void @printIntLine(i32 %div), !dbg !66
  ret void, !dbg !67
}
...
entry:
  ...
  call void @good18(), !dbg !89
  call void @bad18(), !dbg !90
  ret i32 1, !dbg !91
}
...
!1 = !DIFile(filename: "369_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!7 = !DIFile(filename: "./369_18.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!54 = distinct !DISubprogram(name: "bad18", scope: !7, file: !7, line: 51, type: !55, isLocal: false, isDefinition: true, scopeLine: 52, isOptimized: false, unit: !0, variables: !2)
...
!68 = distinct !DISubprogram(name: "good18", scope: !7, file: !7, line: 69, type: !55, isLocal: false, isDefinition: true, scopeLine: 70, isOptimized: false, unit: !0, variables: !2)
...
!88 = distinct !DISubprogram(name: "main", scope: !7, file: !7, line: 93, type: !19, isLocal: false, isDefinition: true, scopeLine: 93, isOptimized: false, unit: !0, variables: !2)
!89 = !DILocation(line: 94, column: 2, scope: !88)
!90 = !DILocation(line: 95, column: 5, scope: !88)
!91 = !DILocation(line: 96, column: 5, scope: !88)
