...
if.then2:                                         ; preds = %if.end
  ...
  %rem = srem i32 100, %3, !dbg !57
  call void @printIntLine(i32 %rem), !dbg !58
...
entry:
  ...
  call void @good30(), !dbg !67
  call void @bad30(), !dbg !68
  ret i32 1, !dbg !69
}
...
if.then2:                                         ; preds = %if.end
  ...
  %rem = srem i32 100, %2, !dbg !87
  call void @printIntLine(i32 %rem), !dbg !88
...
!1 = !DIFile(filename: "369_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!7 = !DIFile(filename: "./369_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!39 = distinct !DISubprogram(name: "bad30", scope: !7, file: !7, line: 28, type: !40, isLocal: false, isDefinition: true, scopeLine: 29, isOptimized: false, unit: !0, variables: !2)
...
!61 = distinct !DISubprogram(name: "good30", scope: !7, file: !7, line: 73, type: !40, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
...
!66 = !{!8}
!67 = !DILocation(line: 82, column: 5, scope: !64)
!68 = !DILocation(line: 83, column: 5, scope: !64)
