...
if.then:                                          ; preds = %entry
  ...
  %div = sdiv i32 100, %1, !dbg !76
  call void @printIntLine(i32 %div), !dbg !77
...
if.then1:                                         ; preds = %if.else
  ...
  %div = sdiv i32 100, %2, !dbg !106
  call void @printIntLine(i32 %div), !dbg !107
...
entry:
  ...
  call void @good19(), !dbg !113
  call void @bad19(), !dbg !114
  ret i32 1, !dbg !115
}
...
!1 = !DIFile(filename: "369_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!7 = !DIFile(filename: "./369_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!56 = distinct !DISubprogram(name: "bad19", scope: !7, file: !7, line: 59, type: !57, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!80 = distinct !DISubprogram(name: "good19", scope: !7, file: !7, line: 95, type: !57, isLocal: false, isDefinition: true, scopeLine: 95, isOptimized: false, unit: !0, variables: !2)
...
!113 = !DILocation(line: 109, column: 2, scope: !112)
