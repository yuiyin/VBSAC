...
entry:
  ...
  call void @good25(), !dbg !54
  call void @bad25(), !dbg !55
  ret i32 1, !dbg !56
}
...
entry:
  ...
  %div = sdiv i32 100, %1, !dbg !62
  call void @printIntLine(i32 %div), !dbg !63
  ret void, !dbg !64
}

; Function Attrs: nounwind uwtable
define internal void @good25() #0 !dbg !65 {
entry:
  %data = alloca i32, align 4
...
entry:
  ...
  %div = sdiv i32 100, %1, !dbg !79
  call void @printIntLine(i32 %div), !dbg !80
  ret void, !dbg !81
}
...
!1 = !DIFile(filename: "369_25.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
!2 = !{}
!3 = !{!4}
...
!7 = !DIFile(filename: "./369_25.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/369")
...
!39 = distinct !DISubprogram(name: "bad25", scope: !7, file: !7, line: 36, type: !40, isLocal: false, isDefinition: true, scopeLine: 37, isOptimized: false, unit: !0, variables: !2)
...
!53 = !{!8}
!54 = !DILocation(line: 71, column: 2, scope: !51)
...
!65 = distinct !DISubprogram(name: "good25", scope: !7, file: !7, line: 57, type: !40, isLocal: true, isDefinition: true, scopeLine: 58, isOptimized: false, unit: !0, variables: !2)
