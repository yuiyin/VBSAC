...
if.else:                                          ; preds = %entry
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !85
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %call1 = call i32 @globalReturnsTrueOrFalse(), !dbg !87
  %tobool2 = icmp ne i32 %call1, 0, !dbg !87
  br i1 %tobool2, label %if.then3, label %if.else4, !dbg !89

if.then3:                                         ; preds = %if.end
  %0 = load i8*, i8** %data, align 8, !dbg !90
  call void @printLine(i8* %0), !dbg !92
  br label %if.end5, !dbg !93

if.else4:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !94
...
entry:
  %data = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %data, metadata !100, metadata !33), !dbg !101
...
if.end:                                           ; preds = %if.else, %if.then
  %call1 = call i32 @globalReturnsTrueOrFalse(), !dbg !107
  %tobool2 = icmp ne i32 %call1, 0, !dbg !107
  br i1 %tobool2, label %if.then3, label %if.else4, !dbg !109

if.then3:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !110
  %0 = load i8*, i8** %data, align 8, !dbg !112
  call void @printLine(i8* %0), !dbg !113
  br label %if.end5, !dbg !114

if.else4:                                         ; preds = %if.end
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !115
  %1 = load i8*, i8** %data, align 8, !dbg !117
  call void @printLine(i8* %1), !dbg !118
  br label %if.end5
...
entry:
  ...
  call void @good12(), !dbg !121
  call void @bad12(), !dbg !122
  ret i32 1, !dbg !123
}
...
!1 = !DIFile(filename: "457_12.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_12.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!85 = !DILocation(line: 70, column: 14, scope: !86)
!86 = distinct !DILexicalBlock(scope: !81, file: !8, line: 68, column: 5)
!87 = !DILocation(line: 72, column: 8, scope: !88)
!88 = distinct !DILexicalBlock(scope: !74, file: !8, line: 72, column: 8)
!89 = !DILocation(line: 72, column: 8, scope: !74)
!90 = !DILocation(line: 75, column: 19, scope: !91)
!91 = distinct !DILexicalBlock(scope: !88, file: !8, line: 73, column: 5)
!92 = !DILocation(line: 75, column: 9, scope: !91)
!93 = !DILocation(line: 76, column: 5, scope: !91)
!94 = !DILocation(line: 80, column: 14, scope: !95)
!95 = distinct !DILexicalBlock(scope: !88, file: !8, line: 78, column: 5)
!96 = !DILocation(line: 81, column: 19, scope: !95)
!97 = !DILocation(line: 81, column: 9, scope: !95)
!98 = !DILocation(line: 83, column: 1, scope: !74)
!99 = distinct !DISubprogram(name: "good12", scope: !8, file: !8, line: 89, type: !75, isLocal: false, isDefinition: true, scopeLine: 90, isOptimized: false, unit: !0, variables: !2)
!100 = !DILocalVariable(name: "data", scope: !99, file: !8, line: 91, type: !78)
!101 = !DILocation(line: 91, column: 12, scope: !99)
!102 = !DILocation(line: 92, column: 8, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !8, line: 92, column: 8)
!104 = !DILocation(line: 92, column: 8, scope: !99)
!105 = !DILocation(line: 96, column: 5, scope: !106)
!106 = distinct !DILexicalBlock(scope: !103, file: !8, line: 93, column: 5)
!107 = !DILocation(line: 102, column: 8, scope: !108)
!108 = distinct !DILexicalBlock(scope: !99, file: !8, line: 102, column: 8)
!109 = !DILocation(line: 102, column: 8, scope: !99)
!110 = !DILocation(line: 105, column: 14, scope: !111)
!111 = distinct !DILexicalBlock(scope: !108, file: !8, line: 103, column: 5)
!112 = !DILocation(line: 106, column: 19, scope: !111)
!113 = !DILocation(line: 106, column: 9, scope: !111)
!114 = !DILocation(line: 107, column: 5, scope: !111)
!115 = !DILocation(line: 111, column: 14, scope: !116)
!116 = distinct !DILexicalBlock(scope: !108, file: !8, line: 109, column: 5)
!117 = !DILocation(line: 112, column: 19, scope: !116)
!118 = !DILocation(line: 112, column: 9, scope: !116)
!119 = !DILocation(line: 114, column: 1, scope: !99)
!120 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 118, type: !19, isLocal: false, isDefinition: true, scopeLine: 118, isOptimized: false, unit: !0, variables: !2)
!121 = !DILocation(line: 119, column: 5, scope: !120)
!122 = !DILocation(line: 120, column: 2, scope: !120)
