...
entry:
  ...
  call void @printIntLine(i32 %0), !dbg !82
  ret void, !dbg !83
}

; Function Attrs: nounwind uwtable
define void @good20() #0 !dbg !84 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !85, metadata !33), !dbg !86
  store i32 5, i32* %data, align 4, !dbg !87
  %0 = load i32, i32* %data, align 4, !dbg !90
  call void @printIntLine(i32 %0), !dbg !93
  ret void, !dbg !94
}
...
entry:
  ...
  call void @good20(), !dbg !96
  call void @bad20(), !dbg !97
  ret i32 1, !dbg !98
}
...
!1 = !DIFile(filename: "457_20.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_20.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!76 = !{null}
!77 = !DILocalVariable(name: "data", scope: !74, file: !8, line: 61, type: !4)
!78 = !DILocation(line: 61, column: 9, scope: !74)
!79 = !DILocation(line: 70, column: 22, scope: !80)
!80 = distinct !DILexicalBlock(scope: !81, file: !8, line: 68, column: 5)
!81 = distinct !DILexicalBlock(scope: !74, file: !8, line: 67, column: 8)
!82 = !DILocation(line: 70, column: 9, scope: !80)
!83 = !DILocation(line: 72, column: 1, scope: !74)
!84 = distinct !DISubprogram(name: "good20", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!85 = !DILocalVariable(name: "data", scope: !84, file: !8, line: 80, type: !4)
!86 = !DILocation(line: 80, column: 9, scope: !84)
!87 = !DILocation(line: 84, column: 14, scope: !88)
!88 = distinct !DILexicalBlock(scope: !89, file: !8, line: 82, column: 5)
!89 = distinct !DILexicalBlock(scope: !84, file: !8, line: 81, column: 8)
!90 = !DILocation(line: 89, column: 22, scope: !91)
!91 = distinct !DILexicalBlock(scope: !92, file: !8, line: 87, column: 5)
!92 = distinct !DILexicalBlock(scope: !84, file: !8, line: 86, column: 8)
!93 = !DILocation(line: 89, column: 9, scope: !91)
!94 = !DILocation(line: 91, column: 1, scope: !84)
!95 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 95, type: !19, isLocal: false, isDefinition: true, scopeLine: 95, isOptimized: false, unit: !0, variables: !2)
!96 = !DILocation(line: 96, column: 2, scope: !95)
!97 = !DILocation(line: 97, column: 5, scope: !95)
!98 = !DILocation(line: 98, column: 5, scope: !95)
