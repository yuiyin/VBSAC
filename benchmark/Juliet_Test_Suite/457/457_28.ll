...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalTrue, align 4, !dbg !93
  %tobool1 = icmp ne i32 %1, 0, !dbg !93
  br i1 %tobool1, label %if.then2, label %if.end3, !dbg !95
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalFalse, align 4, !dbg !109
...
entry:
  ...
  call void @good28(), !dbg !121
  call void @bad28(), !dbg !122
  ret i32 1, !dbg !123
}
...
!1 = !DIFile(filename: "457_28.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_28.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!83 = distinct !DISubprogram(name: "bad28", scope: !8, file: !8, line: 63, type: !84, isLocal: false, isDefinition: true, scopeLine: 64, isOptimized: false, unit: !0, variables: !2)
...
!101 = distinct !DISubprogram(name: "good28", scope: !8, file: !8, line: 82, type: !84, isLocal: false, isDefinition: true, scopeLine: 83, isOptimized: false, unit: !0, variables: !2)
!102 = !DILocalVariable(name: "data", scope: !101, file: !8, line: 84, type: !4)
!103 = !DILocation(line: 84, column: 9, scope: !101)
!104 = !DILocation(line: 85, column: 8, scope: !105)
!105 = distinct !DILexicalBlock(scope: !101, file: !8, line: 85, column: 8)
!106 = !DILocation(line: 85, column: 8, scope: !101)
!107 = !DILocation(line: 89, column: 5, scope: !108)
!108 = distinct !DILexicalBlock(scope: !105, file: !8, line: 86, column: 5)
!109 = !DILocation(line: 90, column: 8, scope: !110)
!110 = distinct !DILexicalBlock(scope: !101, file: !8, line: 90, column: 8)
!111 = !DILocation(line: 90, column: 8, scope: !101)
!112 = !DILocation(line: 93, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !110, file: !8, line: 91, column: 5)
!114 = !DILocation(line: 94, column: 5, scope: !113)
!115 = !DILocation(line: 98, column: 14, scope: !116)
!116 = distinct !DILexicalBlock(scope: !110, file: !8, line: 96, column: 5)
...
!120 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 104, type: !19, isLocal: false, isDefinition: true, scopeLine: 104, isOptimized: false, unit: !0, variables: !2)
!121 = !DILocation(line: 105, column: 5, scope: !120)
!122 = !DILocation(line: 106, column: 2, scope: !120)
!123 = !DILocation(line: 107, column: 5, scope: !120)
