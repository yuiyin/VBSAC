...
entry:
  ...
  call void @printLine(i8* %0), !dbg !81
  ret void, !dbg !82
}

; Function Attrs: nounwind uwtable
define void @good15() #0 !dbg !83 {
entry:
  %data = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %data, metadata !84, metadata !33), !dbg !85
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !86
  %0 = load i8*, i8** %data, align 8, !dbg !87
  call void @printLine(i8* %0), !dbg !88
  ret void, !dbg !89
}
...
entry:
  ...
  call void @good15(), !dbg !91
  call void @bad15(), !dbg !92
  ret i32 1, !dbg !93
}
...
!1 = !DIFile(filename: "457_15.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_15.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!80 = !DILocation(line: 77, column: 19, scope: !74)
!81 = !DILocation(line: 77, column: 9, scope: !74)
!82 = !DILocation(line: 84, column: 1, scope: !74)
!83 = distinct !DISubprogram(name: "good15", scope: !8, file: !8, line: 90, type: !75, isLocal: false, isDefinition: true, scopeLine: 91, isOptimized: false, unit: !0, variables: !2)
!84 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 92, type: !78)
!85 = !DILocation(line: 92, column: 12, scope: !83)
!86 = !DILocation(line: 112, column: 14, scope: !83)
!87 = !DILocation(line: 113, column: 19, scope: !83)
!88 = !DILocation(line: 113, column: 9, scope: !83)
!89 = !DILocation(line: 116, column: 1, scope: !83)
!90 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 119, type: !19, isLocal: false, isDefinition: true, scopeLine: 119, isOptimized: false, unit: !0, variables: !2)
!91 = !DILocation(line: 120, column: 5, scope: !90)
!92 = !DILocation(line: 121, column: 2, scope: !90)
!93 = !DILocation(line: 122, column: 5, scope: !90)
