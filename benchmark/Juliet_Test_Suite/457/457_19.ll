...
entry:
  ...
  call void @printIntLine(i32 %0), !dbg !80
  ret void, !dbg !81
}

; Function Attrs: nounwind uwtable
define void @good19() #0 !dbg !82 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !83, metadata !33), !dbg !84
  store i32 5, i32* %data, align 4, !dbg !85
  %0 = load i32, i32* %data, align 4, !dbg !86
  call void @printIntLine(i32 %0), !dbg !87
  ret void, !dbg !88
}
...
entry:
  ...
  call void @good19(), !dbg !90
  call void @bad19(), !dbg !91
  ret i32 1, !dbg !92
}
...
!1 = !DIFile(filename: "457_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_19.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!79 = !DILocation(line: 65, column: 18, scope: !74)
!80 = !DILocation(line: 65, column: 5, scope: !74)
!81 = !DILocation(line: 66, column: 1, scope: !74)
!82 = distinct !DISubprogram(name: "good19", scope: !8, file: !8, line: 73, type: !75, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
!83 = !DILocalVariable(name: "data", scope: !82, file: !8, line: 75, type: !4)
!84 = !DILocation(line: 75, column: 9, scope: !82)
!85 = !DILocation(line: 77, column: 10, scope: !82)
!86 = !DILocation(line: 79, column: 18, scope: !82)
!87 = !DILocation(line: 79, column: 5, scope: !82)
!88 = !DILocation(line: 80, column: 1, scope: !82)
!89 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 84, type: !19, isLocal: false, isDefinition: true, scopeLine: 84, isOptimized: false, unit: !0, variables: !2)
!90 = !DILocation(line: 85, column: 5, scope: !89)
!91 = !DILocation(line: 86, column: 2, scope: !89)
!92 = !DILocation(line: 87, column: 5, scope: !89)
