...
; Function Attrs: nounwind uwtable
define void @bad41() #0 !dbg !76 {
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !79, metadata !35), !dbg !80
...
if.then2:                                         ; preds = %if.end
  ...
  call void @printLongLine(i64 %2), !dbg !91
...
; Function Attrs: nounwind uwtable
define void @good41() #0 !dbg !94 {
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !95, metadata !35), !dbg !96
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @staticFalse, align 4, !dbg !102
  %tobool1 = icmp ne i32 %1, 0, !dbg !102
  br i1 %tobool1, label %if.then2, label %if.else, !dbg !104

if.then2:                                         ; preds = %if.end
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0)), !dbg !105
  br label %if.end3, !dbg !107

if.else:                                          ; preds = %if.end
  store i64 5, i64* %data, align 8, !dbg !108
  %2 = load i64, i64* %data, align 8, !dbg !110
  call void @printLongLine(i64 %2), !dbg !111
  br label %if.end3
...
entry:
  ...
  call void @good41(), !dbg !114
  call void @bad41(), !dbg !115
  ret i32 1, !dbg !116
}
...
!1 = !DIFile(filename: "457_41.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_41.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!76 = distinct !DISubprogram(name: "bad41", scope: !8, file: !8, line: 62, type: !77, isLocal: false, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
!77 = !DISubroutineType(types: !78)
!78 = !{null}
!79 = !DILocalVariable(name: "data", scope: !76, file: !8, line: 64, type: !68)
!80 = !DILocation(line: 64, column: 13, scope: !76)
!81 = !DILocation(line: 65, column: 8, scope: !82)
!82 = distinct !DILexicalBlock(scope: !76, file: !8, line: 65, column: 8)
!83 = !DILocation(line: 65, column: 8, scope: !76)
!84 = !DILocation(line: 69, column: 5, scope: !85)
!85 = distinct !DILexicalBlock(scope: !82, file: !8, line: 66, column: 5)
!86 = !DILocation(line: 70, column: 8, scope: !87)
!87 = distinct !DILexicalBlock(scope: !76, file: !8, line: 70, column: 8)
!88 = !DILocation(line: 70, column: 8, scope: !76)
!89 = !DILocation(line: 73, column: 23, scope: !90)
!90 = distinct !DILexicalBlock(scope: !87, file: !8, line: 71, column: 5)
!91 = !DILocation(line: 73, column: 9, scope: !90)
!92 = !DILocation(line: 74, column: 5, scope: !90)
!93 = !DILocation(line: 75, column: 1, scope: !76)
!94 = distinct !DISubprogram(name: "good41", scope: !8, file: !8, line: 81, type: !77, isLocal: false, isDefinition: true, scopeLine: 82, isOptimized: false, unit: !0, variables: !2)
!95 = !DILocalVariable(name: "data", scope: !94, file: !8, line: 83, type: !68)
!96 = !DILocation(line: 83, column: 13, scope: !94)
!97 = !DILocation(line: 84, column: 8, scope: !98)
!98 = distinct !DILexicalBlock(scope: !94, file: !8, line: 84, column: 8)
!99 = !DILocation(line: 84, column: 8, scope: !94)
!100 = !DILocation(line: 88, column: 5, scope: !101)
!101 = distinct !DILexicalBlock(scope: !98, file: !8, line: 85, column: 5)
!102 = !DILocation(line: 89, column: 8, scope: !103)
!103 = distinct !DILexicalBlock(scope: !94, file: !8, line: 89, column: 8)
!104 = !DILocation(line: 89, column: 8, scope: !94)
!105 = !DILocation(line: 92, column: 9, scope: !106)
!106 = distinct !DILexicalBlock(scope: !103, file: !8, line: 90, column: 5)
!107 = !DILocation(line: 93, column: 5, scope: !106)
!108 = !DILocation(line: 97, column: 14, scope: !109)
!109 = distinct !DILexicalBlock(scope: !103, file: !8, line: 95, column: 5)
!110 = !DILocation(line: 98, column: 23, scope: !109)
!111 = !DILocation(line: 98, column: 9, scope: !109)
!112 = !DILocation(line: 100, column: 1, scope: !94)
!113 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 104, type: !21, isLocal: false, isDefinition: true, scopeLine: 104, isOptimized: false, unit: !0, variables: !2)
!114 = !DILocation(line: 105, column: 5, scope: !113)
!115 = !DILocation(line: 106, column: 2, scope: !113)
!116 = !DILocation(line: 107, column: 5, scope: !113)
