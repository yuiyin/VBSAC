...
while.end:                                        ; preds = %while.body
  br label %while.body1, !dbg !91

while.body1:                                      ; preds = %while.end
  %0 = load i32, i32* %data, align 4, !dbg !92
  call void @printIntLine(i32 %0), !dbg !94
  br label %while.end2, !dbg !95
...
while.end:                                        ; preds = %while.body
  br label %while.body1, !dbg !103

while.body1:                                      ; preds = %while.end
  store i32 5, i32* %data, align 4, !dbg !104
  %0 = load i32, i32* %data, align 4, !dbg !106
  call void @printIntLine(i32 %0), !dbg !107
  br label %while.end2, !dbg !108
...
entry:
  ...
  call void @good34(), !dbg !111
  call void @bad34(), !dbg !112
  ret i32 1, !dbg !113
}
...
!1 = !DIFile(filename: "457_34.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_34.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!83 = distinct !DISubprogram(name: "bad34", scope: !8, file: !8, line: 63, type: !84, isLocal: false, isDefinition: true, scopeLine: 64, isOptimized: false, unit: !0, variables: !2)
!84 = !DISubroutineType(types: !85)
!85 = !{null}
!86 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 65, type: !4)
!87 = !DILocation(line: 65, column: 9, scope: !83)
!88 = !DILocation(line: 66, column: 5, scope: !83)
!89 = !DILocation(line: 70, column: 9, scope: !90)
!90 = distinct !DILexicalBlock(scope: !83, file: !8, line: 67, column: 5)
!91 = !DILocation(line: 72, column: 5, scope: !83)
!92 = !DILocation(line: 75, column: 22, scope: !93)
!93 = distinct !DILexicalBlock(scope: !83, file: !8, line: 73, column: 5)
!94 = !DILocation(line: 75, column: 9, scope: !93)
!95 = !DILocation(line: 76, column: 9, scope: !93)
!96 = !DILocation(line: 78, column: 1, scope: !83)
!97 = distinct !DISubprogram(name: "good34", scope: !8, file: !8, line: 84, type: !84, isLocal: false, isDefinition: true, scopeLine: 85, isOptimized: false, unit: !0, variables: !2)
!98 = !DILocalVariable(name: "data", scope: !97, file: !8, line: 86, type: !4)
!99 = !DILocation(line: 86, column: 9, scope: !97)
!100 = !DILocation(line: 87, column: 5, scope: !97)
!101 = !DILocation(line: 91, column: 9, scope: !102)
!102 = distinct !DILexicalBlock(scope: !97, file: !8, line: 88, column: 5)
!103 = !DILocation(line: 93, column: 5, scope: !97)
!104 = !DILocation(line: 96, column: 14, scope: !105)
!105 = distinct !DILexicalBlock(scope: !97, file: !8, line: 94, column: 5)
!106 = !DILocation(line: 97, column: 22, scope: !105)
!107 = !DILocation(line: 97, column: 9, scope: !105)
!108 = !DILocation(line: 98, column: 9, scope: !105)
!109 = !DILocation(line: 99, column: 6, scope: !97)
!110 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 103, type: !19, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: false, unit: !0, variables: !2)
!111 = !DILocation(line: 104, column: 2, scope: !110)
