...
; Function Attrs: nounwind uwtable
define void @bad33() #0 !dbg !83 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !86, metadata !33), !dbg !87
  %0 = load i32, i32* %data, align 4, !dbg !88
  call void @printIntLine(i32 %0), !dbg !89
  ret void, !dbg !90
}

; Function Attrs: nounwind uwtable
define void @good33() #0 !dbg !91 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !92, metadata !33), !dbg !93
  store i32 5, i32* %data, align 4, !dbg !94
  %0 = load i32, i32* %data, align 4, !dbg !95
  call void @printIntLine(i32 %0), !dbg !96
  ret void, !dbg !97
}
...
entry:
  ...
  call void @good33(), !dbg !99
  call void @bad33(), !dbg !100
  ret i32 1, !dbg !101
}
...
!1 = !DIFile(filename: "457_33.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_33.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!83 = distinct !DISubprogram(name: "bad33", scope: !8, file: !8, line: 63, type: !84, isLocal: false, isDefinition: true, scopeLine: 64, isOptimized: false, unit: !0, variables: !2)
!84 = !DISubroutineType(types: !85)
!85 = !{null}
!86 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 65, type: !4)
!87 = !DILocation(line: 65, column: 9, scope: !83)
!88 = !DILocation(line: 81, column: 22, scope: !83)
!89 = !DILocation(line: 81, column: 9, scope: !83)
!90 = !DILocation(line: 88, column: 1, scope: !83)
!91 = distinct !DISubprogram(name: "good33", scope: !8, file: !8, line: 94, type: !84, isLocal: false, isDefinition: true, scopeLine: 95, isOptimized: false, unit: !0, variables: !2)
!92 = !DILocalVariable(name: "data", scope: !91, file: !8, line: 96, type: !4)
!93 = !DILocation(line: 96, column: 9, scope: !91)
!94 = !DILocation(line: 116, column: 14, scope: !91)
!95 = !DILocation(line: 117, column: 22, scope: !91)
!96 = !DILocation(line: 117, column: 9, scope: !91)
!97 = !DILocation(line: 120, column: 1, scope: !91)
!98 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 124, type: !19, isLocal: false, isDefinition: true, scopeLine: 124, isOptimized: false, unit: !0, variables: !2)
!99 = !DILocation(line: 125, column: 2, scope: !98)
!100 = !DILocation(line: 126, column: 5, scope: !98)
!101 = !DILocation(line: 127, column: 5, scope: !98)
