...
entry:
  ...
  call void @good37(), !dbg !87
  call void @bad37(), !dbg !88
  ret i32 1, !dbg !89
}
...
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !91, metadata !33), !dbg !92
  store i64 5, i64* %data, align 8, !dbg !93
  %0 = load i64, i64* %data, align 8, !dbg !94
  call void @printLongLine(i64 %0), !dbg !95
  ret void, !dbg !96
}
...
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !98, metadata !33), !dbg !99
  store i64 5, i64* %data, align 8, !dbg !100
  %0 = load i64, i64* %data, align 8, !dbg !101
  call void @printLongLine(i64 %0), !dbg !102
  ret void, !dbg !103
}
...
!1 = !DIFile(filename: "457_37.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_37.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!74 = distinct !DISubprogram(name: "bad37", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "data", scope: !74, file: !8, line: 61, type: !66)
!78 = !DILocation(line: 61, column: 13, scope: !74)
!79 = !DILocation(line: 65, column: 19, scope: !74)
!80 = !DILocation(line: 65, column: 5, scope: !74)
!81 = !DILocation(line: 66, column: 1, scope: !74)
!82 = distinct !DISubprogram(name: "good37", scope: !8, file: !8, line: 93, type: !75, isLocal: false, isDefinition: true, scopeLine: 94, isOptimized: false, unit: !0, variables: !2)
!83 = !DILocation(line: 95, column: 5, scope: !82)
!84 = !DILocation(line: 96, column: 5, scope: !82)
!85 = !DILocation(line: 97, column: 1, scope: !82)
!86 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 101, type: !19, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!87 = !DILocation(line: 102, column: 2, scope: !86)
!88 = !DILocation(line: 103, column: 5, scope: !86)
!89 = !DILocation(line: 104, column: 5, scope: !86)
!90 = distinct !DISubprogram(name: "goodG2B", scope: !8, file: !8, line: 73, type: !75, isLocal: true, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
!91 = !DILocalVariable(name: "data", scope: !90, file: !8, line: 75, type: !66)
!92 = !DILocation(line: 75, column: 13, scope: !90)
!93 = !DILocation(line: 77, column: 10, scope: !90)
!94 = !DILocation(line: 79, column: 19, scope: !90)
!95 = !DILocation(line: 79, column: 5, scope: !90)
!96 = !DILocation(line: 80, column: 1, scope: !90)
!97 = distinct !DISubprogram(name: "goodB2G", scope: !8, file: !8, line: 83, type: !75, isLocal: true, isDefinition: true, scopeLine: 84, isOptimized: false, unit: !0, variables: !2)
!98 = !DILocalVariable(name: "data", scope: !97, file: !8, line: 85, type: !66)
!99 = !DILocation(line: 85, column: 13, scope: !97)
!100 = !DILocation(line: 89, column: 10, scope: !97)
!101 = !DILocation(line: 90, column: 19, scope: !97)
!102 = !DILocation(line: 90, column: 5, scope: !97)
!103 = !DILocation(line: 91, column: 1, scope: !97)
