...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalFive, align 4, !dbg !85
  %cmp1 = icmp eq i32 %1, 5, !dbg !87
  br i1 %cmp1, label %if.then2, label %if.end3, !dbg !88
...
; Function Attrs: nounwind uwtable
define void @good50() #0 !dbg !94 {
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !95, metadata !33), !dbg !96
  %0 = load i32, i32* @globalFive, align 4, !dbg !97
  %cmp = icmp eq i32 %0, 5, !dbg !99
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalFive, align 4, !dbg !103
  %cmp1 = icmp ne i32 %1, 5, !dbg !105
  br i1 %cmp1, label %if.then2, label %if.else, !dbg !106
...
if.else:                                          ; preds = %if.end
  store i64 5, i64* %data, align 8, !dbg !110
  %2 = load i64, i64* %data, align 8, !dbg !112
  call void @printLongLine(i64 %2), !dbg !113
  br label %if.end3
...
entry:
  ...
  call void @good50(), !dbg !116
  call void @bad50(), !dbg !117
  ret i32 1, !dbg !118
}
...
!1 = !DIFile(filename: "457_50.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_50.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!74 = distinct !DISubprogram(name: "bad50", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!84 = distinct !DILexicalBlock(scope: !80, file: !8, line: 63, column: 5)
!85 = !DILocation(line: 67, column: 8, scope: !86)
!86 = distinct !DILexicalBlock(scope: !74, file: !8, line: 67, column: 8)
!87 = !DILocation(line: 67, column: 18, scope: !86)
!88 = !DILocation(line: 67, column: 8, scope: !74)
!89 = !DILocation(line: 70, column: 23, scope: !90)
!90 = distinct !DILexicalBlock(scope: !86, file: !8, line: 68, column: 5)
!91 = !DILocation(line: 70, column: 9, scope: !90)
!92 = !DILocation(line: 71, column: 5, scope: !90)
!93 = !DILocation(line: 72, column: 1, scope: !74)
!94 = distinct !DISubprogram(name: "good50", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!95 = !DILocalVariable(name: "data", scope: !94, file: !8, line: 80, type: !66)
!96 = !DILocation(line: 80, column: 13, scope: !94)
!97 = !DILocation(line: 81, column: 8, scope: !98)
!98 = distinct !DILexicalBlock(scope: !94, file: !8, line: 81, column: 8)
!99 = !DILocation(line: 81, column: 18, scope: !98)
!100 = !DILocation(line: 81, column: 8, scope: !94)
!101 = !DILocation(line: 85, column: 5, scope: !102)
!102 = distinct !DILexicalBlock(scope: !98, file: !8, line: 82, column: 5)
!103 = !DILocation(line: 86, column: 8, scope: !104)
!104 = distinct !DILexicalBlock(scope: !94, file: !8, line: 86, column: 8)
!105 = !DILocation(line: 86, column: 18, scope: !104)
!106 = !DILocation(line: 86, column: 8, scope: !94)
!107 = !DILocation(line: 89, column: 9, scope: !108)
!108 = distinct !DILexicalBlock(scope: !104, file: !8, line: 87, column: 5)
!109 = !DILocation(line: 90, column: 5, scope: !108)
!110 = !DILocation(line: 94, column: 14, scope: !111)
!111 = distinct !DILexicalBlock(scope: !104, file: !8, line: 92, column: 5)
!112 = !DILocation(line: 95, column: 23, scope: !111)
!113 = !DILocation(line: 95, column: 9, scope: !111)
!114 = !DILocation(line: 97, column: 1, scope: !94)
!115 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 101, type: !19, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!116 = !DILocation(line: 102, column: 5, scope: !115)
!117 = !DILocation(line: 103, column: 2, scope: !115)
!118 = !DILocation(line: 104, column: 5, scope: !115)
