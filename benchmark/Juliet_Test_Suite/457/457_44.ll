...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsTrue(), !dbg !84
  %tobool2 = icmp ne i32 %call1, 0, !dbg !84
  br i1 %tobool2, label %if.then3, label %if.end4, !dbg !86

if.then3:                                         ; preds = %if.end
  %0 = load i64, i64* %data, align 8, !dbg !87
  call void @printLongLine(i64 %0), !dbg !89
...
; Function Attrs: nounwind uwtable
define void @good44() #0 !dbg !92 {
entry:
  %data = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !93, metadata !33), !dbg !94
...
if.then3:                                         ; preds = %if.end
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0)), !dbg !103
  br label %if.end4, !dbg !105

if.else:                                          ; preds = %if.end
  store i64 5, i64* %data, align 8, !dbg !106
  %0 = load i64, i64* %data, align 8, !dbg !108
  call void @printLongLine(i64 %0), !dbg !109
  br label %if.end4
...
entry:
  ...
  call void @good44(), !dbg !112
  call void @bad44(), !dbg !113
  ret i32 1, !dbg !114
}

; Function Attrs: nounwind uwtable
define internal i32 @staticReturnsTrue() #0 !dbg !115 {
entry:
  ret i32 1, !dbg !116
}
...
!1 = !DIFile(filename: "457_44.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_44.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!74 = distinct !DISubprogram(name: "bad44", scope: !8, file: !8, line: 69, type: !75, isLocal: false, isDefinition: true, scopeLine: 70, isOptimized: false, unit: !0, variables: !2)
!75 = !DISubroutineType(types: !76)
!76 = !{null}
!77 = !DILocalVariable(name: "data", scope: !74, file: !8, line: 71, type: !66)
!78 = !DILocation(line: 71, column: 13, scope: !74)
!79 = !DILocation(line: 72, column: 8, scope: !80)
!80 = distinct !DILexicalBlock(scope: !74, file: !8, line: 72, column: 8)
!81 = !DILocation(line: 72, column: 8, scope: !74)
!82 = !DILocation(line: 76, column: 5, scope: !83)
!83 = distinct !DILexicalBlock(scope: !80, file: !8, line: 73, column: 5)
!84 = !DILocation(line: 77, column: 8, scope: !85)
!85 = distinct !DILexicalBlock(scope: !74, file: !8, line: 77, column: 8)
!86 = !DILocation(line: 77, column: 8, scope: !74)
!87 = !DILocation(line: 80, column: 23, scope: !88)
!88 = distinct !DILexicalBlock(scope: !85, file: !8, line: 78, column: 5)
!89 = !DILocation(line: 80, column: 9, scope: !88)
!90 = !DILocation(line: 81, column: 5, scope: !88)
!91 = !DILocation(line: 82, column: 1, scope: !74)
!92 = distinct !DISubprogram(name: "good44", scope: !8, file: !8, line: 88, type: !75, isLocal: false, isDefinition: true, scopeLine: 89, isOptimized: false, unit: !0, variables: !2)
!93 = !DILocalVariable(name: "data", scope: !92, file: !8, line: 90, type: !66)
!94 = !DILocation(line: 90, column: 13, scope: !92)
!95 = !DILocation(line: 91, column: 8, scope: !96)
!96 = distinct !DILexicalBlock(scope: !92, file: !8, line: 91, column: 8)
!97 = !DILocation(line: 91, column: 8, scope: !92)
!98 = !DILocation(line: 95, column: 5, scope: !99)
!99 = distinct !DILexicalBlock(scope: !96, file: !8, line: 92, column: 5)
!100 = !DILocation(line: 96, column: 8, scope: !101)
!101 = distinct !DILexicalBlock(scope: !92, file: !8, line: 96, column: 8)
!102 = !DILocation(line: 96, column: 8, scope: !92)
!103 = !DILocation(line: 99, column: 9, scope: !104)
!104 = distinct !DILexicalBlock(scope: !101, file: !8, line: 97, column: 5)
!105 = !DILocation(line: 100, column: 5, scope: !104)
!106 = !DILocation(line: 104, column: 14, scope: !107)
!107 = distinct !DILexicalBlock(scope: !101, file: !8, line: 102, column: 5)
!108 = !DILocation(line: 105, column: 23, scope: !107)
!109 = !DILocation(line: 105, column: 9, scope: !107)
!110 = !DILocation(line: 107, column: 1, scope: !92)
!111 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 110, type: !19, isLocal: false, isDefinition: true, scopeLine: 110, isOptimized: false, unit: !0, variables: !2)
!112 = !DILocation(line: 111, column: 5, scope: !111)
!113 = !DILocation(line: 112, column: 2, scope: !111)
!114 = !DILocation(line: 113, column: 5, scope: !111)
!115 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !8, file: !8, line: 57, type: !19, isLocal: true, isDefinition: true, scopeLine: 58, isOptimized: false, unit: !0, variables: !2)
!116 = !DILocation(line: 59, column: 5, scope: !115)
!117 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !8, file: !8, line: 62, type: !19, isLocal: true, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
