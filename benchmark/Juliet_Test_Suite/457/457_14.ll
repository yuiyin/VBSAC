...
; Function Attrs: nounwind uwtable
define void @good14() #0 !dbg !95 {
entry:
  %data = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %data, metadata !96, metadata !33), !dbg !97
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalFive, align 4, !dbg !104
...
if.else:                                          ; preds = %if.end
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0), i8** %data, align 8, !dbg !111
  %2 = load i8*, i8** %data, align 8, !dbg !113
  call void @printLine(i8* %2), !dbg !114
  br label %if.end3
...
entry:
  ...
  call void @good14(), !dbg !117
  call void @bad14(), !dbg !118
  ret i32 1, !dbg !119
}
...
!1 = !DIFile(filename: "457_14.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_14.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!82 = !DILocation(line: 62, column: 18, scope: !81)
!83 = !DILocation(line: 62, column: 8, scope: !74)
!84 = !DILocation(line: 66, column: 5, scope: !85)
!85 = distinct !DILexicalBlock(scope: !81, file: !8, line: 63, column: 5)
...
!89 = !DILocation(line: 67, column: 8, scope: !74)
!90 = !DILocation(line: 70, column: 19, scope: !91)
!91 = distinct !DILexicalBlock(scope: !87, file: !8, line: 68, column: 5)
!92 = !DILocation(line: 70, column: 9, scope: !91)
!93 = !DILocation(line: 71, column: 5, scope: !91)
!94 = !DILocation(line: 72, column: 1, scope: !74)
!95 = distinct !DISubprogram(name: "good14", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
...
!100 = !DILocation(line: 81, column: 18, scope: !99)
!101 = !DILocation(line: 81, column: 8, scope: !95)
!102 = !DILocation(line: 85, column: 5, scope: !103)
!103 = distinct !DILexicalBlock(scope: !99, file: !8, line: 82, column: 5)
!104 = !DILocation(line: 86, column: 8, scope: !105)
!105 = distinct !DILexicalBlock(scope: !95, file: !8, line: 86, column: 8)
!106 = !DILocation(line: 86, column: 18, scope: !105)
!107 = !DILocation(line: 86, column: 8, scope: !95)
!108 = !DILocation(line: 89, column: 9, scope: !109)
!109 = distinct !DILexicalBlock(scope: !105, file: !8, line: 87, column: 5)
...
!113 = !DILocation(line: 95, column: 19, scope: !112)
!114 = !DILocation(line: 95, column: 9, scope: !112)
!115 = !DILocation(line: 97, column: 1, scope: !95)
!116 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 101, type: !19, isLocal: false, isDefinition: true, scopeLine: 101, isOptimized: false, unit: !0, variables: !2)
!117 = !DILocation(line: 102, column: 5, scope: !116)
!118 = !DILocation(line: 103, column: 2, scope: !116)
!119 = !DILocation(line: 104, column: 5, scope: !116)
