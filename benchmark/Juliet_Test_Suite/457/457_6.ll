...
entry:
  ...
  call void @printLine(i8* %0), !dbg !83
  ret void, !dbg !84
}
...
entry:
  %data = alloca i8*, align 8
  call void @llvm.dbg.declare(metadata i8** %data, metadata !86, metadata !33), !dbg !87
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i8** %data, align 8, !dbg !88
...
entry:
  ...
  call void @good6(), !dbg !95
  call void @bad6(), !dbg !96
  ret i32 1, !dbg !97
}
...
!1 = !DIFile(filename: "457_6.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_6.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!80 = !DILocation(line: 72, column: 19, scope: !81)
!81 = distinct !DILexicalBlock(scope: !82, file: !8, line: 70, column: 5)
!82 = distinct !DILexicalBlock(scope: !74, file: !8, line: 69, column: 8)
!83 = !DILocation(line: 72, column: 9, scope: !81)
!84 = !DILocation(line: 74, column: 1, scope: !74)
!85 = distinct !DISubprogram(name: "good6", scope: !8, file: !8, line: 80, type: !75, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
!86 = !DILocalVariable(name: "data", scope: !85, file: !8, line: 82, type: !78)
!87 = !DILocation(line: 82, column: 12, scope: !85)
!88 = !DILocation(line: 96, column: 14, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !8, line: 94, column: 5)
!90 = distinct !DILexicalBlock(scope: !85, file: !8, line: 88, column: 8)
!91 = !DILocation(line: 97, column: 19, scope: !89)
!92 = !DILocation(line: 97, column: 9, scope: !89)
!93 = !DILocation(line: 99, column: 1, scope: !85)
!94 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 103, type: !19, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: false, unit: !0, variables: !2)
!95 = !DILocation(line: 104, column: 5, scope: !94)
!96 = !DILocation(line: 105, column: 2, scope: !94)
!97 = !DILocation(line: 106, column: 5, scope: !94)
