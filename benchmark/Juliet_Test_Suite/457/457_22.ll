...
; Function Attrs: nounwind uwtable
define void @bad22() #0 !dbg !83 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !86, metadata !33), !dbg !87
  %0 = load i32, i32* %data, align 4, !dbg !88
  call void @printIntLine(i32 %0), !dbg !91
  ret void, !dbg !92
}

; Function Attrs: nounwind uwtable
define void @good22() #0 !dbg !93 {
entry:
  %data = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !94, metadata !33), !dbg !95
  store i32 5, i32* %data, align 4, !dbg !96
  %0 = load i32, i32* %data, align 4, !dbg !99
...
entry:
  ...
  call void @good22(), !dbg !103
  call void @bad22(), !dbg !104
  ret i32 1, !dbg !105
}
...
!1 = !DIFile(filename: "457_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_22.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!83 = distinct !DISubprogram(name: "bad22", scope: !8, file: !8, line: 66, type: !84, isLocal: false, isDefinition: true, scopeLine: 67, isOptimized: false, unit: !0, variables: !2)
!84 = !DISubroutineType(types: !85)
!85 = !{null}
!86 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 68, type: !4)
!87 = !DILocation(line: 68, column: 9, scope: !83)
!88 = !DILocation(line: 77, column: 22, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !8, line: 75, column: 5)
!90 = distinct !DILexicalBlock(scope: !83, file: !8, line: 74, column: 8)
!91 = !DILocation(line: 77, column: 9, scope: !89)
!92 = !DILocation(line: 79, column: 1, scope: !83)
!93 = distinct !DISubprogram(name: "good22", scope: !8, file: !8, line: 87, type: !84, isLocal: false, isDefinition: true, scopeLine: 88, isOptimized: false, unit: !0, variables: !2)
!94 = !DILocalVariable(name: "data", scope: !93, file: !8, line: 89, type: !4)
!95 = !DILocation(line: 89, column: 13, scope: !93)
!96 = !DILocation(line: 103, column: 14, scope: !97)
!97 = distinct !DILexicalBlock(scope: !98, file: !8, line: 101, column: 5)
!98 = distinct !DILexicalBlock(scope: !93, file: !8, line: 95, column: 8)
!99 = !DILocation(line: 104, column: 22, scope: !97)
!100 = !DILocation(line: 104, column: 9, scope: !97)
!101 = !DILocation(line: 106, column: 1, scope: !93)
!102 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 110, type: !19, isLocal: false, isDefinition: true, scopeLine: 110, isOptimized: false, unit: !0, variables: !2)
!103 = !DILocation(line: 111, column: 5, scope: !102)
!104 = !DILocation(line: 112, column: 2, scope: !102)
!105 = !DILocation(line: 113, column: 5, scope: !102)
