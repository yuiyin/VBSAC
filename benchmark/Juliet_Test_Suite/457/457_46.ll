...
if.end:                                           ; preds = %if.then, %entry
  ...
  br i1 %tobool1, label %if.then2, label %if.end3, !dbg !86

if.then2:                                         ; preds = %if.end
  %2 = load i32, i32* %data, align 4, !dbg !87
  %conv = sext i32 %2 to i64, !dbg !87
  call void @printLongLine(i64 %conv), !dbg !89
...
entry:
  ...
  %0 = load i32, i32* @globalTrue, align 4, !dbg !95
...
if.end:                                           ; preds = %if.then, %entry
  %1 = load i32, i32* @globalFalse, align 4, !dbg !100
...
if.else:                                          ; preds = %if.end
  ...
  call void @printLongLine(i64 %conv), !dbg !109
  br label %if.end3
...
entry:
  ...
  call void @good46(), !dbg !112
  call void @bad46(), !dbg !113
  ret i32 1, !dbg !114
}
...
!1 = !DIFile(filename: "457_46.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_46.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!74 = distinct !DISubprogram(name: "bad46", scope: !8, file: !8, line: 59, type: !75, isLocal: false, isDefinition: true, scopeLine: 60, isOptimized: false, unit: !0, variables: !2)
...
!92 = distinct !DISubprogram(name: "good46", scope: !8, file: !8, line: 78, type: !75, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!93 = !DILocalVariable(name: "data", scope: !92, file: !8, line: 80, type: !4)
...
!111 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 100, type: !19, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!112 = !DILocation(line: 101, column: 5, scope: !111)
!113 = !DILocation(line: 102, column: 2, scope: !111)
!114 = !DILocation(line: 103, column: 5, scope: !111)
