...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsTrue(), !dbg !93
  %tobool2 = icmp ne i32 %call1, 0, !dbg !93
  br i1 %tobool2, label %if.then3, label %if.end4, !dbg !95

if.then3:                                         ; preds = %if.end
  %0 = load i32, i32* %data, align 4, !dbg !96
  %conv = sitofp i32 %0 to double, !dbg !96
  call void @printDoubleLine(double %conv), !dbg !98
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsFalse(), !dbg !109
  %tobool2 = icmp ne i32 %call1, 0, !dbg !109
  br i1 %tobool2, label %if.then3, label %if.else, !dbg !111

if.then3:                                         ; preds = %if.end
  call void @printLine(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0)), !dbg !112
  br label %if.end4, !dbg !114

if.else:                                          ; preds = %if.end
  store i32 5, i32* %data, align 4, !dbg !115
  %0 = load i32, i32* %data, align 4, !dbg !117
  call void @printIntLine(i32 %0), !dbg !118
  br label %if.end4
...
entry:
  ...
  call void @good26(), !dbg !121
  call void @bad26(), !dbg !122
  ret i32 1, !dbg !123
}
...
!1 = !DIFile(filename: "457_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_26.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!83 = distinct !DISubprogram(name: "bad26", scope: !8, file: !8, line: 73, type: !84, isLocal: false, isDefinition: true, scopeLine: 74, isOptimized: false, unit: !0, variables: !2)
!84 = !DISubroutineType(types: !85)
!85 = !{null}
!86 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 75, type: !4)
!87 = !DILocation(line: 75, column: 9, scope: !83)
!88 = !DILocation(line: 76, column: 8, scope: !89)
!89 = distinct !DILexicalBlock(scope: !83, file: !8, line: 76, column: 8)
!90 = !DILocation(line: 76, column: 8, scope: !83)
!91 = !DILocation(line: 80, column: 5, scope: !92)
!92 = distinct !DILexicalBlock(scope: !89, file: !8, line: 77, column: 5)
!93 = !DILocation(line: 81, column: 8, scope: !94)
!94 = distinct !DILexicalBlock(scope: !83, file: !8, line: 81, column: 8)
!95 = !DILocation(line: 81, column: 8, scope: !83)
!96 = !DILocation(line: 84, column: 25, scope: !97)
!97 = distinct !DILexicalBlock(scope: !94, file: !8, line: 82, column: 5)
!98 = !DILocation(line: 84, column: 9, scope: !97)
!99 = !DILocation(line: 85, column: 5, scope: !97)
!100 = !DILocation(line: 86, column: 1, scope: !83)
!101 = distinct !DISubprogram(name: "good26", scope: !8, file: !8, line: 93, type: !84, isLocal: false, isDefinition: true, scopeLine: 94, isOptimized: false, unit: !0, variables: !2)
!102 = !DILocalVariable(name: "data", scope: !101, file: !8, line: 95, type: !4)
!103 = !DILocation(line: 95, column: 13, scope: !101)
!104 = !DILocation(line: 96, column: 8, scope: !105)
!105 = distinct !DILexicalBlock(scope: !101, file: !8, line: 96, column: 8)
!106 = !DILocation(line: 96, column: 8, scope: !101)
!107 = !DILocation(line: 100, column: 5, scope: !108)
!108 = distinct !DILexicalBlock(scope: !105, file: !8, line: 97, column: 5)
!109 = !DILocation(line: 101, column: 8, scope: !110)
!110 = distinct !DILexicalBlock(scope: !101, file: !8, line: 101, column: 8)
!111 = !DILocation(line: 101, column: 8, scope: !101)
!112 = !DILocation(line: 104, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !110, file: !8, line: 102, column: 5)
!114 = !DILocation(line: 105, column: 5, scope: !113)
!115 = !DILocation(line: 109, column: 14, scope: !116)
!116 = distinct !DILexicalBlock(scope: !110, file: !8, line: 107, column: 5)
!117 = !DILocation(line: 110, column: 22, scope: !116)
!118 = !DILocation(line: 110, column: 9, scope: !116)
!119 = !DILocation(line: 112, column: 1, scope: !101)
!120 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 116, type: !19, isLocal: false, isDefinition: true, scopeLine: 116, isOptimized: false, unit: !0, variables: !2)
!121 = !DILocation(line: 117, column: 2, scope: !120)
!122 = !DILocation(line: 118, column: 5, scope: !120)
!123 = !DILocation(line: 119, column: 5, scope: !120)
!124 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !8, file: !8, line: 61, type: !19, isLocal: true, isDefinition: true, scopeLine: 62, isOptimized: false, unit: !0, variables: !2)
!125 = !DILocation(line: 63, column: 5, scope: !124)
!126 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !8, file: !8, line: 66, type: !19, isLocal: true, isDefinition: true, scopeLine: 67, isOptimized: false, unit: !0, variables: !2)
