...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsTrue(), !dbg !85
  %tobool2 = icmp ne i32 %call1, 0, !dbg !85
  br i1 %tobool2, label %if.then3, label %if.end4, !dbg !87

if.then3:                                         ; preds = %if.end
  %0 = load i8*, i8** %data, align 8, !dbg !88
  call void @printLine(i8* %0), !dbg !90
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = call i32 @staticReturnsFalse(), !dbg !101
  %tobool2 = icmp ne i32 %call1, 0, !dbg !101
  br i1 %tobool2, label %if.then3, label %if.else, !dbg !103
...
entry:
  ...
  call void @good8(), !dbg !113
  call void @bad8(), !dbg !114
  ret i32 1, !dbg !115
}
...
!1 = !DIFile(filename: "457_8.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./457_8.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/457")
...
!85 = !DILocation(line: 77, column: 8, scope: !86)
!86 = distinct !DILexicalBlock(scope: !74, file: !8, line: 77, column: 8)
!87 = !DILocation(line: 77, column: 8, scope: !74)
!88 = !DILocation(line: 80, column: 19, scope: !89)
!89 = distinct !DILexicalBlock(scope: !86, file: !8, line: 78, column: 5)
!90 = !DILocation(line: 80, column: 9, scope: !89)
!91 = !DILocation(line: 81, column: 5, scope: !89)
!92 = !DILocation(line: 82, column: 1, scope: !74)
!93 = distinct !DISubprogram(name: "good8", scope: !8, file: !8, line: 88, type: !75, isLocal: false, isDefinition: true, scopeLine: 89, isOptimized: false, unit: !0, variables: !2)
!94 = !DILocalVariable(name: "data", scope: !93, file: !8, line: 90, type: !78)
!95 = !DILocation(line: 90, column: 12, scope: !93)
!96 = !DILocation(line: 91, column: 8, scope: !97)
!97 = distinct !DILexicalBlock(scope: !93, file: !8, line: 91, column: 8)
!98 = !DILocation(line: 91, column: 8, scope: !93)
!99 = !DILocation(line: 95, column: 5, scope: !100)
!100 = distinct !DILexicalBlock(scope: !97, file: !8, line: 92, column: 5)
!101 = !DILocation(line: 96, column: 8, scope: !102)
!102 = distinct !DILexicalBlock(scope: !93, file: !8, line: 96, column: 8)
!103 = !DILocation(line: 96, column: 8, scope: !93)
!104 = !DILocation(line: 99, column: 9, scope: !105)
!105 = distinct !DILexicalBlock(scope: !102, file: !8, line: 97, column: 5)
!106 = !DILocation(line: 100, column: 5, scope: !105)
!107 = !DILocation(line: 104, column: 14, scope: !108)
!108 = distinct !DILexicalBlock(scope: !102, file: !8, line: 102, column: 5)
!109 = !DILocation(line: 105, column: 19, scope: !108)
!110 = !DILocation(line: 105, column: 9, scope: !108)
!111 = !DILocation(line: 107, column: 1, scope: !93)
!112 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 111, type: !19, isLocal: false, isDefinition: true, scopeLine: 111, isOptimized: false, unit: !0, variables: !2)
!113 = !DILocation(line: 112, column: 5, scope: !112)
!114 = !DILocation(line: 113, column: 2, scope: !112)
!115 = !DILocation(line: 114, column: 5, scope: !112)
!116 = distinct !DISubprogram(name: "staticReturnsTrue", scope: !8, file: !8, line: 57, type: !19, isLocal: true, isDefinition: true, scopeLine: 58, isOptimized: false, unit: !0, variables: !2)
!117 = !DILocation(line: 59, column: 5, scope: !116)
!118 = distinct !DISubprogram(name: "staticReturnsFalse", scope: !8, file: !8, line: 62, type: !19, isLocal: true, isDefinition: true, scopeLine: 63, isOptimized: false, unit: !0, variables: !2)
!119 = !DILocation(line: 64, column: 5, scope: !118)
