...
; Function Attrs: nounwind uwtable
define void @bad4() #0 !dbg !56 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %data, metadata !59, metadata !15), !dbg !60
  store i8 32, i8* %data, align 1, !dbg !61
  store i8 127, i8* %data, align 1, !dbg !62
  call void @llvm.dbg.declare(metadata i8* %result, metadata !65, metadata !15), !dbg !69
  %0 = load i8, i8* %data, align 1, !dbg !70
  %conv = sext i8 %0 to i32, !dbg !70
  %add = add nsw i32 %conv, 1, !dbg !71
  %conv1 = trunc i32 %add to i8, !dbg !70
  store i8 %conv1, i8* %result, align 1, !dbg !69
  %1 = load i8, i8* %result, align 1, !dbg !72
  call void @printHexCharLine(i8 signext %1), !dbg !73
  ret void, !dbg !74
}
...
entry:
  ...
  call void @good4(), !dbg !78
  call void @bad4(), !dbg !79
  ret i32 1, !dbg !80
}

; Function Attrs: nounwind uwtable
define internal void @good4() #0 !dbg !81 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %data, metadata !82, metadata !15), !dbg !83
  store i8 32, i8* %data, align 1, !dbg !84
  store i8 127, i8* %data, align 1, !dbg !85
  %0 = load i8, i8* %data, align 1, !dbg !88
  %conv = sext i8 %0 to i32, !dbg !88
  %cmp = icmp slt i32 %conv, 127, !dbg !92
...
if.then:                                          ; preds = %entry
  ...
  %add = add nsw i32 %conv2, 1, !dbg !98
  %conv3 = trunc i32 %add to i8, !dbg !97
...
if.else:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0)), !dbg !102
  br label %if.end
...
!1 = !DIFile(filename: "190_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./190_4.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!56 = distinct !DISubprogram(name: "bad4", scope: !10, file: !10, line: 37, type: !57, isLocal: false, isDefinition: true, scopeLine: 38, isOptimized: false, unit: !0, variables: !2)
!57 = !DISubroutineType(types: !58)
!58 = !{null}
!59 = !DILocalVariable(name: "data", scope: !56, file: !10, line: 39, type: !13)
!60 = !DILocation(line: 39, column: 10, scope: !56)
!61 = !DILocation(line: 40, column: 10, scope: !56)
!62 = !DILocation(line: 44, column: 14, scope: !63)
!63 = distinct !DILexicalBlock(scope: !64, file: !10, line: 42, column: 5)
!64 = distinct !DILexicalBlock(scope: !56, file: !10, line: 41, column: 8)
!65 = !DILocalVariable(name: "result", scope: !66, file: !10, line: 50, type: !13)
!66 = distinct !DILexicalBlock(scope: !67, file: !10, line: 48, column: 9)
!67 = distinct !DILexicalBlock(scope: !68, file: !10, line: 47, column: 5)
!68 = distinct !DILexicalBlock(scope: !56, file: !10, line: 46, column: 8)
!69 = !DILocation(line: 50, column: 18, scope: !66)
!70 = !DILocation(line: 50, column: 27, scope: !66)
!71 = !DILocation(line: 50, column: 32, scope: !66)
!72 = !DILocation(line: 51, column: 30, scope: !66)
!73 = !DILocation(line: 51, column: 13, scope: !66)
!74 = !DILocation(line: 54, column: 1, scope: !56)
!75 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 87, type: !76, isLocal: false, isDefinition: true, scopeLine: 87, isOptimized: false, unit: !0, variables: !2)
!76 = !DISubroutineType(types: !77)
!77 = !{!4}
!78 = !DILocation(line: 88, column: 5, scope: !75)
!79 = !DILocation(line: 89, column: 5, scope: !75)
!80 = !DILocation(line: 90, column: 5, scope: !75)
!81 = distinct !DISubprogram(name: "good4", scope: !10, file: !10, line: 58, type: !57, isLocal: true, isDefinition: true, scopeLine: 59, isOptimized: false, unit: !0, variables: !2)
!82 = !DILocalVariable(name: "data", scope: !81, file: !10, line: 60, type: !13)
!83 = !DILocation(line: 60, column: 10, scope: !81)
!84 = !DILocation(line: 61, column: 10, scope: !81)
!85 = !DILocation(line: 65, column: 14, scope: !86)
!86 = distinct !DILexicalBlock(scope: !87, file: !10, line: 63, column: 5)
!87 = distinct !DILexicalBlock(scope: !81, file: !10, line: 62, column: 8)
!88 = !DILocation(line: 75, column: 13, scope: !89)
!89 = distinct !DILexicalBlock(scope: !90, file: !10, line: 75, column: 13)
!90 = distinct !DILexicalBlock(scope: !91, file: !10, line: 73, column: 5)
!91 = distinct !DILexicalBlock(scope: !81, file: !10, line: 67, column: 8)
!92 = !DILocation(line: 75, column: 18, scope: !89)
!93 = !DILocation(line: 75, column: 13, scope: !90)
!94 = !DILocalVariable(name: "result", scope: !95, file: !10, line: 77, type: !13)
!95 = distinct !DILexicalBlock(scope: !89, file: !10, line: 76, column: 9)
!96 = !DILocation(line: 77, column: 18, scope: !95)
!97 = !DILocation(line: 77, column: 27, scope: !95)
!98 = !DILocation(line: 77, column: 32, scope: !95)
!99 = !DILocation(line: 78, column: 30, scope: !95)
!100 = !DILocation(line: 78, column: 13, scope: !95)
!101 = !DILocation(line: 79, column: 9, scope: !95)
!102 = !DILocation(line: 82, column: 13, scope: !103)
!103 = distinct !DILexicalBlock(scope: !89, file: !10, line: 81, column: 9)
!104 = !DILocation(line: 85, column: 1, scope: !81)
