...
entry:
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %data), !dbg !81
  call void @llvm.dbg.declare(metadata i32* %dataCopy, metadata !82, metadata !33), !dbg !84
  %1 = load i32, i32* %data, align 4, !dbg !85
  store i32 %1, i32* %dataCopy, align 4, !dbg !84
  call void @llvm.dbg.declare(metadata i32* %data1, metadata !86, metadata !33), !dbg !87
  %2 = load i32, i32* %dataCopy, align 4, !dbg !88
  store i32 %2, i32* %data1, align 4, !dbg !87
  call void @llvm.dbg.declare(metadata i32* %result, metadata !89, metadata !33), !dbg !91
  %3 = load i32, i32* %data1, align 4, !dbg !92
  %add = add nsw i32 %3, 1, !dbg !93
  store i32 %add, i32* %result, align 4, !dbg !91
  %4 = load i32, i32* %result, align 4, !dbg !94
...
entry:
  ...
  %data1 = alloca i32, align 4
  %result = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !98, metadata !33), !dbg !99
  store i32 0, i32* %data, align 4, !dbg !100
  store i32 2, i32* %data, align 4, !dbg !101
  call void @llvm.dbg.declare(metadata i32* %dataCopy, metadata !102, metadata !33), !dbg !104
  %0 = load i32, i32* %data, align 4, !dbg !105
  store i32 %0, i32* %dataCopy, align 4, !dbg !104
  call void @llvm.dbg.declare(metadata i32* %data1, metadata !106, metadata !33), !dbg !107
  %1 = load i32, i32* %dataCopy, align 4, !dbg !108
  store i32 %1, i32* %data1, align 4, !dbg !107
  call void @llvm.dbg.declare(metadata i32* %result, metadata !109, metadata !33), !dbg !111
  %2 = load i32, i32* %data1, align 4, !dbg !112
  %add = add nsw i32 %2, 1, !dbg !113
  store i32 %add, i32* %result, align 4, !dbg !111
  %3 = load i32, i32* %result, align 4, !dbg !114
...
entry:
  ...
  call void @good49(), !dbg !118
  call void @bad49(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "190_49.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./190_49.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!74 = distinct !DISubprogram(name: "bad49", scope: !8, file: !8, line: 58, type: !75, isLocal: false, isDefinition: true, scopeLine: 59, isOptimized: false, unit: !0, variables: !2)
...
!81 = !DILocation(line: 64, column: 5, scope: !74)
!82 = !DILocalVariable(name: "dataCopy", scope: !83, file: !8, line: 66, type: !4)
!83 = distinct !DILexicalBlock(scope: !74, file: !8, line: 65, column: 5)
!84 = !DILocation(line: 66, column: 13, scope: !83)
!85 = !DILocation(line: 66, column: 24, scope: !83)
!86 = !DILocalVariable(name: "data", scope: !83, file: !8, line: 67, type: !4)
!87 = !DILocation(line: 67, column: 13, scope: !83)
!88 = !DILocation(line: 67, column: 20, scope: !83)
!89 = !DILocalVariable(name: "result", scope: !90, file: !8, line: 70, type: !4)
!90 = distinct !DILexicalBlock(scope: !83, file: !8, line: 68, column: 9)
!91 = !DILocation(line: 70, column: 17, scope: !90)
!92 = !DILocation(line: 70, column: 26, scope: !90)
!93 = !DILocation(line: 70, column: 31, scope: !90)
!94 = !DILocation(line: 71, column: 26, scope: !90)
!95 = !DILocation(line: 71, column: 13, scope: !90)
!96 = !DILocation(line: 74, column: 1, scope: !74)
!97 = distinct !DISubprogram(name: "good49", scope: !8, file: !8, line: 80, type: !75, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
!98 = !DILocalVariable(name: "data", scope: !97, file: !8, line: 82, type: !4)
...
!102 = !DILocalVariable(name: "dataCopy", scope: !103, file: !8, line: 88, type: !4)
!103 = distinct !DILexicalBlock(scope: !97, file: !8, line: 87, column: 5)
!104 = !DILocation(line: 88, column: 13, scope: !103)
!105 = !DILocation(line: 88, column: 24, scope: !103)
!106 = !DILocalVariable(name: "data", scope: !103, file: !8, line: 89, type: !4)
!107 = !DILocation(line: 89, column: 13, scope: !103)
!108 = !DILocation(line: 89, column: 20, scope: !103)
!109 = !DILocalVariable(name: "result", scope: !110, file: !8, line: 92, type: !4)
!110 = distinct !DILexicalBlock(scope: !103, file: !8, line: 90, column: 9)
!111 = !DILocation(line: 92, column: 17, scope: !110)
!112 = !DILocation(line: 92, column: 26, scope: !110)
!113 = !DILocation(line: 92, column: 31, scope: !110)
!114 = !DILocation(line: 93, column: 26, scope: !110)
!115 = !DILocation(line: 93, column: 13, scope: !110)
!116 = !DILocation(line: 96, column: 1, scope: !97)
!117 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 100, type: !19, isLocal: false, isDefinition: true, scopeLine: 100, isOptimized: false, unit: !0, variables: !2)
!118 = !DILocation(line: 101, column: 5, scope: !117)
!119 = !DILocation(line: 102, column: 5, scope: !117)
!120 = !DILocation(line: 103, column: 5, scope: !117)
