...
source:                                           ; preds = %entry
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %data), !dbg !82
  br label %sink, !dbg !83

sink:                                             ; preds = %source
  call void @llvm.dbg.declare(metadata i32* %result, metadata !84, metadata !33), !dbg !86
  %1 = load i32, i32* %data, align 4, !dbg !87
  %add = add nsw i32 %1, 1, !dbg !88
  store i32 %add, i32* %result, align 4, !dbg !86
  %2 = load i32, i32* %result, align 4, !dbg !89
  call void @printIntLine(i32 %2), !dbg !90
  ret void, !dbg !91
}
...
; Function Attrs: nounwind uwtable
define void @good46() #0 !dbg !92 {
entry:
  %data = alloca i32, align 4
  %result = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !93, metadata !33), !dbg !94
  store i32 0, i32* %data, align 4, !dbg !95
  br label %source, !dbg !96

source:                                           ; preds = %entry
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !dbg !97
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %data), !dbg !98
  br label %sink, !dbg !99
...
if.then:                                          ; preds = %sink
  call void @llvm.dbg.declare(metadata i32* %result, metadata !104, metadata !33), !dbg !106
...
if.else:                                          ; preds = %sink
  call void @printLine(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i32 0, i32 0)), !dbg !112
  br label %if.end
...
entry:
  ...
  call void @good46(), !dbg !116
  call void @bad46(), !dbg !117
  ret i32 1, !dbg !118
}
...
!1 = !DIFile(filename: "190_46.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./190_46.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!74 = distinct !DISubprogram(name: "bad46", scope: !8, file: !8, line: 58, type: !75, isLocal: false, isDefinition: true, scopeLine: 59, isOptimized: false, unit: !0, variables: !2)
...
!80 = !DILocation(line: 63, column: 5, scope: !74)
!81 = !DILocation(line: 66, column: 12, scope: !74)
!82 = !DILocation(line: 66, column: 5, scope: !74)
!83 = !DILocation(line: 67, column: 5, scope: !74)
!84 = !DILocalVariable(name: "result", scope: !85, file: !8, line: 71, type: !4)
!85 = distinct !DILexicalBlock(scope: !74, file: !8, line: 69, column: 5)
!86 = !DILocation(line: 71, column: 13, scope: !85)
!87 = !DILocation(line: 71, column: 22, scope: !85)
!88 = !DILocation(line: 71, column: 27, scope: !85)
!89 = !DILocation(line: 72, column: 22, scope: !85)
!90 = !DILocation(line: 72, column: 9, scope: !85)
!91 = !DILocation(line: 74, column: 1, scope: !74)
!92 = distinct !DISubprogram(name: "good46", scope: !8, file: !8, line: 80, type: !75, isLocal: false, isDefinition: true, scopeLine: 81, isOptimized: false, unit: !0, variables: !2)
!93 = !DILocalVariable(name: "data", scope: !92, file: !8, line: 82, type: !4)
!94 = !DILocation(line: 82, column: 9, scope: !92)
!95 = !DILocation(line: 84, column: 10, scope: !92)
!96 = !DILocation(line: 85, column: 5, scope: !92)
!97 = !DILocation(line: 88, column: 12, scope: !92)
!98 = !DILocation(line: 88, column: 5, scope: !92)
!99 = !DILocation(line: 89, column: 5, scope: !92)
!100 = !DILocation(line: 92, column: 9, scope: !101)
!101 = distinct !DILexicalBlock(scope: !92, file: !8, line: 92, column: 9)
!102 = !DILocation(line: 92, column: 14, scope: !101)
!103 = !DILocation(line: 92, column: 9, scope: !92)
!104 = !DILocalVariable(name: "result", scope: !105, file: !8, line: 94, type: !4)
!105 = distinct !DILexicalBlock(scope: !101, file: !8, line: 93, column: 5)
!106 = !DILocation(line: 94, column: 13, scope: !105)
!107 = !DILocation(line: 94, column: 22, scope: !105)
!108 = !DILocation(line: 94, column: 27, scope: !105)
!109 = !DILocation(line: 95, column: 22, scope: !105)
!110 = !DILocation(line: 95, column: 9, scope: !105)
!111 = !DILocation(line: 96, column: 5, scope: !105)
!112 = !DILocation(line: 99, column: 9, scope: !113)
!113 = distinct !DILexicalBlock(scope: !101, file: !8, line: 98, column: 5)
!114 = !DILocation(line: 101, column: 1, scope: !92)
!115 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 106, type: !19, isLocal: false, isDefinition: true, scopeLine: 106, isOptimized: false, unit: !0, variables: !2)
!116 = !DILocation(line: 107, column: 5, scope: !115)
!117 = !DILocation(line: 108, column: 5, scope: !115)
!118 = !DILocation(line: 109, column: 5, scope: !115)
