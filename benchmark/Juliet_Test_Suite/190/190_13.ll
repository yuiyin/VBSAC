...
entry:
  ...
  store i64 9223372036854775807, i64* %data, align 8, !dbg !80
  call void @llvm.dbg.declare(metadata i64* %result, metadata !83, metadata !33), !dbg !87
  %0 = load i64, i64* %data, align 8, !dbg !88
  %add = add nsw i64 %0, 1, !dbg !89
  store i64 %add, i64* %result, align 8, !dbg !87
  %1 = load i64, i64* %result, align 8, !dbg !90
  call void @printLongLine(i64 %1), !dbg !91
  ret void, !dbg !92
}

; Function Attrs: nounwind uwtable
define void @good13() #0 !dbg !93 {
entry:
  %data = alloca i64, align 8
  %result = alloca i64, align 8
  call void @llvm.dbg.declare(metadata i64* %data, metadata !94, metadata !33), !dbg !95
  store i64 0, i64* %data, align 8, !dbg !96
  store i64 9223372036854775807, i64* %data, align 8, !dbg !97
  %0 = load i64, i64* %data, align 8, !dbg !100
  %cmp = icmp slt i64 %0, 9223372036854775807, !dbg !104
  br i1 %cmp, label %if.then, label %if.else, !dbg !105

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i64* %result, metadata !106, metadata !33), !dbg !108
  %1 = load i64, i64* %data, align 8, !dbg !109
  %add = add nsw i64 %1, 1, !dbg !110
  store i64 %add, i64* %result, align 8, !dbg !108
  %2 = load i64, i64* %result, align 8, !dbg !111
  call void @printLongLine(i64 %2), !dbg !112
  br label %if.end, !dbg !113

if.else:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0)), !dbg !114
  br label %if.end
...
entry:
  ...
  call void @good13(), !dbg !118
  call void @bad13(), !dbg !119
  ret i32 1, !dbg !120
}
...
!1 = !DIFile(filename: "190_13.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./190_13.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!74 = distinct !DISubprogram(name: "bad13", scope: !8, file: !8, line: 60, type: !75, isLocal: false, isDefinition: true, scopeLine: 61, isOptimized: false, unit: !0, variables: !2)
...
!80 = !DILocation(line: 67, column: 14, scope: !81)
!81 = distinct !DILexicalBlock(scope: !82, file: !8, line: 65, column: 5)
!82 = distinct !DILexicalBlock(scope: !74, file: !8, line: 64, column: 8)
!83 = !DILocalVariable(name: "result", scope: !84, file: !8, line: 73, type: !66)
!84 = distinct !DILexicalBlock(scope: !85, file: !8, line: 71, column: 9)
!85 = distinct !DILexicalBlock(scope: !86, file: !8, line: 70, column: 5)
!86 = distinct !DILexicalBlock(scope: !74, file: !8, line: 69, column: 8)
!87 = !DILocation(line: 73, column: 21, scope: !84)
!88 = !DILocation(line: 73, column: 30, scope: !84)
!89 = !DILocation(line: 73, column: 35, scope: !84)
!90 = !DILocation(line: 74, column: 27, scope: !84)
!91 = !DILocation(line: 74, column: 13, scope: !84)
!92 = !DILocation(line: 77, column: 1, scope: !74)
!93 = distinct !DISubprogram(name: "good13", scope: !8, file: !8, line: 79, type: !75, isLocal: false, isDefinition: true, scopeLine: 80, isOptimized: false, unit: !0, variables: !2)
!94 = !DILocalVariable(name: "data", scope: !93, file: !8, line: 81, type: !66)
!95 = !DILocation(line: 81, column: 13, scope: !93)
!96 = !DILocation(line: 82, column: 10, scope: !93)
!97 = !DILocation(line: 86, column: 14, scope: !98)
!98 = distinct !DILexicalBlock(scope: !99, file: !8, line: 84, column: 5)
!99 = distinct !DILexicalBlock(scope: !93, file: !8, line: 83, column: 8)
!100 = !DILocation(line: 96, column: 13, scope: !101)
!101 = distinct !DILexicalBlock(scope: !102, file: !8, line: 96, column: 13)
!102 = distinct !DILexicalBlock(scope: !103, file: !8, line: 94, column: 5)
!103 = distinct !DILexicalBlock(scope: !93, file: !8, line: 88, column: 8)
!104 = !DILocation(line: 96, column: 18, scope: !101)
!105 = !DILocation(line: 96, column: 13, scope: !102)
!106 = !DILocalVariable(name: "result", scope: !107, file: !8, line: 98, type: !66)
!107 = distinct !DILexicalBlock(scope: !101, file: !8, line: 97, column: 9)
!108 = !DILocation(line: 98, column: 21, scope: !107)
!109 = !DILocation(line: 98, column: 30, scope: !107)
!110 = !DILocation(line: 98, column: 35, scope: !107)
!111 = !DILocation(line: 99, column: 27, scope: !107)
!112 = !DILocation(line: 99, column: 13, scope: !107)
!113 = !DILocation(line: 100, column: 9, scope: !107)
!114 = !DILocation(line: 103, column: 13, scope: !115)
!115 = distinct !DILexicalBlock(scope: !101, file: !8, line: 102, column: 9)
!116 = !DILocation(line: 106, column: 1, scope: !93)
!117 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 108, type: !19, isLocal: false, isDefinition: true, scopeLine: 108, isOptimized: false, unit: !0, variables: !2)
!118 = !DILocation(line: 109, column: 5, scope: !117)
!119 = !DILocation(line: 110, column: 5, scope: !117)
!120 = !DILocation(line: 111, column: 5, scope: !117)
