...
entry:
  ...
  call void @llvm.dbg.declare(metadata i8* %result, metadata !64, metadata !15), !dbg !66
  %1 = load i8, i8* %data, align 1, !dbg !67
  %conv = sext i8 %1 to i32, !dbg !67
  %add = add nsw i32 %conv, 1, !dbg !68
  %conv1 = trunc i32 %add to i8, !dbg !67
  store i8 %conv1, i8* %result, align 1, !dbg !66
  %2 = load i8, i8* %result, align 1, !dbg !69
  call void @printHexCharLine(i8 signext %2), !dbg !70
  ret void, !dbg !71
}
...
; Function Attrs: nounwind uwtable
define void @goodG2B() #0 !dbg !72 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  call void @llvm.dbg.declare(metadata i8* %data, metadata !73, metadata !15), !dbg !74
  store i8 32, i8* %data, align 1, !dbg !75
  store i8 2, i8* %data, align 1, !dbg !76
  call void @llvm.dbg.declare(metadata i8* %result, metadata !77, metadata !15), !dbg !79
  %0 = load i8, i8* %data, align 1, !dbg !80
  %conv = sext i8 %0 to i32, !dbg !80
  %add = add nsw i32 %conv, 1, !dbg !81
  %conv1 = trunc i32 %add to i8, !dbg !80
  store i8 %conv1, i8* %result, align 1, !dbg !79
  %1 = load i8, i8* %result, align 1, !dbg !82
  call void @printHexCharLine(i8 signext %1), !dbg !83
  ret void, !dbg !84
}

; Function Attrs: nounwind uwtable
define void @goodB2G() #0 !dbg !85 {
entry:
  %data = alloca i8, align 1
  %result = alloca i8, align 1
  ...
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i8* %data), !dbg !90
  %1 = load i8, i8* %data, align 1, !dbg !91
  %conv = sext i8 %1 to i32, !dbg !91
  %cmp = icmp slt i32 %conv, 127, !dbg !93
  br i1 %cmp, label %if.then, label %if.else, !dbg !94

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i8* %result, metadata !95, metadata !15), !dbg !97
  %2 = load i8, i8* %data, align 1, !dbg !98
  %conv2 = sext i8 %2 to i32, !dbg !98
  %add = add nsw i32 %conv2, 1, !dbg !99
  %conv3 = trunc i32 %add to i8, !dbg !98
  store i8 %conv3, i8* %result, align 1, !dbg !97
  %3 = load i8, i8* %result, align 1, !dbg !100
  call void @printHexCharLine(i8 signext %3), !dbg !101
...
entry:
  ...
  call void @good30(), !dbg !113
  call void @bad30(), !dbg !114
  ret i32 1, !dbg !115
}
...
!1 = !DIFile(filename: "190_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!10 = !DIFile(filename: "./190_30.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!56 = distinct !DISubprogram(name: "bad30", scope: !10, file: !10, line: 33, type: !57, isLocal: false, isDefinition: true, scopeLine: 34, isOptimized: false, unit: !0, variables: !2)
...
!64 = !DILocalVariable(name: "result", scope: !65, file: !10, line: 41, type: !13)
!65 = distinct !DILexicalBlock(scope: !56, file: !10, line: 39, column: 5)
!66 = !DILocation(line: 41, column: 14, scope: !65)
!67 = !DILocation(line: 41, column: 23, scope: !65)
!68 = !DILocation(line: 41, column: 28, scope: !65)
!69 = !DILocation(line: 42, column: 26, scope: !65)
!70 = !DILocation(line: 42, column: 9, scope: !65)
!71 = !DILocation(line: 44, column: 1, scope: !56)
!72 = distinct !DISubprogram(name: "goodG2B", scope: !10, file: !10, line: 46, type: !57, isLocal: false, isDefinition: true, scopeLine: 47, isOptimized: false, unit: !0, variables: !2)
!73 = !DILocalVariable(name: "data", scope: !72, file: !10, line: 48, type: !13)
!74 = !DILocation(line: 48, column: 10, scope: !72)
!75 = !DILocation(line: 49, column: 10, scope: !72)
!76 = !DILocation(line: 51, column: 10, scope: !72)
!77 = !DILocalVariable(name: "result", scope: !78, file: !10, line: 54, type: !13)
!78 = distinct !DILexicalBlock(scope: !72, file: !10, line: 52, column: 5)
!79 = !DILocation(line: 54, column: 14, scope: !78)
!80 = !DILocation(line: 54, column: 23, scope: !78)
!81 = !DILocation(line: 54, column: 28, scope: !78)
!82 = !DILocation(line: 55, column: 26, scope: !78)
!83 = !DILocation(line: 55, column: 9, scope: !78)
!84 = !DILocation(line: 57, column: 1, scope: !72)
!85 = distinct !DISubprogram(name: "goodB2G", scope: !10, file: !10, line: 60, type: !57, isLocal: false, isDefinition: true, scopeLine: 61, isOptimized: false, unit: !0, variables: !2)
!86 = !DILocalVariable(name: "data", scope: !85, file: !10, line: 62, type: !13)
!87 = !DILocation(line: 62, column: 10, scope: !85)
!88 = !DILocation(line: 63, column: 10, scope: !85)
!89 = !DILocation(line: 65, column: 13, scope: !85)
!90 = !DILocation(line: 65, column: 5, scope: !85)
!91 = !DILocation(line: 67, column: 9, scope: !92)
!92 = distinct !DILexicalBlock(scope: !85, file: !10, line: 67, column: 9)
!93 = !DILocation(line: 67, column: 14, scope: !92)
!94 = !DILocation(line: 67, column: 9, scope: !85)
!95 = !DILocalVariable(name: "result", scope: !96, file: !10, line: 69, type: !13)
!96 = distinct !DILexicalBlock(scope: !92, file: !10, line: 68, column: 5)
!97 = !DILocation(line: 69, column: 14, scope: !96)
!98 = !DILocation(line: 69, column: 23, scope: !96)
!99 = !DILocation(line: 69, column: 28, scope: !96)
!100 = !DILocation(line: 70, column: 26, scope: !96)
!101 = !DILocation(line: 70, column: 9, scope: !96)
!102 = !DILocation(line: 71, column: 5, scope: !96)
!103 = !DILocation(line: 74, column: 9, scope: !104)
!104 = distinct !DILexicalBlock(scope: !92, file: !10, line: 73, column: 5)
!105 = !DILocation(line: 76, column: 1, scope: !85)
!106 = distinct !DISubprogram(name: "good30", scope: !10, file: !10, line: 78, type: !57, isLocal: false, isDefinition: true, scopeLine: 79, isOptimized: false, unit: !0, variables: !2)
!107 = !DILocation(line: 80, column: 5, scope: !106)
!108 = !DILocation(line: 81, column: 5, scope: !106)
!109 = !DILocation(line: 82, column: 1, scope: !106)
!110 = distinct !DISubprogram(name: "main", scope: !10, file: !10, line: 84, type: !111, isLocal: false, isDefinition: true, scopeLine: 84, isOptimized: false, unit: !0, variables: !2)
!111 = !DISubroutineType(types: !112)
!112 = !{!4}
!113 = !DILocation(line: 85, column: 5, scope: !110)
!114 = !DILocation(line: 86, column: 5, scope: !110)
!115 = !DILocation(line: 87, column: 5, scope: !110)
