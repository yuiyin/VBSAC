...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %result, metadata !82, metadata !33), !dbg !83
  %1 = load i32, i32* %data, align 4, !dbg !84
  %add = add nsw i32 %1, 1, !dbg !85
  store i32 %add, i32* %result, align 4, !dbg !83
  %2 = load i32, i32* %result, align 4, !dbg !86
...
; Function Attrs: nounwind uwtable
define void @good43() #0 !dbg !89 {
entry:
  %data = alloca i32, align 4
  %result = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32* %data, metadata !90, metadata !33), !dbg !91
  store i32 0, i32* %data, align 4, !dbg !92
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !dbg !93
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %data), !dbg !94
  %1 = load i32, i32* %data, align 4, !dbg !95
  %cmp = icmp slt i32 %1, 2147483647, !dbg !97
  br i1 %cmp, label %if.then, label %if.else, !dbg !98

if.then:                                          ; preds = %entry
  call void @llvm.dbg.declare(metadata i32* %result, metadata !99, metadata !33), !dbg !101
  %2 = load i32, i32* %data, align 4, !dbg !102
  %add = add nsw i32 %2, 1, !dbg !103
  store i32 %add, i32* %result, align 4, !dbg !101
  %3 = load i32, i32* %result, align 4, !dbg !104
  call void @printIntLine(i32 %3), !dbg !105
  br label %if.end, !dbg !106

if.else:                                          ; preds = %entry
  call void @printLine(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i32 0, i32 0)), !dbg !107
  br label %if.end
...
entry:
  ...
  call void @good43(), !dbg !111
  call void @bad43(), !dbg !112
  ret i32 1, !dbg !113
}
...
!1 = !DIFile(filename: "190_43.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
!2 = !{}
!3 = !{!4, !5}
...
!8 = !DIFile(filename: "./190_43.c", directory: "/home/guzuxing/Documents/VBSAC/benchmark/Juliet_Test_Suite/190")
...
!74 = distinct !DISubprogram(name: "bad43", scope: !8, file: !8, line: 58, type: !75, isLocal: false, isDefinition: true, scopeLine: 59, isOptimized: false, unit: !0, variables: !2)
...
!80 = !DILocation(line: 67, column: 16, scope: !74)
!81 = !DILocation(line: 67, column: 9, scope: !74)
!82 = !DILocalVariable(name: "result", scope: !74, file: !8, line: 79, type: !4)
!83 = !DILocation(line: 79, column: 13, scope: !74)
!84 = !DILocation(line: 79, column: 22, scope: !74)
!85 = !DILocation(line: 79, column: 27, scope: !74)
!86 = !DILocation(line: 80, column: 22, scope: !74)
!87 = !DILocation(line: 80, column: 9, scope: !74)
!88 = !DILocation(line: 88, column: 1, scope: !74)
!89 = distinct !DISubprogram(name: "good43", scope: !8, file: !8, line: 95, type: !75, isLocal: false, isDefinition: true, scopeLine: 96, isOptimized: false, unit: !0, variables: !2)
!90 = !DILocalVariable(name: "data", scope: !89, file: !8, line: 97, type: !4)
!91 = !DILocation(line: 97, column: 9, scope: !89)
!92 = !DILocation(line: 99, column: 10, scope: !89)
!93 = !DILocation(line: 104, column: 16, scope: !89)
!94 = !DILocation(line: 104, column: 9, scope: !89)
!95 = !DILocation(line: 119, column: 13, scope: !96)
!96 = distinct !DILexicalBlock(scope: !89, file: !8, line: 119, column: 13)
!97 = !DILocation(line: 119, column: 18, scope: !96)
!98 = !DILocation(line: 119, column: 13, scope: !89)
!99 = !DILocalVariable(name: "result", scope: !100, file: !8, line: 121, type: !4)
!100 = distinct !DILexicalBlock(scope: !96, file: !8, line: 120, column: 9)
!101 = !DILocation(line: 121, column: 17, scope: !100)
!102 = !DILocation(line: 121, column: 26, scope: !100)
!103 = !DILocation(line: 121, column: 31, scope: !100)
!104 = !DILocation(line: 122, column: 26, scope: !100)
!105 = !DILocation(line: 122, column: 13, scope: !100)
!106 = !DILocation(line: 123, column: 9, scope: !100)
!107 = !DILocation(line: 126, column: 13, scope: !108)
!108 = distinct !DILexicalBlock(scope: !96, file: !8, line: 125, column: 9)
!109 = !DILocation(line: 130, column: 1, scope: !89)
!110 = distinct !DISubprogram(name: "main", scope: !8, file: !8, line: 134, type: !19, isLocal: false, isDefinition: true, scopeLine: 134, isOptimized: false, unit: !0, variables: !2)
!111 = !DILocation(line: 135, column: 5, scope: !110)
!112 = !DILocation(line: 136, column: 5, scope: !110)
!113 = !DILocation(line: 137, column: 5, scope: !110)
